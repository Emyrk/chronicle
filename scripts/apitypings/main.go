...
func main() {
	...
	err = gen.ExcludeCustom(
		"github.com/Emyrk/chronicle/combatlog/parser/types.Spell",
		"github.com/Emyrk/chronicle/combatlog/parser/types.Matched",
		"github.com/Emyrk/chronicle/combatlog/parser/types.Trailer",
		"github.com/Emyrk/chronicle/combatlog/parser/types.Unit",
		"github.com/Emyrk/chronicle/combatlog/parser/types.Pattern",
	)
	if err != nil {
		log.Fatalf("exclude custom: %v", err)
	}
	...
	// Just add import manually
	output = strings.Replace(output, "// Code generated by 'guts'. DO NOT EDIT.", `// Code generated by 'guts'. DO NOT EDIT.

import type { GUID } from "@/lib/guid/guid";`, 1)
...
func TypeMappings(gen *guts.GoParser) error {
	...
	gen.IncludeCustomDeclaration(map[string]guts.TypeOverride{
		"github.com/Emyrk/chronicle/combatlog/parser/guid.GUID": func() bindings.ExpressionType {
