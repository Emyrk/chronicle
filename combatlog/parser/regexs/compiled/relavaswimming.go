...
// Code generated by regengo for pattern: (.+[^\s]) loses (\d+) health for swimming in lava\.\s?(.*)
// DO NOT EDIT.

var reLavaSwimmingStackPool = sync.Pool{New: func() interface{} {
	stack := make([][3]int, 0, 32)
	return &stack
}}

var reLavaSwimmingCaptureStackPool = sync.Pool{New: func() interface{} {
	stack := make([]int, 0, 128)
	return &stack
}}

type ReLavaSwimming struct{}

var CompiledReLavaSwimming = ReLavaSwimming{}

// MinMatchLen is the minimum number of bytes any match can have.
const ReLavaSwimmingMinMatchLen = 39

// MaxMatchLen is the maximum number of bytes any match can have.
// -1 means unbounded (pattern contains * or + quantifiers).
const ReLavaSwimmingMaxMatchLen = -1

func (ReLavaSwimming) MatchLengthInfo() (minLen, maxLen int) {
	return ReLavaSwimmingMinMatchLen, ReLavaSwimmingMaxMatchLen
}

func (ReLavaSwimming) MatchString(input string) bool {
	l := len(input)
	offset := 0
	stackPtr := reLavaSwimmingStackPool.Get().(*[][3]int)
	stack := (*stackPtr)[:0]
	defer func() {
		for i := range stack {
			stack[i] = [3]int{0, 0, 0}
		...
		*stackPtr = stack[:0]
		reLavaSwimmingStackPool.Put(stackPtr)
	}()
	nextInstruction := 1
	goto StepSelect
TryFallback:
...
Ins15:
	{
		stack = append(stack, [3]int{offset, 14, 0})
		goto Ins16
	}
Ins16:
	{
...
func (ReLavaSwimming) MatchBytes(input []byte) bool {
	l := len(input)
	offset := 0
	stackPtr := reLavaSwimmingStackPool.Get().(*[][3]int)
	stack := (*stackPtr)[:0]
...
type ReLavaSwimmingResult struct {
...
type ReLavaSwimmingBytesResult struct {
...
func (ReLavaSwimming) FindStringReuse(input string, r *ReLavaSwimmingResult) (*ReLavaSwimmingResult, bool) {
	l := len(input)
	offset := 0
	var captures [8]int
	stackPtr := reLavaSwimmingStackPool.Get().(*[][3]int)
...
func (recv ReLavaSwimming) FindString(input string) (*ReLavaSwimmingResult, bool) {
	return recv.FindStringReuse(input, nil)
}
func (ReLavaSwimming) FindAllStringAppend(input string, n int, s []*ReLavaSwimmingResult) []*ReLavaSwimmingResult {
	if n == 0 {
		return s
	}
	result := s
	...
	Ins52:
		{
			captures[1] = offset
			var item *ReLavaSwimmingResult
			if len(result) < cap(result) {
				result = result[:len(result)+1]
				item = result[len(result)-1]
				if item == nil {
					item = &ReLavaSwimmingResult{}
...
func (r ReLavaSwimming) FindAllString(input string, n int) []*ReLavaSwimmingResult {
	return r.FindAllStringAppend(input, n, nil)
}
func (ReLavaSwimming) FindBytesReuse(input []byte, r *ReLavaSwimmingBytesResult) (*ReLavaSwimmingBytesResult, bool) {
	l := len(input)
	offset := 0
	var captures [8]int
	stackPtr := reLavaSwimmingStackPool.Get().(*[][3]int)
...
func (recv ReLavaSwimming) FindBytes(input []byte) (*ReLavaSwimmingBytesResult, bool) {
	return recv.FindBytesReuse(input, nil)
}
func (ReLavaSwimming) FindAllBytesAppend(input []byte, n int, s []*ReLavaSwimmingBytesResult) []*ReLavaSwimmingBytesResult {
	if n == 0 {
		return s
	}
	result := s
	...
	Ins52:
		{
			captures[1] = offset
			var item *ReLavaSwimmingBytesResult
			if len(result) < cap(result) {
				result = result[:len(result)+1]
				item = result[len(result)-1]
				if item == nil {
					item = &ReLavaSwimmingBytesResult{}
					result[len(result)-1] = item
				}
			} else {
				item = &ReLavaSwimmingBytesResult{}
...
func (r ReLavaSwimming) FindAllBytes(input []byte, n int) []*ReLavaSwimmingBytesResult {
...
func (ReLavaSwimming) DefaultMaxLeftover() int {
	return 1048576
}
...
func (ReLavaSwimming) FindReader(r io.Reader, cfg stream.Config, onMatch func(stream.Match[*ReLavaSwimmingBytesResult]) bool) error {
	...
	reuseResult := &ReLavaSwimmingBytesResult{}
			...
			if err == io.EOF {
				...
				if leftover > 0 {
					...
					for searchPos < len(chunk) {
						result, ok := ReLavaSwimming{}.FindBytesReuse(chunk[searchPos:], reuseResult)
						if !ok {
							break
						}
						...
						m := stream.Match[*ReLavaSwimmingBytesResult]{
...
func (ReLavaSwimming) FindReaderCount(r io.Reader, cfg stream.Config) (int64, error) {
	var count int64
	err := ReLavaSwimming{}.FindReader(r, cfg, func(_ stream.Match[*ReLavaSwimmingBytesResult]) bool {
		count++
		return true
	})
	return count, err
...
func (ReLavaSwimming) FindReaderFirst(r io.Reader, cfg stream.Config) (*ReLavaSwimmingBytesResult, int64, error) {
	var result *ReLavaSwimmingBytesResult
	var offset int64
	err := ReLavaSwimming{}.FindReader(r, cfg, func(m stream.Match[*ReLavaSwimmingBytesResult]) bool {
		// Copy the result since buffer will be reused
		result = ReLavaSwimming{}.copyBytesResult(m.Result)
...
func (ReLavaSwimming) copyBytesResult(src *ReLavaSwimmingBytesResult) *ReLavaSwimmingBytesResult {
	if src == nil {
		return nil
	}
	dst := &ReLavaSwimmingBytesResult{}
	// Copy Match slice
...
//	    })
//	io.Copy(os.Stdout, r)
func (ReLavaSwimming) NewTransformReader(r io.Reader, cfg stream.TransformConfig, onMatch func(match *ReLavaSwimmingBytesResult, emit func([]byte))) io.Reader {
	if cfg.BufferSize == 0 {
	...
	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReLavaSwimming{}.processTransform(data, isEOF, onMatch, emitOut)
	}
...
func (ReLavaSwimming) processTransform(data []byte, isEOF bool, onMatch func(match *ReLavaSwimmingBytesResult, emit func([]byte)), emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReLavaSwimmingBytesResult{}

	for {
		result, ok := ReLavaSwimming{}.FindBytesReuse(data[processed:], reuseResult)
		if !ok {
			// No more matches
			if isEOF {
...
//	io.Copy(os.Stdout, r)
func (ReLavaSwimming) ReplaceReader(r io.Reader, template string) io.Reader {
	parsed, err := replace.Parse(template)
	if err != nil {
		return &reLavaSwimmingTransformErrReader{err: err}
	}
	...
	return ReLavaSwimming{}.NewTransformReader(r, stream.DefaultTransformConfig(), func(m *ReLavaSwimmingBytesResult, emit func([]byte)) {
		...
		for _, seg := range resolved {
			...
			case replace.SegmentCaptureIndex:
				capture := (ReLavaSwimming{}).getCaptureByIndex(m, seg.CaptureIndex)
				if capture != nil {
...
// reLavaSwimmingTransformErrReader is a reader that always returns an error.
type reLavaSwimmingTransformErrReader struct {
	err error
}

func (r *reLavaSwimmingTransformErrReader) Read(p []byte) (int, error) {
	return 0, r.err
}

// getCaptureByIndex returns the capture group value by its index.
func (ReLavaSwimming) getCaptureByIndex(m *ReLavaSwimmingBytesResult, index int) []byte {
	switch index {
	case 0:
		return m.Match
	default:
...
//	})
func (ReLavaSwimming) SelectReader(r io.Reader, pred func(*ReLavaSwimmingBytesResult) bool) io.Reader {
	cfg := stream.DefaultTransformConfig()
	cfg.MaxLeftover = 1048576

	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReLavaSwimming{}.processSelect(data, isEOF, pred, emitOut)
	}
...
func (ReLavaSwimming) processSelect(data []byte, isEOF bool, pred func(*ReLavaSwimmingBytesResult) bool, emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReLavaSwimmingBytesResult{}
...
//	})
func (ReLavaSwimming) RejectReader(r io.Reader, pred func(*ReLavaSwimmingBytesResult) bool) io.Reader {
	cfg := stream.DefaultTransformConfig()
	cfg.MaxLeftover = 1048576

	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReLavaSwimming{}.processReject(data, isEOF, pred, emitOut)
	}
...
func (ReLavaSwimming) processReject(data []byte, isEOF bool, pred func(*ReLavaSwimmingBytesResult) bool, emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReLavaSwimmingBytesResult{}
...
func (r *ReLavaSwimmingResult) CaptureByIndex(idx int) string {
	switch idx {
	case 0:
		return r.Match
	case 1:
...
// CaptureByIndex returns the capture group value by its 0-based index.
// Index 0 returns the full match, 1+ returns capture groups.
func (r *ReLavaSwimmingBytesResult) CaptureByIndex(idx int) []byte {
	switch idx {
	case 0:
		return r.Match
	case 1:
...
func (ReLavaSwimming) ReplaceAllString(input string, template string) string {
	...
	lastEnd := 0
	var r ReLavaSwimmingResult

	remaining := input
	offset := 0

	for {
		match, ok := ReLavaSwimming{}.FindStringReuse(remaining, &r)
		if !ok {
			break
		}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReLavaSwimming) ReplaceAllBytes(input []byte, template string) []byte {
	return ReLavaSwimming{}.ReplaceAllBytesAppend(input, template, nil)
}

// ReplaceAllBytesAppend replaces all matches and appends to buf.
// If buf has sufficient capacity, no allocation occurs.
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReLavaSwimming) ReplaceAllBytesAppend(input []byte, template string, buf []byte) []byte {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	result := buf[:0]
	lastEnd := 0
	var r ReLavaSwimmingBytesResult

	remaining := input
	offset := 0

	for {
		match, ok := ReLavaSwimming{}.FindBytesReuse(remaining, &r)
		if !ok {
			break
		}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReLavaSwimming) ReplaceFirstString(input string, template string) string {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	var r ReLavaSwimmingResult
	match, ok := ReLavaSwimming{}.FindStringReuse(input, &r)
	if !ok {
		return input
	}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReLavaSwimming) ReplaceFirstBytes(input []byte, template string) []byte {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	var r ReLavaSwimmingBytesResult
	match, ok := ReLavaSwimming{}.FindBytesReuse(input, &r)
	if !ok {
...
// ReLavaSwimmingReplaceTemplate holds a pre-compiled replace template for the ReLavaSwimming pattern.
// Use CompileReplaceTemplate to create one, then call its Replace methods.
type ReLavaSwimmingReplaceTemplate struct {
	original string
...
//
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReLavaSwimming) CompileReplaceTemplate(template string) (*ReLavaSwimmingReplaceTemplate, error) {
	tmpl, err := replace.Parse(template)
	if err != nil {
		return nil, err
	}
	...
	return &ReLavaSwimmingReplaceTemplate{
		original: template,
		segments: resolved,
	}, nil
}
...
func (t *ReLavaSwimmingReplaceTemplate) String() string {
	return t.original
}

// ReplaceAllString replaces all matches in input using this compiled template.
func (t *ReLavaSwimmingReplaceTemplate) ReplaceAllString(input string) string {
	var result strings.Builder
	lastEnd := 0
	var r ReLavaSwimmingResult
...
func (t *ReLavaSwimmingReplaceTemplate) ReplaceAllBytes(input []byte) []byte {
	return t.ReplaceAllBytesAppend(input, nil)
}

// ReplaceAllBytesAppend replaces all matches and appends to buf.
// If buf has sufficient capacity, no allocation occurs.
func (t *ReLavaSwimmingReplaceTemplate) ReplaceAllBytesAppend(input []byte, buf []byte) []byte {
	result := buf[:0]
	lastEnd := 0
	var r ReLavaSwimmingBytesResult
...
func (t *ReLavaSwimmingReplaceTemplate) ReplaceFirstString(input string) string {
	var r ReLavaSwimmingResult
	match, ok := ReLavaSwimming{}.FindStringReuse(input, &r)
	if !ok {
		return input
...
func (t *ReLavaSwimmingReplaceTemplate) ReplaceFirstBytes(input []byte) []byte {
	var r ReLavaSwimmingBytesResult
	match, ok := ReLavaSwimming{}.FindBytesReuse(input, &r)
	if !ok {
		return append([]byte{}, input...)
