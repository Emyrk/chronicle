...
// Code generated by regengo for pattern: (.+[^\s]) attacks\. (.+[^\s]) (absorbs|resists) all the damage\.
// DO NOT EDIT.

var reDamageAbsorbResistStackPool = sync.Pool{New: func() interface{} {
	stack := make([][3]int, 0, 32)
	return &stack
}}

var reDamageAbsorbResistCaptureStackPool = sync.Pool{New: func() interface{} {
	stack := make([]int, 0, 128)
	return &stack
}}

type ReDamageAbsorbResist struct{}

var CompiledReDamageAbsorbResist = ReDamageAbsorbResist{}

// MinMatchLen is the minimum number of bytes any match can have.
const ReDamageAbsorbResistMinMatchLen = 38

// MaxMatchLen is the maximum number of bytes any match can have.
// -1 means unbounded (pattern contains * or + quantifiers).
const ReDamageAbsorbResistMaxMatchLen = -1

func (ReDamageAbsorbResist) MatchLengthInfo() (minLen, maxLen int) {
	return ReDamageAbsorbResistMinMatchLen, ReDamageAbsorbResistMaxMatchLen
}

func (ReDamageAbsorbResist) MatchString(input string) bool {
	l := len(input)
	offset := 0
	stackPtr := reDamageAbsorbResistStackPool.Get().(*[][3]int)
	stack := (*stackPtr)[:0]
	defer func() {
		for i := range stack {
			stack[i] = [3]int{0, 0, 0}
		...
		*stackPtr = stack[:0]
		reDamageAbsorbResistStackPool.Put(stackPtr)
	}()
	nextInstruction := 1
	goto StepSelect
TryFallback:
...
func (ReDamageAbsorbResist) MatchBytes(input []byte) bool {
	l := len(input)
	offset := 0
	stackPtr := reDamageAbsorbResistStackPool.Get().(*[][3]int)
	stack := (*stackPtr)[:0]
...
type ReDamageAbsorbResistResult struct {
...
type ReDamageAbsorbResistBytesResult struct {
...
func (ReDamageAbsorbResist) FindStringReuse(input string, r *ReDamageAbsorbResistResult) (*ReDamageAbsorbResistResult, bool) {
	l := len(input)
	offset := 0
	var captures [8]int
	captureStackPtr := reDamageAbsorbResistCaptureStackPool.Get().(*[]int)
	captureStack := (*captureStackPtr)[:0]
	defer func() {
		*captureStackPtr = captureStack[:0]
		reDamageAbsorbResistCaptureStackPool.Put(captureStackPtr)
	}()
	stackPtr := reDamageAbsorbResistStackPool.Get().(*[][3]int)
	stack := (*stackPtr)[:0]
	defer func() {
...
Ins18:
	{
		captureStack = append(captureStack, captures[:]...)
		stack = append(stack, [3]int{offset, 19, 1})
		goto Ins17
	}
Ins19:
	{
...
Ins37:
	{
		captureStack = append(captureStack, captures[:]...)
		stack = append(stack, [3]int{offset, 30, 1})
		goto Ins23
	}
Ins38:
	{
...
func (recv ReDamageAbsorbResist) FindString(input string) (*ReDamageAbsorbResistResult, bool) {
	return recv.FindStringReuse(input, nil)
}
func (ReDamageAbsorbResist) FindAllStringAppend(input string, n int, s []*ReDamageAbsorbResistResult) []*ReDamageAbsorbResistResult {
	if n == 0 {
		return s
	}
	result := s
	...
	Ins55:
		{
			captures[1] = offset
			var item *ReDamageAbsorbResistResult
			if len(result) < cap(result) {
				result = result[:len(result)+1]
				item = result[len(result)-1]
				if item == nil {
					item = &ReDamageAbsorbResistResult{}
...
func (r ReDamageAbsorbResist) FindAllString(input string, n int) []*ReDamageAbsorbResistResult {
	return r.FindAllStringAppend(input, n, nil)
}
func (ReDamageAbsorbResist) FindBytesReuse(input []byte, r *ReDamageAbsorbResistBytesResult) (*ReDamageAbsorbResistBytesResult, bool) {
	l := len(input)
	offset := 0
	var captures [8]int
	captureStackPtr := reDamageAbsorbResistCaptureStackPool.Get().(*[]int)
...
Ins55:
	{
		captures[1] = offset
		if r == nil {
			r = &ReDamageAbsorbResistBytesResult{}
		}
...
func (recv ReDamageAbsorbResist) FindBytes(input []byte) (*ReDamageAbsorbResistBytesResult, bool) {
	return recv.FindBytesReuse(input, nil)
}
func (ReDamageAbsorbResist) FindAllBytesAppend(input []byte, n int, s []*ReDamageAbsorbResistBytesResult) []*ReDamageAbsorbResistBytesResult {
	if n == 0 {
		return s
	}
	result := s
	...
	Ins55:
		{
			captures[1] = offset
			var item *ReDamageAbsorbResistBytesResult
			if len(result) < cap(result) {
				result = result[:len(result)+1]
				item = result[len(result)-1]
				if item == nil {
					item = &ReDamageAbsorbResistBytesResult{}
					result[len(result)-1] = item
				}
			} else {
				item = &ReDamageAbsorbResistBytesResult{}
...
func (r ReDamageAbsorbResist) FindAllBytes(input []byte, n int) []*ReDamageAbsorbResistBytesResult {
...
func (ReDamageAbsorbResist) DefaultMaxLeftover() int {
	return 1048576
}
...
func (ReDamageAbsorbResist) FindReader(r io.Reader, cfg stream.Config, onMatch func(stream.Match[*ReDamageAbsorbResistBytesResult]) bool) error {
	...
	reuseResult := &ReDamageAbsorbResistBytesResult{}
			...
			if err == io.EOF {
				...
				if leftover > 0 {
					...
					for searchPos < len(chunk) {
						result, ok := ReDamageAbsorbResist{}.FindBytesReuse(chunk[searchPos:], reuseResult)
						if !ok {
							break
						}
						...
						m := stream.Match[*ReDamageAbsorbResistBytesResult]{
...
func (ReDamageAbsorbResist) FindReaderCount(r io.Reader, cfg stream.Config) (int64, error) {
	var count int64
	err := ReDamageAbsorbResist{}.FindReader(r, cfg, func(_ stream.Match[*ReDamageAbsorbResistBytesResult]) bool {
		count++
		return true
	})
	return count, err
...
func (ReDamageAbsorbResist) FindReaderFirst(r io.Reader, cfg stream.Config) (*ReDamageAbsorbResistBytesResult, int64, error) {
	var result *ReDamageAbsorbResistBytesResult
	var offset int64
	err := ReDamageAbsorbResist{}.FindReader(r, cfg, func(m stream.Match[*ReDamageAbsorbResistBytesResult]) bool {
		// Copy the result since buffer will be reused
		result = ReDamageAbsorbResist{}.copyBytesResult(m.Result)
...
func (ReDamageAbsorbResist) copyBytesResult(src *ReDamageAbsorbResistBytesResult) *ReDamageAbsorbResistBytesResult {
	if src == nil {
		return nil
	}
	dst := &ReDamageAbsorbResistBytesResult{}
	// Copy Match slice
...
//	    })
//	io.Copy(os.Stdout, r)
func (ReDamageAbsorbResist) NewTransformReader(r io.Reader, cfg stream.TransformConfig, onMatch func(match *ReDamageAbsorbResistBytesResult, emit func([]byte))) io.Reader {
	if cfg.BufferSize == 0 {
	...
	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReDamageAbsorbResist{}.processTransform(data, isEOF, onMatch, emitOut)
	}
...
func (ReDamageAbsorbResist) processTransform(data []byte, isEOF bool, onMatch func(match *ReDamageAbsorbResistBytesResult, emit func([]byte)), emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReDamageAbsorbResistBytesResult{}

	for {
		result, ok := ReDamageAbsorbResist{}.FindBytesReuse(data[processed:], reuseResult)
		if !ok {
			// No more matches
			if isEOF {
...
//	io.Copy(os.Stdout, r)
func (ReDamageAbsorbResist) ReplaceReader(r io.Reader, template string) io.Reader {
	parsed, err := replace.Parse(template)
	if err != nil {
		return &reDamageAbsorbResistTransformErrReader{err: err}
	}
	...
	return ReDamageAbsorbResist{}.NewTransformReader(r, stream.DefaultTransformConfig(), func(m *ReDamageAbsorbResistBytesResult, emit func([]byte)) {
		...
		for _, seg := range resolved {
			...
			case replace.SegmentCaptureIndex:
				capture := (ReDamageAbsorbResist{}).getCaptureByIndex(m, seg.CaptureIndex)
				if capture != nil {
...
// reDamageAbsorbResistTransformErrReader is a reader that always returns an error.
type reDamageAbsorbResistTransformErrReader struct {
	err error
}

func (r *reDamageAbsorbResistTransformErrReader) Read(p []byte) (int, error) {
	return 0, r.err
}

// getCaptureByIndex returns the capture group value by its index.
func (ReDamageAbsorbResist) getCaptureByIndex(m *ReDamageAbsorbResistBytesResult, index int) []byte {
	switch index {
	case 0:
		return m.Match
	default:
...
//	})
func (ReDamageAbsorbResist) SelectReader(r io.Reader, pred func(*ReDamageAbsorbResistBytesResult) bool) io.Reader {
	cfg := stream.DefaultTransformConfig()
	cfg.MaxLeftover = 1048576

	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReDamageAbsorbResist{}.processSelect(data, isEOF, pred, emitOut)
	}
...
func (ReDamageAbsorbResist) processSelect(data []byte, isEOF bool, pred func(*ReDamageAbsorbResistBytesResult) bool, emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReDamageAbsorbResistBytesResult{}
...
//	})
func (ReDamageAbsorbResist) RejectReader(r io.Reader, pred func(*ReDamageAbsorbResistBytesResult) bool) io.Reader {
	cfg := stream.DefaultTransformConfig()
	cfg.MaxLeftover = 1048576

	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReDamageAbsorbResist{}.processReject(data, isEOF, pred, emitOut)
	}
...
func (ReDamageAbsorbResist) processReject(data []byte, isEOF bool, pred func(*ReDamageAbsorbResistBytesResult) bool, emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReDamageAbsorbResistBytesResult{}
...
func (r *ReDamageAbsorbResistResult) CaptureByIndex(idx int) string {
	switch idx {
	case 0:
		return r.Match
	case 1:
...
// CaptureByIndex returns the capture group value by its 0-based index.
// Index 0 returns the full match, 1+ returns capture groups.
func (r *ReDamageAbsorbResistBytesResult) CaptureByIndex(idx int) []byte {
	switch idx {
	case 0:
		return r.Match
	case 1:
...
func (ReDamageAbsorbResist) ReplaceAllString(input string, template string) string {
	...
	lastEnd := 0
	var r ReDamageAbsorbResistResult

	remaining := input
	offset := 0

	for {
		match, ok := ReDamageAbsorbResist{}.FindStringReuse(remaining, &r)
		if !ok {
			break
		}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageAbsorbResist) ReplaceAllBytes(input []byte, template string) []byte {
	return ReDamageAbsorbResist{}.ReplaceAllBytesAppend(input, template, nil)
}

// ReplaceAllBytesAppend replaces all matches and appends to buf.
// If buf has sufficient capacity, no allocation occurs.
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageAbsorbResist) ReplaceAllBytesAppend(input []byte, template string, buf []byte) []byte {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	result := buf[:0]
	lastEnd := 0
	var r ReDamageAbsorbResistBytesResult

	remaining := input
	offset := 0

	for {
		match, ok := ReDamageAbsorbResist{}.FindBytesReuse(remaining, &r)
		if !ok {
			break
		}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageAbsorbResist) ReplaceFirstString(input string, template string) string {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	var r ReDamageAbsorbResistResult
	match, ok := ReDamageAbsorbResist{}.FindStringReuse(input, &r)
	if !ok {
		return input
	}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageAbsorbResist) ReplaceFirstBytes(input []byte, template string) []byte {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	var r ReDamageAbsorbResistBytesResult
	match, ok := ReDamageAbsorbResist{}.FindBytesReuse(input, &r)
	if !ok {
...
// ReDamageAbsorbResistReplaceTemplate holds a pre-compiled replace template for the ReDamageAbsorbResist pattern.
// Use CompileReplaceTemplate to create one, then call its Replace methods.
type ReDamageAbsorbResistReplaceTemplate struct {
	original string
...
//
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageAbsorbResist) CompileReplaceTemplate(template string) (*ReDamageAbsorbResistReplaceTemplate, error) {
	tmpl, err := replace.Parse(template)
	if err != nil {
		return nil, err
	}
	...
	return &ReDamageAbsorbResistReplaceTemplate{
		original: template,
		segments: resolved,
	}, nil
}
...
func (t *ReDamageAbsorbResistReplaceTemplate) String() string {
	return t.original
}

// ReplaceAllString replaces all matches in input using this compiled template.
func (t *ReDamageAbsorbResistReplaceTemplate) ReplaceAllString(input string) string {
	var result strings.Builder
	lastEnd := 0
	var r ReDamageAbsorbResistResult
...
func (t *ReDamageAbsorbResistReplaceTemplate) ReplaceAllBytes(input []byte) []byte {
	return t.ReplaceAllBytesAppend(input, nil)
}

// ReplaceAllBytesAppend replaces all matches and appends to buf.
// If buf has sufficient capacity, no allocation occurs.
func (t *ReDamageAbsorbResistReplaceTemplate) ReplaceAllBytesAppend(input []byte, buf []byte) []byte {
	result := buf[:0]
	lastEnd := 0
	var r ReDamageAbsorbResistBytesResult
...
func (t *ReDamageAbsorbResistReplaceTemplate) ReplaceFirstString(input string) string {
	var r ReDamageAbsorbResistResult
	match, ok := ReDamageAbsorbResist{}.FindStringReuse(input, &r)
	if !ok {
		return input
...
func (t *ReDamageAbsorbResistReplaceTemplate) ReplaceFirstBytes(input []byte) []byte {
	var r ReDamageAbsorbResistBytesResult
	match, ok := ReDamageAbsorbResist{}.FindBytesReuse(input, &r)
	if !ok {
		return append([]byte{}, input...)
