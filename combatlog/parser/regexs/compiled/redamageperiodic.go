...
// Code generated by regengo for pattern: (.+[^\s]) suffers (\d+) ([a-zA-Z]+) damage from (.+[^\s])'s (.+[^\s])\.\s?(.*)
// DO NOT EDIT.

var reDamagePeriodicStackPool = sync.Pool{New: func() interface{} {
	stack := make([][3]int, 0, 32)
	return &stack
}}

var reDamagePeriodicCaptureStackPool = sync.Pool{New: func() interface{} {
	stack := make([]int, 0, 224)
	return &stack
}}

type ReDamagePeriodic struct{}

var CompiledReDamagePeriodic = ReDamagePeriodic{}

// MinMatchLen is the minimum number of bytes any match can have.
const ReDamagePeriodicMinMatchLen = 35

// MaxMatchLen is the maximum number of bytes any match can have.
// -1 means unbounded (pattern contains * or + quantifiers).
const ReDamagePeriodicMaxMatchLen = -1

func (ReDamagePeriodic) MatchLengthInfo() (minLen, maxLen int) {
	return ReDamagePeriodicMinMatchLen, ReDamagePeriodicMaxMatchLen
}

func (ReDamagePeriodic) MatchString(input string) bool {
	l := len(input)
	offset := 0
	stackPtr := reDamagePeriodicStackPool.Get().(*[][3]int)
	stack := (*stackPtr)[:0]
	defer func() {
		for i := range stack {
			stack[i] = [3]int{0, 0, 0}
		...
		*stackPtr = stack[:0]
		reDamagePeriodicStackPool.Put(stackPtr)
	}()
	nextInstruction := 1
	goto StepSelect
TryFallback:
...
func (ReDamagePeriodic) MatchBytes(input []byte) bool {
	l := len(input)
	offset := 0
	stackPtr := reDamagePeriodicStackPool.Get().(*[][3]int)
	stack := (*stackPtr)[:0]
...
type ReDamagePeriodicResult struct {
...
type ReDamagePeriodicBytesResult struct {
...
func (ReDamagePeriodic) FindStringReuse(input string, r *ReDamagePeriodicResult) (*ReDamagePeriodicResult, bool) {
	l := len(input)
	offset := 0
	var captures [14]int
	stackPtr := reDamagePeriodicStackPool.Get().(*[][3]int)
...
Ins55:
	{
		stack = append(stack, [3]int{offset, 56, 0})
		goto Ins54
	}
Ins56:
	{
...
func (recv ReDamagePeriodic) FindString(input string) (*ReDamagePeriodicResult, bool) {
	return recv.FindStringReuse(input, nil)
}
func (ReDamagePeriodic) FindAllStringAppend(input string, n int, s []*ReDamagePeriodicResult) []*ReDamagePeriodicResult {
	if n == 0 {
		return s
	}
	result := s
	...
	Ins57:
		{
			captures[1] = offset
			var item *ReDamagePeriodicResult
			if len(result) < cap(result) {
				result = result[:len(result)+1]
				item = result[len(result)-1]
				if item == nil {
					item = &ReDamagePeriodicResult{}
...
func (r ReDamagePeriodic) FindAllString(input string, n int) []*ReDamagePeriodicResult {
	return r.FindAllStringAppend(input, n, nil)
}
func (ReDamagePeriodic) FindBytesReuse(input []byte, r *ReDamagePeriodicBytesResult) (*ReDamagePeriodicBytesResult, bool) {
	l := len(input)
	offset := 0
	var captures [14]int
	stackPtr := reDamagePeriodicStackPool.Get().(*[][3]int)
...
func (recv ReDamagePeriodic) FindBytes(input []byte) (*ReDamagePeriodicBytesResult, bool) {
	return recv.FindBytesReuse(input, nil)
}
func (ReDamagePeriodic) FindAllBytesAppend(input []byte, n int, s []*ReDamagePeriodicBytesResult) []*ReDamagePeriodicBytesResult {
	if n == 0 {
		return s
	}
	result := s
	...
	Ins57:
		{
			captures[1] = offset
			var item *ReDamagePeriodicBytesResult
			if len(result) < cap(result) {
				result = result[:len(result)+1]
				item = result[len(result)-1]
				if item == nil {
					item = &ReDamagePeriodicBytesResult{}
					result[len(result)-1] = item
				}
			} else {
				item = &ReDamagePeriodicBytesResult{}
...
func (r ReDamagePeriodic) FindAllBytes(input []byte, n int) []*ReDamagePeriodicBytesResult {
...
func (ReDamagePeriodic) DefaultMaxLeftover() int {
	return 1048576
}
...
func (ReDamagePeriodic) FindReader(r io.Reader, cfg stream.Config, onMatch func(stream.Match[*ReDamagePeriodicBytesResult]) bool) error {
	...
	reuseResult := &ReDamagePeriodicBytesResult{}
			...
			if err == io.EOF {
				...
				if leftover > 0 {
					...
					for searchPos < len(chunk) {
						result, ok := ReDamagePeriodic{}.FindBytesReuse(chunk[searchPos:], reuseResult)
						if !ok {
							break
						}
						...
						m := stream.Match[*ReDamagePeriodicBytesResult]{
...
func (ReDamagePeriodic) FindReaderCount(r io.Reader, cfg stream.Config) (int64, error) {
	var count int64
	err := ReDamagePeriodic{}.FindReader(r, cfg, func(_ stream.Match[*ReDamagePeriodicBytesResult]) bool {
		count++
		return true
	})
	return count, err
...
func (ReDamagePeriodic) FindReaderFirst(r io.Reader, cfg stream.Config) (*ReDamagePeriodicBytesResult, int64, error) {
	var result *ReDamagePeriodicBytesResult
	var offset int64
	err := ReDamagePeriodic{}.FindReader(r, cfg, func(m stream.Match[*ReDamagePeriodicBytesResult]) bool {
		// Copy the result since buffer will be reused
		result = ReDamagePeriodic{}.copyBytesResult(m.Result)
...
func (ReDamagePeriodic) copyBytesResult(src *ReDamagePeriodicBytesResult) *ReDamagePeriodicBytesResult {
	if src == nil {
		return nil
	}
	dst := &ReDamagePeriodicBytesResult{}
	// Copy Match slice
...
//	    })
//	io.Copy(os.Stdout, r)
func (ReDamagePeriodic) NewTransformReader(r io.Reader, cfg stream.TransformConfig, onMatch func(match *ReDamagePeriodicBytesResult, emit func([]byte))) io.Reader {
	if cfg.BufferSize == 0 {
	...
	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReDamagePeriodic{}.processTransform(data, isEOF, onMatch, emitOut)
	}
...
func (ReDamagePeriodic) processTransform(data []byte, isEOF bool, onMatch func(match *ReDamagePeriodicBytesResult, emit func([]byte)), emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReDamagePeriodicBytesResult{}

	for {
		result, ok := ReDamagePeriodic{}.FindBytesReuse(data[processed:], reuseResult)
		if !ok {
			// No more matches
			if isEOF {
...
//	io.Copy(os.Stdout, r)
func (ReDamagePeriodic) ReplaceReader(r io.Reader, template string) io.Reader {
	parsed, err := replace.Parse(template)
	if err != nil {
		return &reDamagePeriodicTransformErrReader{err: err}
	}
	...
	return ReDamagePeriodic{}.NewTransformReader(r, stream.DefaultTransformConfig(), func(m *ReDamagePeriodicBytesResult, emit func([]byte)) {
		...
		for _, seg := range resolved {
			...
			case replace.SegmentCaptureIndex:
				capture := (ReDamagePeriodic{}).getCaptureByIndex(m, seg.CaptureIndex)
				if capture != nil {
...
// reDamagePeriodicTransformErrReader is a reader that always returns an error.
type reDamagePeriodicTransformErrReader struct {
	err error
}

func (r *reDamagePeriodicTransformErrReader) Read(p []byte) (int, error) {
	return 0, r.err
}

// getCaptureByIndex returns the capture group value by its index.
func (ReDamagePeriodic) getCaptureByIndex(m *ReDamagePeriodicBytesResult, index int) []byte {
	switch index {
	case 0:
		return m.Match
	default:
...
//	})
func (ReDamagePeriodic) SelectReader(r io.Reader, pred func(*ReDamagePeriodicBytesResult) bool) io.Reader {
	cfg := stream.DefaultTransformConfig()
	cfg.MaxLeftover = 1048576

	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReDamagePeriodic{}.processSelect(data, isEOF, pred, emitOut)
	}
...
func (ReDamagePeriodic) processSelect(data []byte, isEOF bool, pred func(*ReDamagePeriodicBytesResult) bool, emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReDamagePeriodicBytesResult{}
...
//	})
func (ReDamagePeriodic) RejectReader(r io.Reader, pred func(*ReDamagePeriodicBytesResult) bool) io.Reader {
	cfg := stream.DefaultTransformConfig()
	cfg.MaxLeftover = 1048576

	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReDamagePeriodic{}.processReject(data, isEOF, pred, emitOut)
	}
...
func (ReDamagePeriodic) processReject(data []byte, isEOF bool, pred func(*ReDamagePeriodicBytesResult) bool, emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReDamagePeriodicBytesResult{}
...
func (r *ReDamagePeriodicResult) CaptureByIndex(idx int) string {
	switch idx {
	case 0:
		return r.Match
	case 1:
...
// CaptureByIndex returns the capture group value by its 0-based index.
// Index 0 returns the full match, 1+ returns capture groups.
func (r *ReDamagePeriodicBytesResult) CaptureByIndex(idx int) []byte {
	switch idx {
	case 0:
		return r.Match
	case 1:
...
func (ReDamagePeriodic) ReplaceAllString(input string, template string) string {
	...
	lastEnd := 0
	var r ReDamagePeriodicResult

	remaining := input
	offset := 0

	for {
		match, ok := ReDamagePeriodic{}.FindStringReuse(remaining, &r)
		if !ok {
			break
		}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamagePeriodic) ReplaceAllBytes(input []byte, template string) []byte {
	return ReDamagePeriodic{}.ReplaceAllBytesAppend(input, template, nil)
}

// ReplaceAllBytesAppend replaces all matches and appends to buf.
// If buf has sufficient capacity, no allocation occurs.
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamagePeriodic) ReplaceAllBytesAppend(input []byte, template string, buf []byte) []byte {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	result := buf[:0]
	lastEnd := 0
	var r ReDamagePeriodicBytesResult

	remaining := input
	offset := 0

	for {
		match, ok := ReDamagePeriodic{}.FindBytesReuse(remaining, &r)
		if !ok {
			break
		}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamagePeriodic) ReplaceFirstString(input string, template string) string {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	var r ReDamagePeriodicResult
	match, ok := ReDamagePeriodic{}.FindStringReuse(input, &r)
	if !ok {
		return input
	}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamagePeriodic) ReplaceFirstBytes(input []byte, template string) []byte {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	var r ReDamagePeriodicBytesResult
	match, ok := ReDamagePeriodic{}.FindBytesReuse(input, &r)
	if !ok {
...
// ReDamagePeriodicReplaceTemplate holds a pre-compiled replace template for the ReDamagePeriodic pattern.
// Use CompileReplaceTemplate to create one, then call its Replace methods.
type ReDamagePeriodicReplaceTemplate struct {
	original string
...
//
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamagePeriodic) CompileReplaceTemplate(template string) (*ReDamagePeriodicReplaceTemplate, error) {
	tmpl, err := replace.Parse(template)
	if err != nil {
		return nil, err
	}
	...
	return &ReDamagePeriodicReplaceTemplate{
		original: template,
		segments: resolved,
	}, nil
}
...
func (t *ReDamagePeriodicReplaceTemplate) String() string {
	return t.original
}

// ReplaceAllString replaces all matches in input using this compiled template.
func (t *ReDamagePeriodicReplaceTemplate) ReplaceAllString(input string) string {
	var result strings.Builder
	lastEnd := 0
	var r ReDamagePeriodicResult
...
func (t *ReDamagePeriodicReplaceTemplate) ReplaceAllBytes(input []byte) []byte {
	return t.ReplaceAllBytesAppend(input, nil)
}

// ReplaceAllBytesAppend replaces all matches and appends to buf.
// If buf has sufficient capacity, no allocation occurs.
func (t *ReDamagePeriodicReplaceTemplate) ReplaceAllBytesAppend(input []byte, buf []byte) []byte {
	result := buf[:0]
	lastEnd := 0
	var r ReDamagePeriodicBytesResult
...
func (t *ReDamagePeriodicReplaceTemplate) ReplaceFirstString(input string) string {
	var r ReDamagePeriodicResult
	match, ok := ReDamagePeriodic{}.FindStringReuse(input, &r)
	if !ok {
		return input
...
func (t *ReDamagePeriodicReplaceTemplate) ReplaceFirstBytes(input []byte) []byte {
	var r ReDamagePeriodicBytesResult
	match, ok := ReDamagePeriodic{}.FindBytesReuse(input, &r)
	if !ok {
		return append([]byte{}, input...)
