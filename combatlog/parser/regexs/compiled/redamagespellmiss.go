...
// Code generated by regengo for pattern: (.+[^\s])'s (.+[^\s]) misse(s|d) (.+[^\s])\.
// DO NOT EDIT.

var reDamageSpellMissStackPool = sync.Pool{New: func() interface{} {
	stack := make([][3]int, 0, 32)
	return &stack
}}

var reDamageSpellMissCaptureStackPool = sync.Pool{New: func() interface{} {
	stack := make([]int, 0, 160)
	return &stack
}}

type ReDamageSpellMiss struct{}

var CompiledReDamageSpellMiss = ReDamageSpellMiss{}

// MinMatchLen is the minimum number of bytes any match can have.
const ReDamageSpellMissMinMatchLen = 18

// MaxMatchLen is the maximum number of bytes any match can have.
// -1 means unbounded (pattern contains * or + quantifiers).
const ReDamageSpellMissMaxMatchLen = -1

func (ReDamageSpellMiss) MatchLengthInfo() (minLen, maxLen int) {
	return ReDamageSpellMissMinMatchLen, ReDamageSpellMissMaxMatchLen
}

func (ReDamageSpellMiss) MatchString(input string) bool {
	l := len(input)
	offset := 0
	stackPtr := reDamageSpellMissStackPool.Get().(*[][3]int)
	stack := (*stackPtr)[:0]
	defer func() {
		for i := range stack {
			stack[i] = [3]int{0, 0, 0}
		...
		*stackPtr = stack[:0]
		reDamageSpellMissStackPool.Put(stackPtr)
	}()
	nextInstruction := 1
	goto StepSelect
TryFallback:
...
Ins21:
	...
	{
		if input[offset] != uint8(0x64) && input[offset] != uint8(0x73) {
			goto TryFallback
		}
		offset++
		goto Ins22
...
func (ReDamageSpellMiss) MatchBytes(input []byte) bool {
	l := len(input)
	offset := 0
	stackPtr := reDamageSpellMissStackPool.Get().(*[][3]int)
	stack := (*stackPtr)[:0]
...
type ReDamageSpellMissResult struct {
...
type ReDamageSpellMissBytesResult struct {
...
func (ReDamageSpellMiss) FindStringReuse(input string, r *ReDamageSpellMissResult) (*ReDamageSpellMissResult, bool) {
	l := len(input)
	offset := 0
	var captures [10]int
	captureStackPtr := reDamageSpellMissCaptureStackPool.Get().(*[]int)
	captureStack := (*captureStackPtr)[:0]
	defer func() {
		*captureStackPtr = captureStack[:0]
		reDamageSpellMissCaptureStackPool.Put(captureStackPtr)
	}()
	stackPtr := reDamageSpellMissStackPool.Get().(*[][3]int)
	stack := (*stackPtr)[:0]
	defer func() {
...
func (recv ReDamageSpellMiss) FindString(input string) (*ReDamageSpellMissResult, bool) {
	return recv.FindStringReuse(input, nil)
}
func (ReDamageSpellMiss) FindAllStringAppend(input string, n int, s []*ReDamageSpellMissResult) []*ReDamageSpellMissResult {
	if n == 0 {
		return s
	}
	result := s
	...
	Ins30:
		{
			captures[1] = offset
			var item *ReDamageSpellMissResult
			if len(result) < cap(result) {
				result = result[:len(result)+1]
				item = result[len(result)-1]
				if item == nil {
					item = &ReDamageSpellMissResult{}
...
func (r ReDamageSpellMiss) FindAllString(input string, n int) []*ReDamageSpellMissResult {
	return r.FindAllStringAppend(input, n, nil)
}
func (ReDamageSpellMiss) FindBytesReuse(input []byte, r *ReDamageSpellMissBytesResult) (*ReDamageSpellMissBytesResult, bool) {
	l := len(input)
	offset := 0
	var captures [10]int
	captureStackPtr := reDamageSpellMissCaptureStackPool.Get().(*[]int)
...
Ins30:
	{
		captures[1] = offset
		if r == nil {
			r = &ReDamageSpellMissBytesResult{}
		}
...
func (recv ReDamageSpellMiss) FindBytes(input []byte) (*ReDamageSpellMissBytesResult, bool) {
	return recv.FindBytesReuse(input, nil)
}
func (ReDamageSpellMiss) FindAllBytesAppend(input []byte, n int, s []*ReDamageSpellMissBytesResult) []*ReDamageSpellMissBytesResult {
	if n == 0 {
		return s
	}
	result := s
	...
	Ins30:
		{
			captures[1] = offset
			var item *ReDamageSpellMissBytesResult
			if len(result) < cap(result) {
				result = result[:len(result)+1]
				item = result[len(result)-1]
				if item == nil {
					item = &ReDamageSpellMissBytesResult{}
					result[len(result)-1] = item
				}
			} else {
				item = &ReDamageSpellMissBytesResult{}
...
func (r ReDamageSpellMiss) FindAllBytes(input []byte, n int) []*ReDamageSpellMissBytesResult {
...
func (ReDamageSpellMiss) DefaultMaxLeftover() int {
	return 1048576
}
...
func (ReDamageSpellMiss) FindReader(r io.Reader, cfg stream.Config, onMatch func(stream.Match[*ReDamageSpellMissBytesResult]) bool) error {
	...
	reuseResult := &ReDamageSpellMissBytesResult{}
			...
			if err == io.EOF {
				...
				if leftover > 0 {
					...
					for searchPos < len(chunk) {
						result, ok := ReDamageSpellMiss{}.FindBytesReuse(chunk[searchPos:], reuseResult)
						if !ok {
							break
						}
						...
						m := stream.Match[*ReDamageSpellMissBytesResult]{
...
func (ReDamageSpellMiss) FindReaderCount(r io.Reader, cfg stream.Config) (int64, error) {
	var count int64
	err := ReDamageSpellMiss{}.FindReader(r, cfg, func(_ stream.Match[*ReDamageSpellMissBytesResult]) bool {
		count++
		return true
	})
	return count, err
...
func (ReDamageSpellMiss) FindReaderFirst(r io.Reader, cfg stream.Config) (*ReDamageSpellMissBytesResult, int64, error) {
	var result *ReDamageSpellMissBytesResult
	var offset int64
	err := ReDamageSpellMiss{}.FindReader(r, cfg, func(m stream.Match[*ReDamageSpellMissBytesResult]) bool {
		// Copy the result since buffer will be reused
		result = ReDamageSpellMiss{}.copyBytesResult(m.Result)
...
func (ReDamageSpellMiss) copyBytesResult(src *ReDamageSpellMissBytesResult) *ReDamageSpellMissBytesResult {
	if src == nil {
		return nil
	}
	dst := &ReDamageSpellMissBytesResult{}
	// Copy Match slice
...
//	    })
//	io.Copy(os.Stdout, r)
func (ReDamageSpellMiss) NewTransformReader(r io.Reader, cfg stream.TransformConfig, onMatch func(match *ReDamageSpellMissBytesResult, emit func([]byte))) io.Reader {
	if cfg.BufferSize == 0 {
	...
	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReDamageSpellMiss{}.processTransform(data, isEOF, onMatch, emitOut)
	}
...
func (ReDamageSpellMiss) processTransform(data []byte, isEOF bool, onMatch func(match *ReDamageSpellMissBytesResult, emit func([]byte)), emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReDamageSpellMissBytesResult{}

	for {
		result, ok := ReDamageSpellMiss{}.FindBytesReuse(data[processed:], reuseResult)
		if !ok {
			// No more matches
			if isEOF {
...
//	io.Copy(os.Stdout, r)
func (ReDamageSpellMiss) ReplaceReader(r io.Reader, template string) io.Reader {
	parsed, err := replace.Parse(template)
	if err != nil {
		return &reDamageSpellMissTransformErrReader{err: err}
	}
	...
	return ReDamageSpellMiss{}.NewTransformReader(r, stream.DefaultTransformConfig(), func(m *ReDamageSpellMissBytesResult, emit func([]byte)) {
		...
		for _, seg := range resolved {
			...
			case replace.SegmentCaptureIndex:
				capture := (ReDamageSpellMiss{}).getCaptureByIndex(m, seg.CaptureIndex)
				if capture != nil {
...
// reDamageSpellMissTransformErrReader is a reader that always returns an error.
type reDamageSpellMissTransformErrReader struct {
	err error
}

func (r *reDamageSpellMissTransformErrReader) Read(p []byte) (int, error) {
	return 0, r.err
}

// getCaptureByIndex returns the capture group value by its index.
func (ReDamageSpellMiss) getCaptureByIndex(m *ReDamageSpellMissBytesResult, index int) []byte {
	switch index {
	case 0:
		return m.Match
	default:
...
//	})
func (ReDamageSpellMiss) SelectReader(r io.Reader, pred func(*ReDamageSpellMissBytesResult) bool) io.Reader {
	cfg := stream.DefaultTransformConfig()
	cfg.MaxLeftover = 1048576

	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReDamageSpellMiss{}.processSelect(data, isEOF, pred, emitOut)
	}
...
func (ReDamageSpellMiss) processSelect(data []byte, isEOF bool, pred func(*ReDamageSpellMissBytesResult) bool, emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReDamageSpellMissBytesResult{}
...
//	})
func (ReDamageSpellMiss) RejectReader(r io.Reader, pred func(*ReDamageSpellMissBytesResult) bool) io.Reader {
	cfg := stream.DefaultTransformConfig()
	cfg.MaxLeftover = 1048576

	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReDamageSpellMiss{}.processReject(data, isEOF, pred, emitOut)
	}
...
func (ReDamageSpellMiss) processReject(data []byte, isEOF bool, pred func(*ReDamageSpellMissBytesResult) bool, emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReDamageSpellMissBytesResult{}
...
func (r *ReDamageSpellMissResult) CaptureByIndex(idx int) string {
	switch idx {
	case 0:
		return r.Match
	case 1:
...
// CaptureByIndex returns the capture group value by its 0-based index.
// Index 0 returns the full match, 1+ returns capture groups.
func (r *ReDamageSpellMissBytesResult) CaptureByIndex(idx int) []byte {
	switch idx {
	case 0:
		return r.Match
	case 1:
...
func (ReDamageSpellMiss) ReplaceAllString(input string, template string) string {
	...
	lastEnd := 0
	var r ReDamageSpellMissResult

	remaining := input
	offset := 0

	for {
		match, ok := ReDamageSpellMiss{}.FindStringReuse(remaining, &r)
		if !ok {
			break
		}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageSpellMiss) ReplaceAllBytes(input []byte, template string) []byte {
	return ReDamageSpellMiss{}.ReplaceAllBytesAppend(input, template, nil)
}

// ReplaceAllBytesAppend replaces all matches and appends to buf.
// If buf has sufficient capacity, no allocation occurs.
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageSpellMiss) ReplaceAllBytesAppend(input []byte, template string, buf []byte) []byte {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	result := buf[:0]
	lastEnd := 0
	var r ReDamageSpellMissBytesResult

	remaining := input
	offset := 0

	for {
		match, ok := ReDamageSpellMiss{}.FindBytesReuse(remaining, &r)
		if !ok {
			break
		}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageSpellMiss) ReplaceFirstString(input string, template string) string {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	var r ReDamageSpellMissResult
	match, ok := ReDamageSpellMiss{}.FindStringReuse(input, &r)
	if !ok {
		return input
	}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageSpellMiss) ReplaceFirstBytes(input []byte, template string) []byte {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	var r ReDamageSpellMissBytesResult
	match, ok := ReDamageSpellMiss{}.FindBytesReuse(input, &r)
	if !ok {
...
// ReDamageSpellMissReplaceTemplate holds a pre-compiled replace template for the ReDamageSpellMiss pattern.
// Use CompileReplaceTemplate to create one, then call its Replace methods.
type ReDamageSpellMissReplaceTemplate struct {
	original string
...
//
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageSpellMiss) CompileReplaceTemplate(template string) (*ReDamageSpellMissReplaceTemplate, error) {
	tmpl, err := replace.Parse(template)
	if err != nil {
		return nil, err
	}
	...
	return &ReDamageSpellMissReplaceTemplate{
		original: template,
		segments: resolved,
	}, nil
}
...
func (t *ReDamageSpellMissReplaceTemplate) String() string {
	return t.original
}

// ReplaceAllString replaces all matches in input using this compiled template.
func (t *ReDamageSpellMissReplaceTemplate) ReplaceAllString(input string) string {
	var result strings.Builder
	lastEnd := 0
	var r ReDamageSpellMissResult
...
func (t *ReDamageSpellMissReplaceTemplate) ReplaceAllBytes(input []byte) []byte {
	return t.ReplaceAllBytesAppend(input, nil)
}

// ReplaceAllBytesAppend replaces all matches and appends to buf.
// If buf has sufficient capacity, no allocation occurs.
func (t *ReDamageSpellMissReplaceTemplate) ReplaceAllBytesAppend(input []byte, buf []byte) []byte {
	result := buf[:0]
	lastEnd := 0
	var r ReDamageSpellMissBytesResult
...
func (t *ReDamageSpellMissReplaceTemplate) ReplaceFirstString(input string) string {
	var r ReDamageSpellMissResult
	match, ok := ReDamageSpellMiss{}.FindStringReuse(input, &r)
	if !ok {
		return input
...
func (t *ReDamageSpellMissReplaceTemplate) ReplaceFirstBytes(input []byte) []byte {
	var r ReDamageSpellMissBytesResult
	match, ok := ReDamageSpellMiss{}.FindBytesReuse(input, &r)
	if !ok {
		return append([]byte{}, input...)
