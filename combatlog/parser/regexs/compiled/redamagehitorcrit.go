...
// Code generated by regengo for pattern: (.+[^\s]) (cr|h)its (.+[^\s]) for (\d+)\.\s?(.*)
// DO NOT EDIT.

var reDamageHitOrCritStackPool = sync.Pool{New: func() interface{} {
	stack := make([][3]int, 0, 32)
	return &stack
}}

var reDamageHitOrCritCaptureStackPool = sync.Pool{New: func() interface{} {
	stack := make([]int, 0, 192)
	return &stack
}}

type ReDamageHitOrCrit struct{}

var CompiledReDamageHitOrCrit = ReDamageHitOrCrit{}

// MinMatchLen is the minimum number of bytes any match can have.
const ReDamageHitOrCritMinMatchLen = 17

// MaxMatchLen is the maximum number of bytes any match can have.
// -1 means unbounded (pattern contains * or + quantifiers).
const ReDamageHitOrCritMaxMatchLen = -1

func (ReDamageHitOrCrit) MatchLengthInfo() (minLen, maxLen int) {
	return ReDamageHitOrCritMinMatchLen, ReDamageHitOrCritMaxMatchLen
}

func (ReDamageHitOrCrit) MatchString(input string) bool {
	l := len(input)
	offset := 0
	stackPtr := reDamageHitOrCritStackPool.Get().(*[][3]int)
	stack := (*stackPtr)[:0]
	defer func() {
		for i := range stack {
			stack[i] = [3]int{0, 0, 0}
		...
		*stackPtr = stack[:0]
		reDamageHitOrCritStackPool.Put(stackPtr)
	}()
	nextInstruction := 1
	goto StepSelect
TryFallback:
...
func (ReDamageHitOrCrit) MatchBytes(input []byte) bool {
	l := len(input)
	offset := 0
	stackPtr := reDamageHitOrCritStackPool.Get().(*[][3]int)
	stack := (*stackPtr)[:0]
...
type ReDamageHitOrCritResult struct {
...
type ReDamageHitOrCritBytesResult struct {
...
func (ReDamageHitOrCrit) FindStringReuse(input string, r *ReDamageHitOrCritResult) (*ReDamageHitOrCritResult, bool) {
	l := len(input)
	offset := 0
	var captures [12]int
	stackPtr := reDamageHitOrCritStackPool.Get().(*[][3]int)
...
func (recv ReDamageHitOrCrit) FindString(input string) (*ReDamageHitOrCritResult, bool) {
	return recv.FindStringReuse(input, nil)
}
func (ReDamageHitOrCrit) FindAllStringAppend(input string, n int, s []*ReDamageHitOrCritResult) []*ReDamageHitOrCritResult {
	if n == 0 {
		return s
	}
	result := s
	...
	Ins38:
		{
			captures[1] = offset
			var item *ReDamageHitOrCritResult
			if len(result) < cap(result) {
				result = result[:len(result)+1]
				item = result[len(result)-1]
				if item == nil {
					item = &ReDamageHitOrCritResult{}
...
func (r ReDamageHitOrCrit) FindAllString(input string, n int) []*ReDamageHitOrCritResult {
	return r.FindAllStringAppend(input, n, nil)
}
func (ReDamageHitOrCrit) FindBytesReuse(input []byte, r *ReDamageHitOrCritBytesResult) (*ReDamageHitOrCritBytesResult, bool) {
	l := len(input)
	offset := 0
	var captures [12]int
	stackPtr := reDamageHitOrCritStackPool.Get().(*[][3]int)
...
Ins38:
	{
		captures[1] = offset
		if r == nil {
			r = &ReDamageHitOrCritBytesResult{}
		}
...
func (recv ReDamageHitOrCrit) FindBytes(input []byte) (*ReDamageHitOrCritBytesResult, bool) {
	return recv.FindBytesReuse(input, nil)
}
func (ReDamageHitOrCrit) FindAllBytesAppend(input []byte, n int, s []*ReDamageHitOrCritBytesResult) []*ReDamageHitOrCritBytesResult {
	if n == 0 {
		return s
	}
	result := s
	...
	Ins38:
		{
			captures[1] = offset
			var item *ReDamageHitOrCritBytesResult
			if len(result) < cap(result) {
				result = result[:len(result)+1]
				item = result[len(result)-1]
				if item == nil {
					item = &ReDamageHitOrCritBytesResult{}
					result[len(result)-1] = item
				}
			} else {
				item = &ReDamageHitOrCritBytesResult{}
...
func (r ReDamageHitOrCrit) FindAllBytes(input []byte, n int) []*ReDamageHitOrCritBytesResult {
...
func (ReDamageHitOrCrit) DefaultMaxLeftover() int {
	return 1048576
}
...
func (ReDamageHitOrCrit) FindReader(r io.Reader, cfg stream.Config, onMatch func(stream.Match[*ReDamageHitOrCritBytesResult]) bool) error {
	...
	reuseResult := &ReDamageHitOrCritBytesResult{}
			...
			if err == io.EOF {
				...
				if leftover > 0 {
					...
					for searchPos < len(chunk) {
						result, ok := ReDamageHitOrCrit{}.FindBytesReuse(chunk[searchPos:], reuseResult)
						if !ok {
							break
						}
						...
						m := stream.Match[*ReDamageHitOrCritBytesResult]{
...
func (ReDamageHitOrCrit) FindReaderCount(r io.Reader, cfg stream.Config) (int64, error) {
	var count int64
	err := ReDamageHitOrCrit{}.FindReader(r, cfg, func(_ stream.Match[*ReDamageHitOrCritBytesResult]) bool {
		count++
		return true
	})
	return count, err
...
func (ReDamageHitOrCrit) FindReaderFirst(r io.Reader, cfg stream.Config) (*ReDamageHitOrCritBytesResult, int64, error) {
	var result *ReDamageHitOrCritBytesResult
	var offset int64
	err := ReDamageHitOrCrit{}.FindReader(r, cfg, func(m stream.Match[*ReDamageHitOrCritBytesResult]) bool {
		// Copy the result since buffer will be reused
		result = ReDamageHitOrCrit{}.copyBytesResult(m.Result)
...
func (ReDamageHitOrCrit) copyBytesResult(src *ReDamageHitOrCritBytesResult) *ReDamageHitOrCritBytesResult {
	if src == nil {
		return nil
	}
	dst := &ReDamageHitOrCritBytesResult{}
	// Copy Match slice
...
//	    })
//	io.Copy(os.Stdout, r)
func (ReDamageHitOrCrit) NewTransformReader(r io.Reader, cfg stream.TransformConfig, onMatch func(match *ReDamageHitOrCritBytesResult, emit func([]byte))) io.Reader {
	if cfg.BufferSize == 0 {
	...
	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReDamageHitOrCrit{}.processTransform(data, isEOF, onMatch, emitOut)
	}
...
func (ReDamageHitOrCrit) processTransform(data []byte, isEOF bool, onMatch func(match *ReDamageHitOrCritBytesResult, emit func([]byte)), emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReDamageHitOrCritBytesResult{}

	for {
		result, ok := ReDamageHitOrCrit{}.FindBytesReuse(data[processed:], reuseResult)
		if !ok {
			// No more matches
			if isEOF {
...
//	io.Copy(os.Stdout, r)
func (ReDamageHitOrCrit) ReplaceReader(r io.Reader, template string) io.Reader {
	parsed, err := replace.Parse(template)
	if err != nil {
		return &reDamageHitOrCritTransformErrReader{err: err}
	}
	...
	return ReDamageHitOrCrit{}.NewTransformReader(r, stream.DefaultTransformConfig(), func(m *ReDamageHitOrCritBytesResult, emit func([]byte)) {
		...
		for _, seg := range resolved {
			...
			case replace.SegmentCaptureIndex:
				capture := (ReDamageHitOrCrit{}).getCaptureByIndex(m, seg.CaptureIndex)
				if capture != nil {
...
// reDamageHitOrCritTransformErrReader is a reader that always returns an error.
type reDamageHitOrCritTransformErrReader struct {
	err error
}

func (r *reDamageHitOrCritTransformErrReader) Read(p []byte) (int, error) {
	return 0, r.err
}

// getCaptureByIndex returns the capture group value by its index.
func (ReDamageHitOrCrit) getCaptureByIndex(m *ReDamageHitOrCritBytesResult, index int) []byte {
	switch index {
	case 0:
		return m.Match
	default:
...
//	})
func (ReDamageHitOrCrit) SelectReader(r io.Reader, pred func(*ReDamageHitOrCritBytesResult) bool) io.Reader {
	cfg := stream.DefaultTransformConfig()
	cfg.MaxLeftover = 1048576

	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReDamageHitOrCrit{}.processSelect(data, isEOF, pred, emitOut)
	}
...
func (ReDamageHitOrCrit) processSelect(data []byte, isEOF bool, pred func(*ReDamageHitOrCritBytesResult) bool, emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReDamageHitOrCritBytesResult{}
...
//	})
func (ReDamageHitOrCrit) RejectReader(r io.Reader, pred func(*ReDamageHitOrCritBytesResult) bool) io.Reader {
	cfg := stream.DefaultTransformConfig()
	cfg.MaxLeftover = 1048576

	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReDamageHitOrCrit{}.processReject(data, isEOF, pred, emitOut)
	}
...
func (ReDamageHitOrCrit) processReject(data []byte, isEOF bool, pred func(*ReDamageHitOrCritBytesResult) bool, emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReDamageHitOrCritBytesResult{}
...
func (r *ReDamageHitOrCritResult) CaptureByIndex(idx int) string {
	switch idx {
	case 0:
		return r.Match
	case 1:
...
// CaptureByIndex returns the capture group value by its 0-based index.
// Index 0 returns the full match, 1+ returns capture groups.
func (r *ReDamageHitOrCritBytesResult) CaptureByIndex(idx int) []byte {
	switch idx {
	case 0:
		return r.Match
	case 1:
...
func (ReDamageHitOrCrit) ReplaceAllString(input string, template string) string {
	...
	lastEnd := 0
	var r ReDamageHitOrCritResult

	remaining := input
	offset := 0

	for {
		match, ok := ReDamageHitOrCrit{}.FindStringReuse(remaining, &r)
		if !ok {
			break
		}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageHitOrCrit) ReplaceAllBytes(input []byte, template string) []byte {
	return ReDamageHitOrCrit{}.ReplaceAllBytesAppend(input, template, nil)
}

// ReplaceAllBytesAppend replaces all matches and appends to buf.
// If buf has sufficient capacity, no allocation occurs.
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageHitOrCrit) ReplaceAllBytesAppend(input []byte, template string, buf []byte) []byte {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	result := buf[:0]
	lastEnd := 0
	var r ReDamageHitOrCritBytesResult

	remaining := input
	offset := 0

	for {
		match, ok := ReDamageHitOrCrit{}.FindBytesReuse(remaining, &r)
		if !ok {
			break
		}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageHitOrCrit) ReplaceFirstString(input string, template string) string {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	var r ReDamageHitOrCritResult
	match, ok := ReDamageHitOrCrit{}.FindStringReuse(input, &r)
	if !ok {
		return input
	}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageHitOrCrit) ReplaceFirstBytes(input []byte, template string) []byte {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	var r ReDamageHitOrCritBytesResult
	match, ok := ReDamageHitOrCrit{}.FindBytesReuse(input, &r)
	if !ok {
...
// ReDamageHitOrCritReplaceTemplate holds a pre-compiled replace template for the ReDamageHitOrCrit pattern.
// Use CompileReplaceTemplate to create one, then call its Replace methods.
type ReDamageHitOrCritReplaceTemplate struct {
	original string
...
//
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageHitOrCrit) CompileReplaceTemplate(template string) (*ReDamageHitOrCritReplaceTemplate, error) {
	tmpl, err := replace.Parse(template)
	if err != nil {
		return nil, err
	}
	...
	return &ReDamageHitOrCritReplaceTemplate{
		original: template,
		segments: resolved,
	}, nil
}
...
func (t *ReDamageHitOrCritReplaceTemplate) String() string {
	return t.original
}

// ReplaceAllString replaces all matches in input using this compiled template.
func (t *ReDamageHitOrCritReplaceTemplate) ReplaceAllString(input string) string {
	var result strings.Builder
	lastEnd := 0
	var r ReDamageHitOrCritResult
...
func (t *ReDamageHitOrCritReplaceTemplate) ReplaceAllBytes(input []byte) []byte {
	return t.ReplaceAllBytesAppend(input, nil)
}

// ReplaceAllBytesAppend replaces all matches and appends to buf.
// If buf has sufficient capacity, no allocation occurs.
func (t *ReDamageHitOrCritReplaceTemplate) ReplaceAllBytesAppend(input []byte, buf []byte) []byte {
	result := buf[:0]
	lastEnd := 0
	var r ReDamageHitOrCritBytesResult
...
func (t *ReDamageHitOrCritReplaceTemplate) ReplaceFirstString(input string) string {
	var r ReDamageHitOrCritResult
	match, ok := ReDamageHitOrCrit{}.FindStringReuse(input, &r)
	if !ok {
		return input
...
func (t *ReDamageHitOrCritReplaceTemplate) ReplaceFirstBytes(input []byte) []byte {
	var r ReDamageHitOrCritBytesResult
	match, ok := ReDamageHitOrCrit{}.FindBytesReuse(input, &r)
	if !ok {
		return append([]byte{}, input...)
