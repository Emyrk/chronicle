...
// Code generated by regengo for pattern: (.+[^\s]) (casts|performs) (.+[^\s])\.
// DO NOT EDIT.

var reSpellCastPerformUnknownStackPool = sync.Pool{New: func() interface{} {
	stack := make([][3]int, 0, 32)
	return &stack
}}

var reSpellCastPerformUnknownCaptureStackPool = sync.Pool{New: func() interface{} {
	stack := make([]int, 0, 128)
	return &stack
}}

type ReSpellCastPerformUnknown struct{}

var CompiledReSpellCastPerformUnknown = ReSpellCastPerformUnknown{}

// MinMatchLen is the minimum number of bytes any match can have.
const ReSpellCastPerformUnknownMinMatchLen = 12

// MaxMatchLen is the maximum number of bytes any match can have.
// -1 means unbounded (pattern contains * or + quantifiers).
const ReSpellCastPerformUnknownMaxMatchLen = -1

func (ReSpellCastPerformUnknown) MatchLengthInfo() (minLen, maxLen int) {
	return ReSpellCastPerformUnknownMinMatchLen, ReSpellCastPerformUnknownMaxMatchLen
}

func (ReSpellCastPerformUnknown) MatchString(input string) bool {
	l := len(input)
	offset := 0
	stackPtr := reSpellCastPerformUnknownStackPool.Get().(*[][3]int)
	stack := (*stackPtr)[:0]
	defer func() {
		for i := range stack {
			stack[i] = [3]int{0, 0, 0}
		...
		*stackPtr = stack[:0]
		reSpellCastPerformUnknownStackPool.Put(stackPtr)
	}()
	nextInstruction := 1
	goto StepSelect
TryFallback:
...
func (ReSpellCastPerformUnknown) MatchBytes(input []byte) bool {
	l := len(input)
	offset := 0
	stackPtr := reSpellCastPerformUnknownStackPool.Get().(*[][3]int)
	stack := (*stackPtr)[:0]
...
type ReSpellCastPerformUnknownResult struct {
...
type ReSpellCastPerformUnknownBytesResult struct {
...
func (ReSpellCastPerformUnknown) FindStringReuse(input string, r *ReSpellCastPerformUnknownResult) (*ReSpellCastPerformUnknownResult, bool) {
	l := len(input)
	offset := 0
	var captures [8]int
	captureStackPtr := reSpellCastPerformUnknownCaptureStackPool.Get().(*[]int)
	captureStack := (*captureStackPtr)[:0]
	defer func() {
		*captureStackPtr = captureStack[:0]
		reSpellCastPerformUnknownCaptureStackPool.Put(captureStackPtr)
	}()
	stackPtr := reSpellCastPerformUnknownStackPool.Get().(*[][3]int)
	stack := (*stackPtr)[:0]
	defer func() {
...
Ins21:
	{
		captureStack = append(captureStack, captures[:]...)
		stack = append(stack, [3]int{offset, 13, 1})
		goto Ins8
	}
Ins22:
	{
...
Ins30:
	{
		captures[1] = offset
		if r == nil {
			r = &ReSpellCastPerformUnknownResult{}
		}
...
func (recv ReSpellCastPerformUnknown) FindString(input string) (*ReSpellCastPerformUnknownResult, bool) {
	return recv.FindStringReuse(input, nil)
}
func (ReSpellCastPerformUnknown) FindAllStringAppend(input string, n int, s []*ReSpellCastPerformUnknownResult) []*ReSpellCastPerformUnknownResult {
	if n == 0 {
		return s
	}
	result := s
	...
	Ins30:
		{
			captures[1] = offset
			var item *ReSpellCastPerformUnknownResult
			if len(result) < cap(result) {
				result = result[:len(result)+1]
				item = result[len(result)-1]
				if item == nil {
					item = &ReSpellCastPerformUnknownResult{}
...
func (r ReSpellCastPerformUnknown) FindAllString(input string, n int) []*ReSpellCastPerformUnknownResult {
	return r.FindAllStringAppend(input, n, nil)
}
func (ReSpellCastPerformUnknown) FindBytesReuse(input []byte, r *ReSpellCastPerformUnknownBytesResult) (*ReSpellCastPerformUnknownBytesResult, bool) {
	l := len(input)
	offset := 0
	var captures [8]int
	captureStackPtr := reSpellCastPerformUnknownCaptureStackPool.Get().(*[]int)
...
Ins30:
	{
		captures[1] = offset
		if r == nil {
			r = &ReSpellCastPerformUnknownBytesResult{}
		}
...
func (recv ReSpellCastPerformUnknown) FindBytes(input []byte) (*ReSpellCastPerformUnknownBytesResult, bool) {
	return recv.FindBytesReuse(input, nil)
}
func (ReSpellCastPerformUnknown) FindAllBytesAppend(input []byte, n int, s []*ReSpellCastPerformUnknownBytesResult) []*ReSpellCastPerformUnknownBytesResult {
	if n == 0 {
		return s
	}
	result := s
	...
	Ins30:
		{
			captures[1] = offset
			var item *ReSpellCastPerformUnknownBytesResult
			if len(result) < cap(result) {
				result = result[:len(result)+1]
				item = result[len(result)-1]
				if item == nil {
					item = &ReSpellCastPerformUnknownBytesResult{}
					result[len(result)-1] = item
				}
			} else {
				item = &ReSpellCastPerformUnknownBytesResult{}
...
func (r ReSpellCastPerformUnknown) FindAllBytes(input []byte, n int) []*ReSpellCastPerformUnknownBytesResult {
...
func (ReSpellCastPerformUnknown) DefaultMaxLeftover() int {
	return 1048576
}
...
func (ReSpellCastPerformUnknown) FindReader(r io.Reader, cfg stream.Config, onMatch func(stream.Match[*ReSpellCastPerformUnknownBytesResult]) bool) error {
	...
	reuseResult := &ReSpellCastPerformUnknownBytesResult{}
			...
			if err == io.EOF {
				...
				if leftover > 0 {
					...
					for searchPos < len(chunk) {
						result, ok := ReSpellCastPerformUnknown{}.FindBytesReuse(chunk[searchPos:], reuseResult)
						if !ok {
							break
						}
						...
						m := stream.Match[*ReSpellCastPerformUnknownBytesResult]{
...
func (ReSpellCastPerformUnknown) FindReaderCount(r io.Reader, cfg stream.Config) (int64, error) {
	var count int64
	err := ReSpellCastPerformUnknown{}.FindReader(r, cfg, func(_ stream.Match[*ReSpellCastPerformUnknownBytesResult]) bool {
		count++
		return true
	})
	return count, err
...
func (ReSpellCastPerformUnknown) FindReaderFirst(r io.Reader, cfg stream.Config) (*ReSpellCastPerformUnknownBytesResult, int64, error) {
	var result *ReSpellCastPerformUnknownBytesResult
	var offset int64
	err := ReSpellCastPerformUnknown{}.FindReader(r, cfg, func(m stream.Match[*ReSpellCastPerformUnknownBytesResult]) bool {
		// Copy the result since buffer will be reused
		result = ReSpellCastPerformUnknown{}.copyBytesResult(m.Result)
...
func (ReSpellCastPerformUnknown) copyBytesResult(src *ReSpellCastPerformUnknownBytesResult) *ReSpellCastPerformUnknownBytesResult {
	if src == nil {
		return nil
	}
	dst := &ReSpellCastPerformUnknownBytesResult{}
	// Copy Match slice
...
//	    })
//	io.Copy(os.Stdout, r)
func (ReSpellCastPerformUnknown) NewTransformReader(r io.Reader, cfg stream.TransformConfig, onMatch func(match *ReSpellCastPerformUnknownBytesResult, emit func([]byte))) io.Reader {
	if cfg.BufferSize == 0 {
	...
	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReSpellCastPerformUnknown{}.processTransform(data, isEOF, onMatch, emitOut)
	}
...
func (ReSpellCastPerformUnknown) processTransform(data []byte, isEOF bool, onMatch func(match *ReSpellCastPerformUnknownBytesResult, emit func([]byte)), emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReSpellCastPerformUnknownBytesResult{}

	for {
		result, ok := ReSpellCastPerformUnknown{}.FindBytesReuse(data[processed:], reuseResult)
		if !ok {
			// No more matches
			if isEOF {
...
//	io.Copy(os.Stdout, r)
func (ReSpellCastPerformUnknown) ReplaceReader(r io.Reader, template string) io.Reader {
	parsed, err := replace.Parse(template)
	if err != nil {
		return &reSpellCastPerformUnknownTransformErrReader{err: err}
	}
	...
	return ReSpellCastPerformUnknown{}.NewTransformReader(r, stream.DefaultTransformConfig(), func(m *ReSpellCastPerformUnknownBytesResult, emit func([]byte)) {
		...
		for _, seg := range resolved {
			...
			case replace.SegmentCaptureIndex:
				capture := (ReSpellCastPerformUnknown{}).getCaptureByIndex(m, seg.CaptureIndex)
				if capture != nil {
...
// reSpellCastPerformUnknownTransformErrReader is a reader that always returns an error.
type reSpellCastPerformUnknownTransformErrReader struct {
	err error
}

func (r *reSpellCastPerformUnknownTransformErrReader) Read(p []byte) (int, error) {
	return 0, r.err
}

// getCaptureByIndex returns the capture group value by its index.
func (ReSpellCastPerformUnknown) getCaptureByIndex(m *ReSpellCastPerformUnknownBytesResult, index int) []byte {
	switch index {
	case 0:
		return m.Match
	default:
...
//	})
func (ReSpellCastPerformUnknown) SelectReader(r io.Reader, pred func(*ReSpellCastPerformUnknownBytesResult) bool) io.Reader {
	cfg := stream.DefaultTransformConfig()
	cfg.MaxLeftover = 1048576

	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReSpellCastPerformUnknown{}.processSelect(data, isEOF, pred, emitOut)
	}
...
func (ReSpellCastPerformUnknown) processSelect(data []byte, isEOF bool, pred func(*ReSpellCastPerformUnknownBytesResult) bool, emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReSpellCastPerformUnknownBytesResult{}
...
//	})
func (ReSpellCastPerformUnknown) RejectReader(r io.Reader, pred func(*ReSpellCastPerformUnknownBytesResult) bool) io.Reader {
	cfg := stream.DefaultTransformConfig()
	cfg.MaxLeftover = 1048576

	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReSpellCastPerformUnknown{}.processReject(data, isEOF, pred, emitOut)
	}
...
func (ReSpellCastPerformUnknown) processReject(data []byte, isEOF bool, pred func(*ReSpellCastPerformUnknownBytesResult) bool, emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReSpellCastPerformUnknownBytesResult{}
...
func (r *ReSpellCastPerformUnknownResult) CaptureByIndex(idx int) string {
	switch idx {
	case 0:
		return r.Match
	case 1:
...
// CaptureByIndex returns the capture group value by its 0-based index.
// Index 0 returns the full match, 1+ returns capture groups.
func (r *ReSpellCastPerformUnknownBytesResult) CaptureByIndex(idx int) []byte {
	switch idx {
	case 0:
		return r.Match
	case 1:
...
func (ReSpellCastPerformUnknown) ReplaceAllString(input string, template string) string {
	...
	lastEnd := 0
	var r ReSpellCastPerformUnknownResult

	remaining := input
	offset := 0

	for {
		match, ok := ReSpellCastPerformUnknown{}.FindStringReuse(remaining, &r)
		if !ok {
			break
		}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReSpellCastPerformUnknown) ReplaceAllBytes(input []byte, template string) []byte {
	return ReSpellCastPerformUnknown{}.ReplaceAllBytesAppend(input, template, nil)
}

// ReplaceAllBytesAppend replaces all matches and appends to buf.
// If buf has sufficient capacity, no allocation occurs.
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReSpellCastPerformUnknown) ReplaceAllBytesAppend(input []byte, template string, buf []byte) []byte {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	result := buf[:0]
	lastEnd := 0
	var r ReSpellCastPerformUnknownBytesResult

	remaining := input
	offset := 0

	for {
		match, ok := ReSpellCastPerformUnknown{}.FindBytesReuse(remaining, &r)
		if !ok {
			break
		}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReSpellCastPerformUnknown) ReplaceFirstString(input string, template string) string {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	var r ReSpellCastPerformUnknownResult
	match, ok := ReSpellCastPerformUnknown{}.FindStringReuse(input, &r)
	if !ok {
		return input
	}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReSpellCastPerformUnknown) ReplaceFirstBytes(input []byte, template string) []byte {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	var r ReSpellCastPerformUnknownBytesResult
	match, ok := ReSpellCastPerformUnknown{}.FindBytesReuse(input, &r)
	if !ok {
...
// ReSpellCastPerformUnknownReplaceTemplate holds a pre-compiled replace template for the ReSpellCastPerformUnknown pattern.
// Use CompileReplaceTemplate to create one, then call its Replace methods.
type ReSpellCastPerformUnknownReplaceTemplate struct {
	original string
...
//
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReSpellCastPerformUnknown) CompileReplaceTemplate(template string) (*ReSpellCastPerformUnknownReplaceTemplate, error) {
	tmpl, err := replace.Parse(template)
	if err != nil {
		return nil, err
	}
	...
	return &ReSpellCastPerformUnknownReplaceTemplate{
		original: template,
		segments: resolved,
	}, nil
}
...
func (t *ReSpellCastPerformUnknownReplaceTemplate) String() string {
	return t.original
}

// ReplaceAllString replaces all matches in input using this compiled template.
func (t *ReSpellCastPerformUnknownReplaceTemplate) ReplaceAllString(input string) string {
	var result strings.Builder
	lastEnd := 0
	var r ReSpellCastPerformUnknownResult
...
func (t *ReSpellCastPerformUnknownReplaceTemplate) ReplaceAllBytes(input []byte) []byte {
	return t.ReplaceAllBytesAppend(input, nil)
}

// ReplaceAllBytesAppend replaces all matches and appends to buf.
// If buf has sufficient capacity, no allocation occurs.
func (t *ReSpellCastPerformUnknownReplaceTemplate) ReplaceAllBytesAppend(input []byte, buf []byte) []byte {
	result := buf[:0]
	lastEnd := 0
	var r ReSpellCastPerformUnknownBytesResult
...
func (t *ReSpellCastPerformUnknownReplaceTemplate) ReplaceFirstString(input string) string {
	var r ReSpellCastPerformUnknownResult
	match, ok := ReSpellCastPerformUnknown{}.FindStringReuse(input, &r)
	if !ok {
		return input
...
func (t *ReSpellCastPerformUnknownReplaceTemplate) ReplaceFirstBytes(input []byte) []byte {
	var r ReSpellCastPerformUnknownBytesResult
	match, ok := ReSpellCastPerformUnknown{}.FindBytesReuse(input, &r)
	if !ok {
		return append([]byte{}, input...)
