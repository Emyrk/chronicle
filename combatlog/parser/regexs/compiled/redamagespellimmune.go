...
// Code generated by regengo for pattern: (.+[^\s])'s (.+[^\s]) fails\. (.+[^\s]) is immune\.
// DO NOT EDIT.

var reDamageSpellImmuneStackPool = sync.Pool{New: func() interface{} {
	stack := make([][3]int, 0, 32)
	return &stack
}}

var reDamageSpellImmuneCaptureStackPool = sync.Pool{New: func() interface{} {
	stack := make([]int, 0, 128)
	return &stack
}}

type ReDamageSpellImmune struct{}

var CompiledReDamageSpellImmune = ReDamageSpellImmune{}

// MinMatchLen is the minimum number of bytes any match can have.
const ReDamageSpellImmuneMinMatchLen = 28

// MaxMatchLen is the maximum number of bytes any match can have.
// -1 means unbounded (pattern contains * or + quantifiers).
const ReDamageSpellImmuneMaxMatchLen = -1

func (ReDamageSpellImmune) MatchLengthInfo() (minLen, maxLen int) {
	return ReDamageSpellImmuneMinMatchLen, ReDamageSpellImmuneMaxMatchLen
}

func (ReDamageSpellImmune) MatchString(input string) bool {
	l := len(input)
	offset := 0
	stackPtr := reDamageSpellImmuneStackPool.Get().(*[][3]int)
	stack := (*stackPtr)[:0]
	defer func() {
		for i := range stack {
			stack[i] = [3]int{0, 0, 0}
		...
		*stackPtr = stack[:0]
		reDamageSpellImmuneStackPool.Put(stackPtr)
	}()
	nextInstruction := 1
	goto StepSelect
TryFallback:
...
func (ReDamageSpellImmune) MatchBytes(input []byte) bool {
	l := len(input)
	offset := 0
	stackPtr := reDamageSpellImmuneStackPool.Get().(*[][3]int)
	stack := (*stackPtr)[:0]
...
type ReDamageSpellImmuneResult struct {
...
type ReDamageSpellImmuneBytesResult struct {
...
func (ReDamageSpellImmune) FindStringReuse(input string, r *ReDamageSpellImmuneResult) (*ReDamageSpellImmuneResult, bool) {
	l := len(input)
	offset := 0
	var captures [8]int
	captureStackPtr := reDamageSpellImmuneCaptureStackPool.Get().(*[]int)
	captureStack := (*captureStackPtr)[:0]
	defer func() {
		*captureStackPtr = captureStack[:0]
		reDamageSpellImmuneCaptureStackPool.Put(captureStackPtr)
	}()
	stackPtr := reDamageSpellImmuneStackPool.Get().(*[][3]int)
	stack := (*stackPtr)[:0]
	defer func() {
...
Ins24:
	{
		captureStack = append(captureStack, captures[:]...)
		stack = append(stack, [3]int{offset, 25, 1})
		goto Ins23
	}
Ins25:
	{
...
func (recv ReDamageSpellImmune) FindString(input string) (*ReDamageSpellImmuneResult, bool) {
	return recv.FindStringReuse(input, nil)
}
func (ReDamageSpellImmune) FindAllStringAppend(input string, n int, s []*ReDamageSpellImmuneResult) []*ReDamageSpellImmuneResult {
	if n == 0 {
		return s
	}
	result := s
	...
	Ins38:
		{
			captures[1] = offset
			var item *ReDamageSpellImmuneResult
			if len(result) < cap(result) {
				result = result[:len(result)+1]
				item = result[len(result)-1]
				if item == nil {
					item = &ReDamageSpellImmuneResult{}
...
func (r ReDamageSpellImmune) FindAllString(input string, n int) []*ReDamageSpellImmuneResult {
	return r.FindAllStringAppend(input, n, nil)
}
func (ReDamageSpellImmune) FindBytesReuse(input []byte, r *ReDamageSpellImmuneBytesResult) (*ReDamageSpellImmuneBytesResult, bool) {
	l := len(input)
	offset := 0
	var captures [8]int
	captureStackPtr := reDamageSpellImmuneCaptureStackPool.Get().(*[]int)
...
Ins38:
	{
		captures[1] = offset
		if r == nil {
			r = &ReDamageSpellImmuneBytesResult{}
		}
...
func (recv ReDamageSpellImmune) FindBytes(input []byte) (*ReDamageSpellImmuneBytesResult, bool) {
	return recv.FindBytesReuse(input, nil)
}
func (ReDamageSpellImmune) FindAllBytesAppend(input []byte, n int, s []*ReDamageSpellImmuneBytesResult) []*ReDamageSpellImmuneBytesResult {
	if n == 0 {
		return s
	}
	result := s
	...
	Ins38:
		{
			captures[1] = offset
			var item *ReDamageSpellImmuneBytesResult
			if len(result) < cap(result) {
				result = result[:len(result)+1]
				item = result[len(result)-1]
				if item == nil {
					item = &ReDamageSpellImmuneBytesResult{}
					result[len(result)-1] = item
				}
			} else {
				item = &ReDamageSpellImmuneBytesResult{}
...
func (r ReDamageSpellImmune) FindAllBytes(input []byte, n int) []*ReDamageSpellImmuneBytesResult {
...
func (ReDamageSpellImmune) DefaultMaxLeftover() int {
	return 1048576
}
...
func (ReDamageSpellImmune) FindReader(r io.Reader, cfg stream.Config, onMatch func(stream.Match[*ReDamageSpellImmuneBytesResult]) bool) error {
	...
	reuseResult := &ReDamageSpellImmuneBytesResult{}
			...
			if err == io.EOF {
				...
				if leftover > 0 {
					...
					for searchPos < len(chunk) {
						result, ok := ReDamageSpellImmune{}.FindBytesReuse(chunk[searchPos:], reuseResult)
						if !ok {
							break
						}
						...
						m := stream.Match[*ReDamageSpellImmuneBytesResult]{
...
func (ReDamageSpellImmune) FindReaderCount(r io.Reader, cfg stream.Config) (int64, error) {
	var count int64
	err := ReDamageSpellImmune{}.FindReader(r, cfg, func(_ stream.Match[*ReDamageSpellImmuneBytesResult]) bool {
		count++
		return true
	})
	return count, err
...
func (ReDamageSpellImmune) FindReaderFirst(r io.Reader, cfg stream.Config) (*ReDamageSpellImmuneBytesResult, int64, error) {
	var result *ReDamageSpellImmuneBytesResult
	var offset int64
	err := ReDamageSpellImmune{}.FindReader(r, cfg, func(m stream.Match[*ReDamageSpellImmuneBytesResult]) bool {
		// Copy the result since buffer will be reused
		result = ReDamageSpellImmune{}.copyBytesResult(m.Result)
...
func (ReDamageSpellImmune) copyBytesResult(src *ReDamageSpellImmuneBytesResult) *ReDamageSpellImmuneBytesResult {
	if src == nil {
		return nil
	}
	dst := &ReDamageSpellImmuneBytesResult{}
	// Copy Match slice
...
//	    })
//	io.Copy(os.Stdout, r)
func (ReDamageSpellImmune) NewTransformReader(r io.Reader, cfg stream.TransformConfig, onMatch func(match *ReDamageSpellImmuneBytesResult, emit func([]byte))) io.Reader {
	if cfg.BufferSize == 0 {
	...
	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReDamageSpellImmune{}.processTransform(data, isEOF, onMatch, emitOut)
	}
...
func (ReDamageSpellImmune) processTransform(data []byte, isEOF bool, onMatch func(match *ReDamageSpellImmuneBytesResult, emit func([]byte)), emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReDamageSpellImmuneBytesResult{}

	for {
		result, ok := ReDamageSpellImmune{}.FindBytesReuse(data[processed:], reuseResult)
		if !ok {
			// No more matches
			if isEOF {
...
//	io.Copy(os.Stdout, r)
func (ReDamageSpellImmune) ReplaceReader(r io.Reader, template string) io.Reader {
	parsed, err := replace.Parse(template)
	if err != nil {
		return &reDamageSpellImmuneTransformErrReader{err: err}
	}
	...
	return ReDamageSpellImmune{}.NewTransformReader(r, stream.DefaultTransformConfig(), func(m *ReDamageSpellImmuneBytesResult, emit func([]byte)) {
		...
		for _, seg := range resolved {
			...
			case replace.SegmentCaptureIndex:
				capture := (ReDamageSpellImmune{}).getCaptureByIndex(m, seg.CaptureIndex)
				if capture != nil {
...
// reDamageSpellImmuneTransformErrReader is a reader that always returns an error.
type reDamageSpellImmuneTransformErrReader struct {
	err error
}

func (r *reDamageSpellImmuneTransformErrReader) Read(p []byte) (int, error) {
	return 0, r.err
}

// getCaptureByIndex returns the capture group value by its index.
func (ReDamageSpellImmune) getCaptureByIndex(m *ReDamageSpellImmuneBytesResult, index int) []byte {
	switch index {
	case 0:
		return m.Match
	default:
...
//	})
func (ReDamageSpellImmune) SelectReader(r io.Reader, pred func(*ReDamageSpellImmuneBytesResult) bool) io.Reader {
	cfg := stream.DefaultTransformConfig()
	cfg.MaxLeftover = 1048576

	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReDamageSpellImmune{}.processSelect(data, isEOF, pred, emitOut)
	}
...
func (ReDamageSpellImmune) processSelect(data []byte, isEOF bool, pred func(*ReDamageSpellImmuneBytesResult) bool, emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReDamageSpellImmuneBytesResult{}
...
//	})
func (ReDamageSpellImmune) RejectReader(r io.Reader, pred func(*ReDamageSpellImmuneBytesResult) bool) io.Reader {
	cfg := stream.DefaultTransformConfig()
	cfg.MaxLeftover = 1048576

	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReDamageSpellImmune{}.processReject(data, isEOF, pred, emitOut)
	}
...
func (ReDamageSpellImmune) processReject(data []byte, isEOF bool, pred func(*ReDamageSpellImmuneBytesResult) bool, emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReDamageSpellImmuneBytesResult{}
...
func (r *ReDamageSpellImmuneResult) CaptureByIndex(idx int) string {
	switch idx {
	case 0:
		return r.Match
	case 1:
...
// CaptureByIndex returns the capture group value by its 0-based index.
// Index 0 returns the full match, 1+ returns capture groups.
func (r *ReDamageSpellImmuneBytesResult) CaptureByIndex(idx int) []byte {
	switch idx {
	case 0:
		return r.Match
	case 1:
...
func (ReDamageSpellImmune) ReplaceAllString(input string, template string) string {
	...
	lastEnd := 0
	var r ReDamageSpellImmuneResult

	remaining := input
	offset := 0

	for {
		match, ok := ReDamageSpellImmune{}.FindStringReuse(remaining, &r)
		if !ok {
			break
		}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageSpellImmune) ReplaceAllBytes(input []byte, template string) []byte {
	return ReDamageSpellImmune{}.ReplaceAllBytesAppend(input, template, nil)
}

// ReplaceAllBytesAppend replaces all matches and appends to buf.
// If buf has sufficient capacity, no allocation occurs.
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageSpellImmune) ReplaceAllBytesAppend(input []byte, template string, buf []byte) []byte {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	result := buf[:0]
	lastEnd := 0
	var r ReDamageSpellImmuneBytesResult

	remaining := input
	offset := 0

	for {
		match, ok := ReDamageSpellImmune{}.FindBytesReuse(remaining, &r)
		if !ok {
			break
		}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageSpellImmune) ReplaceFirstString(input string, template string) string {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	var r ReDamageSpellImmuneResult
	match, ok := ReDamageSpellImmune{}.FindStringReuse(input, &r)
	if !ok {
		return input
	}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageSpellImmune) ReplaceFirstBytes(input []byte, template string) []byte {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	var r ReDamageSpellImmuneBytesResult
	match, ok := ReDamageSpellImmune{}.FindBytesReuse(input, &r)
	if !ok {
...
// ReDamageSpellImmuneReplaceTemplate holds a pre-compiled replace template for the ReDamageSpellImmune pattern.
// Use CompileReplaceTemplate to create one, then call its Replace methods.
type ReDamageSpellImmuneReplaceTemplate struct {
	original string
...
//
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageSpellImmune) CompileReplaceTemplate(template string) (*ReDamageSpellImmuneReplaceTemplate, error) {
	tmpl, err := replace.Parse(template)
	if err != nil {
		return nil, err
	}
	...
	return &ReDamageSpellImmuneReplaceTemplate{
		original: template,
		segments: resolved,
	}, nil
}
...
func (t *ReDamageSpellImmuneReplaceTemplate) String() string {
	return t.original
}

// ReplaceAllString replaces all matches in input using this compiled template.
func (t *ReDamageSpellImmuneReplaceTemplate) ReplaceAllString(input string) string {
	var result strings.Builder
	lastEnd := 0
	var r ReDamageSpellImmuneResult
...
func (t *ReDamageSpellImmuneReplaceTemplate) ReplaceAllBytes(input []byte) []byte {
	return t.ReplaceAllBytesAppend(input, nil)
}

// ReplaceAllBytesAppend replaces all matches and appends to buf.
// If buf has sufficient capacity, no allocation occurs.
func (t *ReDamageSpellImmuneReplaceTemplate) ReplaceAllBytesAppend(input []byte, buf []byte) []byte {
	result := buf[:0]
	lastEnd := 0
	var r ReDamageSpellImmuneBytesResult
...
func (t *ReDamageSpellImmuneReplaceTemplate) ReplaceFirstString(input string) string {
	var r ReDamageSpellImmuneResult
	match, ok := ReDamageSpellImmune{}.FindStringReuse(input, &r)
	if !ok {
		return input
...
func (t *ReDamageSpellImmuneReplaceTemplate) ReplaceFirstBytes(input []byte) []byte {
	var r ReDamageSpellImmuneBytesResult
	match, ok := ReDamageSpellImmune{}.FindBytesReuse(input, &r)
	if !ok {
		return append([]byte{}, input...)
