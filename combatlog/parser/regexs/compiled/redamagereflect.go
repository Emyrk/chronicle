...
// Code generated by regengo for pattern: (.+[^\s])'s (.+[^\s]) is reflected back by (.+[^\s])\.
// DO NOT EDIT.

var reDamageReflectStackPool = sync.Pool{New: func() interface{} {
	stack := make([][3]int, 0, 32)
	return &stack
}}

var reDamageReflectCaptureStackPool = sync.Pool{New: func() interface{} {
	stack := make([]int, 0, 128)
	return &stack
}}

type ReDamageReflect struct{}

var CompiledReDamageReflect = ReDamageReflect{}

// MinMatchLen is the minimum number of bytes any match can have.
const ReDamageReflectMinMatchLen = 32

// MaxMatchLen is the maximum number of bytes any match can have.
// -1 means unbounded (pattern contains * or + quantifiers).
const ReDamageReflectMaxMatchLen = -1

func (ReDamageReflect) MatchLengthInfo() (minLen, maxLen int) {
	return ReDamageReflectMinMatchLen, ReDamageReflectMaxMatchLen
}

func (ReDamageReflect) MatchString(input string) bool {
	l := len(input)
	offset := 0
	stackPtr := reDamageReflectStackPool.Get().(*[][3]int)
	stack := (*stackPtr)[:0]
	defer func() {
		for i := range stack {
			stack[i] = [3]int{0, 0, 0}
		...
		*stackPtr = stack[:0]
		reDamageReflectStackPool.Put(stackPtr)
	}()
	nextInstruction := 1
	goto StepSelect
TryFallback:
...
func (ReDamageReflect) MatchBytes(input []byte) bool {
	l := len(input)
	offset := 0
	stackPtr := reDamageReflectStackPool.Get().(*[][3]int)
	stack := (*stackPtr)[:0]
...
type ReDamageReflectResult struct {
...
type ReDamageReflectBytesResult struct {
...
func (ReDamageReflect) FindStringReuse(input string, r *ReDamageReflectResult) (*ReDamageReflectResult, bool) {
	l := len(input)
	offset := 0
	var captures [8]int
	captureStackPtr := reDamageReflectCaptureStackPool.Get().(*[]int)
	captureStack := (*captureStackPtr)[:0]
	defer func() {
		*captureStackPtr = captureStack[:0]
		reDamageReflectCaptureStackPool.Put(captureStackPtr)
	}()
	stackPtr := reDamageReflectStackPool.Get().(*[][3]int)
	stack := (*stackPtr)[:0]
	defer func() {
...
Ins38:
	{
		captureStack = append(captureStack, captures[:]...)
		stack = append(stack, [3]int{offset, 39, 1})
		goto Ins37
	}
Ins39:
	{
...
func (recv ReDamageReflect) FindString(input string) (*ReDamageReflectResult, bool) {
	return recv.FindStringReuse(input, nil)
}
func (ReDamageReflect) FindAllStringAppend(input string, n int, s []*ReDamageReflectResult) []*ReDamageReflectResult {
	if n == 0 {
		return s
	}
	result := s
	...
	Ins42:
		{
			captures[1] = offset
			var item *ReDamageReflectResult
			if len(result) < cap(result) {
				result = result[:len(result)+1]
				item = result[len(result)-1]
				if item == nil {
					item = &ReDamageReflectResult{}
...
func (r ReDamageReflect) FindAllString(input string, n int) []*ReDamageReflectResult {
	return r.FindAllStringAppend(input, n, nil)
}
func (ReDamageReflect) FindBytesReuse(input []byte, r *ReDamageReflectBytesResult) (*ReDamageReflectBytesResult, bool) {
	l := len(input)
	offset := 0
	var captures [8]int
	captureStackPtr := reDamageReflectCaptureStackPool.Get().(*[]int)
...
func (recv ReDamageReflect) FindBytes(input []byte) (*ReDamageReflectBytesResult, bool) {
	return recv.FindBytesReuse(input, nil)
}
func (ReDamageReflect) FindAllBytesAppend(input []byte, n int, s []*ReDamageReflectBytesResult) []*ReDamageReflectBytesResult {
	if n == 0 {
		return s
	}
	result := s
	...
	Ins42:
		{
			captures[1] = offset
			var item *ReDamageReflectBytesResult
			if len(result) < cap(result) {
				result = result[:len(result)+1]
				item = result[len(result)-1]
				if item == nil {
					item = &ReDamageReflectBytesResult{}
					result[len(result)-1] = item
				}
			} else {
				item = &ReDamageReflectBytesResult{}
...
func (r ReDamageReflect) FindAllBytes(input []byte, n int) []*ReDamageReflectBytesResult {
...
func (ReDamageReflect) DefaultMaxLeftover() int {
	return 1048576
}
...
func (ReDamageReflect) FindReader(r io.Reader, cfg stream.Config, onMatch func(stream.Match[*ReDamageReflectBytesResult]) bool) error {
	...
	reuseResult := &ReDamageReflectBytesResult{}
			...
			if err == io.EOF {
				...
				if leftover > 0 {
					...
					for searchPos < len(chunk) {
						result, ok := ReDamageReflect{}.FindBytesReuse(chunk[searchPos:], reuseResult)
						if !ok {
							break
						}
						...
						m := stream.Match[*ReDamageReflectBytesResult]{
...
func (ReDamageReflect) FindReaderCount(r io.Reader, cfg stream.Config) (int64, error) {
	var count int64
	err := ReDamageReflect{}.FindReader(r, cfg, func(_ stream.Match[*ReDamageReflectBytesResult]) bool {
		count++
		return true
	})
	return count, err
...
func (ReDamageReflect) FindReaderFirst(r io.Reader, cfg stream.Config) (*ReDamageReflectBytesResult, int64, error) {
	var result *ReDamageReflectBytesResult
	var offset int64
	err := ReDamageReflect{}.FindReader(r, cfg, func(m stream.Match[*ReDamageReflectBytesResult]) bool {
		// Copy the result since buffer will be reused
		result = ReDamageReflect{}.copyBytesResult(m.Result)
...
func (ReDamageReflect) copyBytesResult(src *ReDamageReflectBytesResult) *ReDamageReflectBytesResult {
	if src == nil {
		return nil
	}
	dst := &ReDamageReflectBytesResult{}
	// Copy Match slice
...
//	    })
//	io.Copy(os.Stdout, r)
func (ReDamageReflect) NewTransformReader(r io.Reader, cfg stream.TransformConfig, onMatch func(match *ReDamageReflectBytesResult, emit func([]byte))) io.Reader {
	if cfg.BufferSize == 0 {
	...
	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReDamageReflect{}.processTransform(data, isEOF, onMatch, emitOut)
	}
...
func (ReDamageReflect) processTransform(data []byte, isEOF bool, onMatch func(match *ReDamageReflectBytesResult, emit func([]byte)), emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReDamageReflectBytesResult{}

	for {
		result, ok := ReDamageReflect{}.FindBytesReuse(data[processed:], reuseResult)
		if !ok {
			// No more matches
			if isEOF {
...
//	io.Copy(os.Stdout, r)
func (ReDamageReflect) ReplaceReader(r io.Reader, template string) io.Reader {
	parsed, err := replace.Parse(template)
	if err != nil {
		return &reDamageReflectTransformErrReader{err: err}
	}
	...
	return ReDamageReflect{}.NewTransformReader(r, stream.DefaultTransformConfig(), func(m *ReDamageReflectBytesResult, emit func([]byte)) {
		...
		for _, seg := range resolved {
			...
			case replace.SegmentCaptureIndex:
				capture := (ReDamageReflect{}).getCaptureByIndex(m, seg.CaptureIndex)
				if capture != nil {
...
// reDamageReflectTransformErrReader is a reader that always returns an error.
type reDamageReflectTransformErrReader struct {
	err error
}

func (r *reDamageReflectTransformErrReader) Read(p []byte) (int, error) {
	return 0, r.err
}

// getCaptureByIndex returns the capture group value by its index.
func (ReDamageReflect) getCaptureByIndex(m *ReDamageReflectBytesResult, index int) []byte {
	switch index {
	case 0:
		return m.Match
	default:
...
//	})
func (ReDamageReflect) SelectReader(r io.Reader, pred func(*ReDamageReflectBytesResult) bool) io.Reader {
	cfg := stream.DefaultTransformConfig()
	cfg.MaxLeftover = 1048576

	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReDamageReflect{}.processSelect(data, isEOF, pred, emitOut)
	}
...
func (ReDamageReflect) processSelect(data []byte, isEOF bool, pred func(*ReDamageReflectBytesResult) bool, emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReDamageReflectBytesResult{}
...
//	})
func (ReDamageReflect) RejectReader(r io.Reader, pred func(*ReDamageReflectBytesResult) bool) io.Reader {
	cfg := stream.DefaultTransformConfig()
	cfg.MaxLeftover = 1048576

	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReDamageReflect{}.processReject(data, isEOF, pred, emitOut)
	}
...
func (ReDamageReflect) processReject(data []byte, isEOF bool, pred func(*ReDamageReflectBytesResult) bool, emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReDamageReflectBytesResult{}
...
func (r *ReDamageReflectResult) CaptureByIndex(idx int) string {
	switch idx {
	case 0:
		return r.Match
	case 1:
...
// CaptureByIndex returns the capture group value by its 0-based index.
// Index 0 returns the full match, 1+ returns capture groups.
func (r *ReDamageReflectBytesResult) CaptureByIndex(idx int) []byte {
	switch idx {
	case 0:
		return r.Match
	case 1:
...
func (ReDamageReflect) ReplaceAllString(input string, template string) string {
	...
	lastEnd := 0
	var r ReDamageReflectResult

	remaining := input
	offset := 0

	for {
		match, ok := ReDamageReflect{}.FindStringReuse(remaining, &r)
		if !ok {
			break
		}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageReflect) ReplaceAllBytes(input []byte, template string) []byte {
	return ReDamageReflect{}.ReplaceAllBytesAppend(input, template, nil)
}

// ReplaceAllBytesAppend replaces all matches and appends to buf.
// If buf has sufficient capacity, no allocation occurs.
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageReflect) ReplaceAllBytesAppend(input []byte, template string, buf []byte) []byte {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	result := buf[:0]
	lastEnd := 0
	var r ReDamageReflectBytesResult

	remaining := input
	offset := 0

	for {
		match, ok := ReDamageReflect{}.FindBytesReuse(remaining, &r)
		if !ok {
			break
		}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageReflect) ReplaceFirstString(input string, template string) string {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	var r ReDamageReflectResult
	match, ok := ReDamageReflect{}.FindStringReuse(input, &r)
	if !ok {
		return input
	}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageReflect) ReplaceFirstBytes(input []byte, template string) []byte {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	var r ReDamageReflectBytesResult
	match, ok := ReDamageReflect{}.FindBytesReuse(input, &r)
	if !ok {
...
// ReDamageReflectReplaceTemplate holds a pre-compiled replace template for the ReDamageReflect pattern.
// Use CompileReplaceTemplate to create one, then call its Replace methods.
type ReDamageReflectReplaceTemplate struct {
	original string
...
//
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageReflect) CompileReplaceTemplate(template string) (*ReDamageReflectReplaceTemplate, error) {
	tmpl, err := replace.Parse(template)
	if err != nil {
		return nil, err
	}
	...
	return &ReDamageReflectReplaceTemplate{
		original: template,
		segments: resolved,
	}, nil
}
...
func (t *ReDamageReflectReplaceTemplate) String() string {
	return t.original
}

// ReplaceAllString replaces all matches in input using this compiled template.
func (t *ReDamageReflectReplaceTemplate) ReplaceAllString(input string) string {
	var result strings.Builder
	lastEnd := 0
	var r ReDamageReflectResult
...
func (t *ReDamageReflectReplaceTemplate) ReplaceAllBytes(input []byte) []byte {
	return t.ReplaceAllBytesAppend(input, nil)
}

// ReplaceAllBytesAppend replaces all matches and appends to buf.
// If buf has sufficient capacity, no allocation occurs.
func (t *ReDamageReflectReplaceTemplate) ReplaceAllBytesAppend(input []byte, buf []byte) []byte {
	result := buf[:0]
	lastEnd := 0
	var r ReDamageReflectBytesResult
...
func (t *ReDamageReflectReplaceTemplate) ReplaceFirstString(input string) string {
	var r ReDamageReflectResult
	match, ok := ReDamageReflect{}.FindStringReuse(input, &r)
	if !ok {
		return input
...
func (t *ReDamageReflectReplaceTemplate) ReplaceFirstBytes(input []byte) []byte {
	var r ReDamageReflectBytesResult
	match, ok := ReDamageReflect{}.FindBytesReuse(input, &r)
	if !ok {
		return append([]byte{}, input...)
