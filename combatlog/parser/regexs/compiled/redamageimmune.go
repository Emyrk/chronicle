...
// Code generated by regengo for pattern: (.+[^\s]) attacks but (.+[^\s]) is immune\.
// DO NOT EDIT.

var reDamageImmuneStackPool = sync.Pool{New: func() interface{} {
	stack := make([][3]int, 0, 32)
	return &stack
}}

var reDamageImmuneCaptureStackPool = sync.Pool{New: func() interface{} {
	stack := make([]int, 0, 96)
	return &stack
}}

type ReDamageImmune struct{}

var CompiledReDamageImmune = ReDamageImmune{}

// MinMatchLen is the minimum number of bytes any match can have.
const ReDamageImmuneMinMatchLen = 28

// MaxMatchLen is the maximum number of bytes any match can have.
// -1 means unbounded (pattern contains * or + quantifiers).
const ReDamageImmuneMaxMatchLen = -1

func (ReDamageImmune) MatchLengthInfo() (minLen, maxLen int) {
	return ReDamageImmuneMinMatchLen, ReDamageImmuneMaxMatchLen
}

func (ReDamageImmune) MatchString(input string) bool {
	l := len(input)
	offset := 0
	stackPtr := reDamageImmuneStackPool.Get().(*[][3]int)
	stack := (*stackPtr)[:0]
	defer func() {
		for i := range stack {
			stack[i] = [3]int{0, 0, 0}
		...
		*stackPtr = stack[:0]
		reDamageImmuneStackPool.Put(stackPtr)
	}()
	nextInstruction := 1
	goto StepSelect
TryFallback:
...
func (ReDamageImmune) MatchBytes(input []byte) bool {
	l := len(input)
	offset := 0
	stackPtr := reDamageImmuneStackPool.Get().(*[][3]int)
	stack := (*stackPtr)[:0]
...
type ReDamageImmuneResult struct {
	Match  string // Full match
	Group1 string
	Group2 string
}

type ReDamageImmuneBytesResult struct {
	Match  []byte // Full match
	Group1 []byte
	Group2 []byte
}

func (ReDamageImmune) FindStringReuse(input string, r *ReDamageImmuneResult) (*ReDamageImmuneResult, bool) {
	l := len(input)
	offset := 0
	var captures [6]int
	captureStackPtr := reDamageImmuneCaptureStackPool.Get().(*[]int)
	captureStack := (*captureStackPtr)[:0]
	defer func() {
		*captureStackPtr = captureStack[:0]
		reDamageImmuneCaptureStackPool.Put(captureStackPtr)
	}()
	stackPtr := reDamageImmuneStackPool.Get().(*[][3]int)
	stack := (*stackPtr)[:0]
	defer func() {
...
Ins21:
	{
		captureStack = append(captureStack, captures[:]...)
		stack = append(stack, [3]int{offset, 22, 1})
		goto Ins20
	}
Ins22:
	{
...
func (recv ReDamageImmune) FindString(input string) (*ReDamageImmuneResult, bool) {
	return recv.FindStringReuse(input, nil)
}
func (ReDamageImmune) FindAllStringAppend(input string, n int, s []*ReDamageImmuneResult) []*ReDamageImmuneResult {
	if n == 0 {
		return s
	}
	result := s
	...
	Ins35:
		{
			captures[1] = offset
			var item *ReDamageImmuneResult
			if len(result) < cap(result) {
				result = result[:len(result)+1]
				item = result[len(result)-1]
				if item == nil {
					item = &ReDamageImmuneResult{}
...
func (r ReDamageImmune) FindAllString(input string, n int) []*ReDamageImmuneResult {
	return r.FindAllStringAppend(input, n, nil)
}
func (ReDamageImmune) FindBytesReuse(input []byte, r *ReDamageImmuneBytesResult) (*ReDamageImmuneBytesResult, bool) {
	l := len(input)
	offset := 0
	var captures [6]int
	captureStackPtr := reDamageImmuneCaptureStackPool.Get().(*[]int)
...
func (recv ReDamageImmune) FindBytes(input []byte) (*ReDamageImmuneBytesResult, bool) {
	return recv.FindBytesReuse(input, nil)
}
func (ReDamageImmune) FindAllBytesAppend(input []byte, n int, s []*ReDamageImmuneBytesResult) []*ReDamageImmuneBytesResult {
	if n == 0 {
		return s
	}
	result := s
	...
	Ins35:
		{
			captures[1] = offset
			var item *ReDamageImmuneBytesResult
			if len(result) < cap(result) {
				result = result[:len(result)+1]
				item = result[len(result)-1]
				if item == nil {
					item = &ReDamageImmuneBytesResult{}
					result[len(result)-1] = item
				}
			} else {
				item = &ReDamageImmuneBytesResult{}
...
func (r ReDamageImmune) FindAllBytes(input []byte, n int) []*ReDamageImmuneBytesResult {
...
func (ReDamageImmune) DefaultMaxLeftover() int {
	return 1048576
}
...
func (ReDamageImmune) FindReader(r io.Reader, cfg stream.Config, onMatch func(stream.Match[*ReDamageImmuneBytesResult]) bool) error {
	...
	reuseResult := &ReDamageImmuneBytesResult{}
			...
			if err == io.EOF {
				...
				if leftover > 0 {
					...
					for searchPos < len(chunk) {
						result, ok := ReDamageImmune{}.FindBytesReuse(chunk[searchPos:], reuseResult)
						if !ok {
							break
						}
						...
						m := stream.Match[*ReDamageImmuneBytesResult]{
...
func (ReDamageImmune) FindReaderCount(r io.Reader, cfg stream.Config) (int64, error) {
	var count int64
	err := ReDamageImmune{}.FindReader(r, cfg, func(_ stream.Match[*ReDamageImmuneBytesResult]) bool {
		count++
		return true
	})
	return count, err
...
func (ReDamageImmune) FindReaderFirst(r io.Reader, cfg stream.Config) (*ReDamageImmuneBytesResult, int64, error) {
	var result *ReDamageImmuneBytesResult
	var offset int64
	err := ReDamageImmune{}.FindReader(r, cfg, func(m stream.Match[*ReDamageImmuneBytesResult]) bool {
		// Copy the result since buffer will be reused
		result = ReDamageImmune{}.copyBytesResult(m.Result)
...
func (ReDamageImmune) copyBytesResult(src *ReDamageImmuneBytesResult) *ReDamageImmuneBytesResult {
	if src == nil {
		return nil
	}
	dst := &ReDamageImmuneBytesResult{}
	// Copy Match slice
...
//	    })
//	io.Copy(os.Stdout, r)
func (ReDamageImmune) NewTransformReader(r io.Reader, cfg stream.TransformConfig, onMatch func(match *ReDamageImmuneBytesResult, emit func([]byte))) io.Reader {
	if cfg.BufferSize == 0 {
	...
	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReDamageImmune{}.processTransform(data, isEOF, onMatch, emitOut)
	}
...
func (ReDamageImmune) processTransform(data []byte, isEOF bool, onMatch func(match *ReDamageImmuneBytesResult, emit func([]byte)), emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReDamageImmuneBytesResult{}

	for {
		result, ok := ReDamageImmune{}.FindBytesReuse(data[processed:], reuseResult)
		if !ok {
			// No more matches
			if isEOF {
...
//	io.Copy(os.Stdout, r)
func (ReDamageImmune) ReplaceReader(r io.Reader, template string) io.Reader {
	parsed, err := replace.Parse(template)
	if err != nil {
		return &reDamageImmuneTransformErrReader{err: err}
	}
	...
	return ReDamageImmune{}.NewTransformReader(r, stream.DefaultTransformConfig(), func(m *ReDamageImmuneBytesResult, emit func([]byte)) {
		...
		for _, seg := range resolved {
			...
			case replace.SegmentCaptureIndex:
				capture := (ReDamageImmune{}).getCaptureByIndex(m, seg.CaptureIndex)
				if capture != nil {
...
// reDamageImmuneTransformErrReader is a reader that always returns an error.
type reDamageImmuneTransformErrReader struct {
	err error
}

func (r *reDamageImmuneTransformErrReader) Read(p []byte) (int, error) {
	return 0, r.err
}

// getCaptureByIndex returns the capture group value by its index.
func (ReDamageImmune) getCaptureByIndex(m *ReDamageImmuneBytesResult, index int) []byte {
	switch index {
	case 0:
		return m.Match
	default:
...
//	})
func (ReDamageImmune) SelectReader(r io.Reader, pred func(*ReDamageImmuneBytesResult) bool) io.Reader {
	cfg := stream.DefaultTransformConfig()
	cfg.MaxLeftover = 1048576

	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReDamageImmune{}.processSelect(data, isEOF, pred, emitOut)
	}
...
func (ReDamageImmune) processSelect(data []byte, isEOF bool, pred func(*ReDamageImmuneBytesResult) bool, emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReDamageImmuneBytesResult{}
...
//	})
func (ReDamageImmune) RejectReader(r io.Reader, pred func(*ReDamageImmuneBytesResult) bool) io.Reader {
	cfg := stream.DefaultTransformConfig()
	cfg.MaxLeftover = 1048576

	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReDamageImmune{}.processReject(data, isEOF, pred, emitOut)
	}
...
func (ReDamageImmune) processReject(data []byte, isEOF bool, pred func(*ReDamageImmuneBytesResult) bool, emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReDamageImmuneBytesResult{}
...
func (r *ReDamageImmuneResult) CaptureByIndex(idx int) string {
	switch idx {
	case 0:
		return r.Match
	case 1:
...
// CaptureByIndex returns the capture group value by its 0-based index.
// Index 0 returns the full match, 1+ returns capture groups.
func (r *ReDamageImmuneBytesResult) CaptureByIndex(idx int) []byte {
	switch idx {
	case 0:
		return r.Match
	case 1:
...
func (ReDamageImmune) ReplaceAllString(input string, template string) string {
	...
	lastEnd := 0
	var r ReDamageImmuneResult

	remaining := input
	offset := 0

	for {
		match, ok := ReDamageImmune{}.FindStringReuse(remaining, &r)
		if !ok {
			break
		}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageImmune) ReplaceAllBytes(input []byte, template string) []byte {
	return ReDamageImmune{}.ReplaceAllBytesAppend(input, template, nil)
}

// ReplaceAllBytesAppend replaces all matches and appends to buf.
// If buf has sufficient capacity, no allocation occurs.
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageImmune) ReplaceAllBytesAppend(input []byte, template string, buf []byte) []byte {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	result := buf[:0]
	lastEnd := 0
	var r ReDamageImmuneBytesResult

	remaining := input
	offset := 0

	for {
		match, ok := ReDamageImmune{}.FindBytesReuse(remaining, &r)
		if !ok {
			break
		}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageImmune) ReplaceFirstString(input string, template string) string {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	var r ReDamageImmuneResult
	match, ok := ReDamageImmune{}.FindStringReuse(input, &r)
	if !ok {
		return input
	}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageImmune) ReplaceFirstBytes(input []byte, template string) []byte {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	var r ReDamageImmuneBytesResult
	match, ok := ReDamageImmune{}.FindBytesReuse(input, &r)
	if !ok {
...
// ReDamageImmuneReplaceTemplate holds a pre-compiled replace template for the ReDamageImmune pattern.
// Use CompileReplaceTemplate to create one, then call its Replace methods.
type ReDamageImmuneReplaceTemplate struct {
	original string
...
//
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageImmune) CompileReplaceTemplate(template string) (*ReDamageImmuneReplaceTemplate, error) {
	tmpl, err := replace.Parse(template)
	if err != nil {
		return nil, err
	}
	...
	return &ReDamageImmuneReplaceTemplate{
		original: template,
		segments: resolved,
	}, nil
}
...
func (t *ReDamageImmuneReplaceTemplate) String() string {
	return t.original
}

// ReplaceAllString replaces all matches in input using this compiled template.
func (t *ReDamageImmuneReplaceTemplate) ReplaceAllString(input string) string {
	var result strings.Builder
	lastEnd := 0
	var r ReDamageImmuneResult
...
func (t *ReDamageImmuneReplaceTemplate) ReplaceAllBytes(input []byte) []byte {
	return t.ReplaceAllBytesAppend(input, nil)
}

// ReplaceAllBytesAppend replaces all matches and appends to buf.
// If buf has sufficient capacity, no allocation occurs.
func (t *ReDamageImmuneReplaceTemplate) ReplaceAllBytesAppend(input []byte, buf []byte) []byte {
	result := buf[:0]
	lastEnd := 0
	var r ReDamageImmuneBytesResult
...
func (t *ReDamageImmuneReplaceTemplate) ReplaceFirstString(input string) string {
	var r ReDamageImmuneResult
	match, ok := ReDamageImmune{}.FindStringReuse(input, &r)
	if !ok {
		return input
...
func (t *ReDamageImmuneReplaceTemplate) ReplaceFirstBytes(input []byte) []byte {
	var r ReDamageImmuneBytesResult
	match, ok := ReDamageImmune{}.FindBytesReuse(input, &r)
	if !ok {
		return append([]byte{}, input...)
