...
// Code generated by regengo for pattern: (.+[^\s])'s (.+[^\s]) causes (.+[^\s]) (\d+) damage\.\s?(.*)
// DO NOT EDIT.

var reDamageSpellSplitStackPool = sync.Pool{New: func() interface{} {
	stack := make([][3]int, 0, 32)
	return &stack
}}

var reDamageSpellSplitCaptureStackPool = sync.Pool{New: func() interface{} {
	stack := make([]int, 0, 192)
	return &stack
}}

type ReDamageSpellSplit struct{}

var CompiledReDamageSpellSplit = ReDamageSpellSplit{}

// MinMatchLen is the minimum number of bytes any match can have.
const ReDamageSpellSplitMinMatchLen = 27

// MaxMatchLen is the maximum number of bytes any match can have.
// -1 means unbounded (pattern contains * or + quantifiers).
const ReDamageSpellSplitMaxMatchLen = -1

func (ReDamageSpellSplit) MatchLengthInfo() (minLen, maxLen int) {
	return ReDamageSpellSplitMinMatchLen, ReDamageSpellSplitMaxMatchLen
}

func (ReDamageSpellSplit) MatchString(input string) bool {
	l := len(input)
	offset := 0
	stackPtr := reDamageSpellSplitStackPool.Get().(*[][3]int)
	stack := (*stackPtr)[:0]
	defer func() {
		for i := range stack {
			stack[i] = [3]int{0, 0, 0}
		...
		*stackPtr = stack[:0]
		reDamageSpellSplitStackPool.Put(stackPtr)
	}()
	nextInstruction := 1
	goto StepSelect
TryFallback:
...
func (ReDamageSpellSplit) MatchBytes(input []byte) bool {
	l := len(input)
	offset := 0
	stackPtr := reDamageSpellSplitStackPool.Get().(*[][3]int)
	stack := (*stackPtr)[:0]
...
type ReDamageSpellSplitResult struct {
...
type ReDamageSpellSplitBytesResult struct {
...
func (ReDamageSpellSplit) FindStringReuse(input string, r *ReDamageSpellSplitResult) (*ReDamageSpellSplitResult, bool) {
	l := len(input)
	offset := 0
	var captures [12]int
	stackPtr := reDamageSpellSplitStackPool.Get().(*[][3]int)
...
func (recv ReDamageSpellSplit) FindString(input string) (*ReDamageSpellSplitResult, bool) {
	return recv.FindStringReuse(input, nil)
}
func (ReDamageSpellSplit) FindAllStringAppend(input string, n int, s []*ReDamageSpellSplitResult) []*ReDamageSpellSplitResult {
	if n == 0 {
		return s
	}
	result := s
	...
	Ins46:
		{
			captures[1] = offset
			var item *ReDamageSpellSplitResult
			if len(result) < cap(result) {
				result = result[:len(result)+1]
				item = result[len(result)-1]
				if item == nil {
					item = &ReDamageSpellSplitResult{}
...
func (r ReDamageSpellSplit) FindAllString(input string, n int) []*ReDamageSpellSplitResult {
	return r.FindAllStringAppend(input, n, nil)
}
func (ReDamageSpellSplit) FindBytesReuse(input []byte, r *ReDamageSpellSplitBytesResult) (*ReDamageSpellSplitBytesResult, bool) {
	l := len(input)
	offset := 0
	var captures [12]int
	stackPtr := reDamageSpellSplitStackPool.Get().(*[][3]int)
...
Ins46:
	{
		captures[1] = offset
		if r == nil {
			r = &ReDamageSpellSplitBytesResult{}
		}
...
func (recv ReDamageSpellSplit) FindBytes(input []byte) (*ReDamageSpellSplitBytesResult, bool) {
	return recv.FindBytesReuse(input, nil)
}
func (ReDamageSpellSplit) FindAllBytesAppend(input []byte, n int, s []*ReDamageSpellSplitBytesResult) []*ReDamageSpellSplitBytesResult {
	if n == 0 {
		return s
	}
	result := s
	...
	Ins46:
		{
			captures[1] = offset
			var item *ReDamageSpellSplitBytesResult
			if len(result) < cap(result) {
				result = result[:len(result)+1]
				item = result[len(result)-1]
				if item == nil {
					item = &ReDamageSpellSplitBytesResult{}
					result[len(result)-1] = item
				}
			} else {
				item = &ReDamageSpellSplitBytesResult{}
...
func (r ReDamageSpellSplit) FindAllBytes(input []byte, n int) []*ReDamageSpellSplitBytesResult {
...
func (ReDamageSpellSplit) DefaultMaxLeftover() int {
	return 1048576
}
...
func (ReDamageSpellSplit) FindReader(r io.Reader, cfg stream.Config, onMatch func(stream.Match[*ReDamageSpellSplitBytesResult]) bool) error {
	...
	reuseResult := &ReDamageSpellSplitBytesResult{}
			...
			if err == io.EOF {
				...
				if leftover > 0 {
					...
					for searchPos < len(chunk) {
						result, ok := ReDamageSpellSplit{}.FindBytesReuse(chunk[searchPos:], reuseResult)
						if !ok {
							break
						}
						...
						m := stream.Match[*ReDamageSpellSplitBytesResult]{
...
func (ReDamageSpellSplit) FindReaderCount(r io.Reader, cfg stream.Config) (int64, error) {
	var count int64
	err := ReDamageSpellSplit{}.FindReader(r, cfg, func(_ stream.Match[*ReDamageSpellSplitBytesResult]) bool {
		count++
		return true
	})
	return count, err
...
func (ReDamageSpellSplit) FindReaderFirst(r io.Reader, cfg stream.Config) (*ReDamageSpellSplitBytesResult, int64, error) {
	var result *ReDamageSpellSplitBytesResult
	var offset int64
	err := ReDamageSpellSplit{}.FindReader(r, cfg, func(m stream.Match[*ReDamageSpellSplitBytesResult]) bool {
		// Copy the result since buffer will be reused
		result = ReDamageSpellSplit{}.copyBytesResult(m.Result)
...
func (ReDamageSpellSplit) copyBytesResult(src *ReDamageSpellSplitBytesResult) *ReDamageSpellSplitBytesResult {
	if src == nil {
		return nil
	}
	dst := &ReDamageSpellSplitBytesResult{}
	// Copy Match slice
...
//	    })
//	io.Copy(os.Stdout, r)
func (ReDamageSpellSplit) NewTransformReader(r io.Reader, cfg stream.TransformConfig, onMatch func(match *ReDamageSpellSplitBytesResult, emit func([]byte))) io.Reader {
	if cfg.BufferSize == 0 {
	...
	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReDamageSpellSplit{}.processTransform(data, isEOF, onMatch, emitOut)
	}
...
func (ReDamageSpellSplit) processTransform(data []byte, isEOF bool, onMatch func(match *ReDamageSpellSplitBytesResult, emit func([]byte)), emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReDamageSpellSplitBytesResult{}

	for {
		result, ok := ReDamageSpellSplit{}.FindBytesReuse(data[processed:], reuseResult)
		if !ok {
			// No more matches
			if isEOF {
...
//	io.Copy(os.Stdout, r)
func (ReDamageSpellSplit) ReplaceReader(r io.Reader, template string) io.Reader {
	parsed, err := replace.Parse(template)
	if err != nil {
		return &reDamageSpellSplitTransformErrReader{err: err}
	}
	...
	return ReDamageSpellSplit{}.NewTransformReader(r, stream.DefaultTransformConfig(), func(m *ReDamageSpellSplitBytesResult, emit func([]byte)) {
		...
		for _, seg := range resolved {
			...
			case replace.SegmentCaptureIndex:
				capture := (ReDamageSpellSplit{}).getCaptureByIndex(m, seg.CaptureIndex)
				if capture != nil {
...
// reDamageSpellSplitTransformErrReader is a reader that always returns an error.
type reDamageSpellSplitTransformErrReader struct {
	err error
}

func (r *reDamageSpellSplitTransformErrReader) Read(p []byte) (int, error) {
	return 0, r.err
}

// getCaptureByIndex returns the capture group value by its index.
func (ReDamageSpellSplit) getCaptureByIndex(m *ReDamageSpellSplitBytesResult, index int) []byte {
	switch index {
	case 0:
		return m.Match
	default:
...
//	})
func (ReDamageSpellSplit) SelectReader(r io.Reader, pred func(*ReDamageSpellSplitBytesResult) bool) io.Reader {
	cfg := stream.DefaultTransformConfig()
	cfg.MaxLeftover = 1048576

	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReDamageSpellSplit{}.processSelect(data, isEOF, pred, emitOut)
	}
...
func (ReDamageSpellSplit) processSelect(data []byte, isEOF bool, pred func(*ReDamageSpellSplitBytesResult) bool, emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReDamageSpellSplitBytesResult{}
...
//	})
func (ReDamageSpellSplit) RejectReader(r io.Reader, pred func(*ReDamageSpellSplitBytesResult) bool) io.Reader {
	cfg := stream.DefaultTransformConfig()
	cfg.MaxLeftover = 1048576

	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReDamageSpellSplit{}.processReject(data, isEOF, pred, emitOut)
	}
...
func (ReDamageSpellSplit) processReject(data []byte, isEOF bool, pred func(*ReDamageSpellSplitBytesResult) bool, emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReDamageSpellSplitBytesResult{}
...
func (r *ReDamageSpellSplitResult) CaptureByIndex(idx int) string {
	switch idx {
	case 0:
		return r.Match
	case 1:
...
// CaptureByIndex returns the capture group value by its 0-based index.
// Index 0 returns the full match, 1+ returns capture groups.
func (r *ReDamageSpellSplitBytesResult) CaptureByIndex(idx int) []byte {
	switch idx {
	case 0:
		return r.Match
	case 1:
...
func (ReDamageSpellSplit) ReplaceAllString(input string, template string) string {
	...
	lastEnd := 0
	var r ReDamageSpellSplitResult

	remaining := input
	offset := 0

	for {
		match, ok := ReDamageSpellSplit{}.FindStringReuse(remaining, &r)
		if !ok {
			break
		}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageSpellSplit) ReplaceAllBytes(input []byte, template string) []byte {
	return ReDamageSpellSplit{}.ReplaceAllBytesAppend(input, template, nil)
}

// ReplaceAllBytesAppend replaces all matches and appends to buf.
// If buf has sufficient capacity, no allocation occurs.
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageSpellSplit) ReplaceAllBytesAppend(input []byte, template string, buf []byte) []byte {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	result := buf[:0]
	lastEnd := 0
	var r ReDamageSpellSplitBytesResult

	remaining := input
	offset := 0

	for {
		match, ok := ReDamageSpellSplit{}.FindBytesReuse(remaining, &r)
		if !ok {
			break
		}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageSpellSplit) ReplaceFirstString(input string, template string) string {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	var r ReDamageSpellSplitResult
	match, ok := ReDamageSpellSplit{}.FindStringReuse(input, &r)
	if !ok {
		return input
	}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageSpellSplit) ReplaceFirstBytes(input []byte, template string) []byte {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	var r ReDamageSpellSplitBytesResult
	match, ok := ReDamageSpellSplit{}.FindBytesReuse(input, &r)
	if !ok {
...
// ReDamageSpellSplitReplaceTemplate holds a pre-compiled replace template for the ReDamageSpellSplit pattern.
// Use CompileReplaceTemplate to create one, then call its Replace methods.
type ReDamageSpellSplitReplaceTemplate struct {
	original string
...
//
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageSpellSplit) CompileReplaceTemplate(template string) (*ReDamageSpellSplitReplaceTemplate, error) {
	tmpl, err := replace.Parse(template)
	if err != nil {
		return nil, err
	}
	...
	return &ReDamageSpellSplitReplaceTemplate{
		original: template,
		segments: resolved,
	}, nil
}
...
func (t *ReDamageSpellSplitReplaceTemplate) String() string {
	return t.original
}

// ReplaceAllString replaces all matches in input using this compiled template.
func (t *ReDamageSpellSplitReplaceTemplate) ReplaceAllString(input string) string {
	var result strings.Builder
	lastEnd := 0
	var r ReDamageSpellSplitResult
...
func (t *ReDamageSpellSplitReplaceTemplate) ReplaceAllBytes(input []byte) []byte {
	return t.ReplaceAllBytesAppend(input, nil)
}

// ReplaceAllBytesAppend replaces all matches and appends to buf.
// If buf has sufficient capacity, no allocation occurs.
func (t *ReDamageSpellSplitReplaceTemplate) ReplaceAllBytesAppend(input []byte, buf []byte) []byte {
	result := buf[:0]
	lastEnd := 0
	var r ReDamageSpellSplitBytesResult
...
func (t *ReDamageSpellSplitReplaceTemplate) ReplaceFirstString(input string) string {
	var r ReDamageSpellSplitResult
	match, ok := ReDamageSpellSplit{}.FindStringReuse(input, &r)
	if !ok {
		return input
...
func (t *ReDamageSpellSplitReplaceTemplate) ReplaceFirstBytes(input []byte) []byte {
	var r ReDamageSpellSplitBytesResult
	match, ok := ReDamageSpellSplit{}.FindBytesReuse(input, &r)
	if !ok {
		return append([]byte{}, input...)
