...
// Code generated by regengo for pattern: (.+[^\s]) reflects (\d+) ([a-zA-Z]+) damage to (.+[^\s])\.
// DO NOT EDIT.

var reDamageShieldStackPool = sync.Pool{New: func() interface{} {
	stack := make([][3]int, 0, 32)
	return &stack
}}

var reDamageShieldCaptureStackPool = sync.Pool{New: func() interface{} {
	stack := make([]int, 0, 160)
	return &stack
}}

type ReDamageShield struct{}

var CompiledReDamageShield = ReDamageShield{}

// MinMatchLen is the minimum number of bytes any match can have.
const ReDamageShieldMinMatchLen = 29

// MaxMatchLen is the maximum number of bytes any match can have.
// -1 means unbounded (pattern contains * or + quantifiers).
const ReDamageShieldMaxMatchLen = -1

func (ReDamageShield) MatchLengthInfo() (minLen, maxLen int) {
	return ReDamageShieldMinMatchLen, ReDamageShieldMaxMatchLen
}

func (ReDamageShield) MatchString(input string) bool {
	l := len(input)
	offset := 0
	stackPtr := reDamageShieldStackPool.Get().(*[][3]int)
	stack := (*stackPtr)[:0]
	defer func() {
		for i := range stack {
			stack[i] = [3]int{0, 0, 0}
		...
		*stackPtr = stack[:0]
		reDamageShieldStackPool.Put(stackPtr)
	}()
	nextInstruction := 1
	goto StepSelect
TryFallback:
...
func (ReDamageShield) MatchBytes(input []byte) bool {
	l := len(input)
	offset := 0
	stackPtr := reDamageShieldStackPool.Get().(*[][3]int)
	stack := (*stackPtr)[:0]
...
type ReDamageShieldResult struct {
...
type ReDamageShieldBytesResult struct {
...
func (ReDamageShield) FindStringReuse(input string, r *ReDamageShieldResult) (*ReDamageShieldResult, bool) {
	l := len(input)
	offset := 0
	var captures [10]int
	stackPtr := reDamageShieldStackPool.Get().(*[][3]int)
...
func (recv ReDamageShield) FindString(input string) (*ReDamageShieldResult, bool) {
	return recv.FindStringReuse(input, nil)
}
func (ReDamageShield) FindAllStringAppend(input string, n int, s []*ReDamageShieldResult) []*ReDamageShieldResult {
	if n == 0 {
		return s
	}
	result := s
	...
	Ins42:
		{
			captures[1] = offset
			var item *ReDamageShieldResult
			if len(result) < cap(result) {
				result = result[:len(result)+1]
				item = result[len(result)-1]
				if item == nil {
					item = &ReDamageShieldResult{}
...
func (r ReDamageShield) FindAllString(input string, n int) []*ReDamageShieldResult {
	return r.FindAllStringAppend(input, n, nil)
}
func (ReDamageShield) FindBytesReuse(input []byte, r *ReDamageShieldBytesResult) (*ReDamageShieldBytesResult, bool) {
	l := len(input)
	offset := 0
	var captures [10]int
	stackPtr := reDamageShieldStackPool.Get().(*[][3]int)
...
func (recv ReDamageShield) FindBytes(input []byte) (*ReDamageShieldBytesResult, bool) {
	return recv.FindBytesReuse(input, nil)
}
func (ReDamageShield) FindAllBytesAppend(input []byte, n int, s []*ReDamageShieldBytesResult) []*ReDamageShieldBytesResult {
	if n == 0 {
		return s
	}
	result := s
	...
	Ins42:
		{
			captures[1] = offset
			var item *ReDamageShieldBytesResult
			if len(result) < cap(result) {
				result = result[:len(result)+1]
				item = result[len(result)-1]
				if item == nil {
					item = &ReDamageShieldBytesResult{}
					result[len(result)-1] = item
				}
			} else {
				item = &ReDamageShieldBytesResult{}
...
func (r ReDamageShield) FindAllBytes(input []byte, n int) []*ReDamageShieldBytesResult {
...
func (ReDamageShield) DefaultMaxLeftover() int {
	return 1048576
}
...
func (ReDamageShield) FindReader(r io.Reader, cfg stream.Config, onMatch func(stream.Match[*ReDamageShieldBytesResult]) bool) error {
	...
	reuseResult := &ReDamageShieldBytesResult{}
			...
			if err == io.EOF {
				...
				if leftover > 0 {
					...
					for searchPos < len(chunk) {
						result, ok := ReDamageShield{}.FindBytesReuse(chunk[searchPos:], reuseResult)
						if !ok {
							break
						}
						...
						m := stream.Match[*ReDamageShieldBytesResult]{
...
func (ReDamageShield) FindReaderCount(r io.Reader, cfg stream.Config) (int64, error) {
	var count int64
	err := ReDamageShield{}.FindReader(r, cfg, func(_ stream.Match[*ReDamageShieldBytesResult]) bool {
		count++
		return true
	})
	return count, err
...
func (ReDamageShield) FindReaderFirst(r io.Reader, cfg stream.Config) (*ReDamageShieldBytesResult, int64, error) {
	var result *ReDamageShieldBytesResult
	var offset int64
	err := ReDamageShield{}.FindReader(r, cfg, func(m stream.Match[*ReDamageShieldBytesResult]) bool {
		// Copy the result since buffer will be reused
		result = ReDamageShield{}.copyBytesResult(m.Result)
...
func (ReDamageShield) copyBytesResult(src *ReDamageShieldBytesResult) *ReDamageShieldBytesResult {
	if src == nil {
		return nil
	}
	dst := &ReDamageShieldBytesResult{}
	// Copy Match slice
...
//	    })
//	io.Copy(os.Stdout, r)
func (ReDamageShield) NewTransformReader(r io.Reader, cfg stream.TransformConfig, onMatch func(match *ReDamageShieldBytesResult, emit func([]byte))) io.Reader {
	if cfg.BufferSize == 0 {
	...
	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReDamageShield{}.processTransform(data, isEOF, onMatch, emitOut)
	}
...
func (ReDamageShield) processTransform(data []byte, isEOF bool, onMatch func(match *ReDamageShieldBytesResult, emit func([]byte)), emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReDamageShieldBytesResult{}

	for {
		result, ok := ReDamageShield{}.FindBytesReuse(data[processed:], reuseResult)
		if !ok {
			// No more matches
			if isEOF {
...
//	io.Copy(os.Stdout, r)
func (ReDamageShield) ReplaceReader(r io.Reader, template string) io.Reader {
	parsed, err := replace.Parse(template)
	if err != nil {
		return &reDamageShieldTransformErrReader{err: err}
	}
	...
	return ReDamageShield{}.NewTransformReader(r, stream.DefaultTransformConfig(), func(m *ReDamageShieldBytesResult, emit func([]byte)) {
		...
		for _, seg := range resolved {
			...
			case replace.SegmentCaptureIndex:
				capture := (ReDamageShield{}).getCaptureByIndex(m, seg.CaptureIndex)
				if capture != nil {
...
// reDamageShieldTransformErrReader is a reader that always returns an error.
type reDamageShieldTransformErrReader struct {
	err error
}

func (r *reDamageShieldTransformErrReader) Read(p []byte) (int, error) {
	return 0, r.err
}

// getCaptureByIndex returns the capture group value by its index.
func (ReDamageShield) getCaptureByIndex(m *ReDamageShieldBytesResult, index int) []byte {
	switch index {
	case 0:
		return m.Match
	default:
...
//	})
func (ReDamageShield) SelectReader(r io.Reader, pred func(*ReDamageShieldBytesResult) bool) io.Reader {
	cfg := stream.DefaultTransformConfig()
	cfg.MaxLeftover = 1048576

	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReDamageShield{}.processSelect(data, isEOF, pred, emitOut)
	}
...
func (ReDamageShield) processSelect(data []byte, isEOF bool, pred func(*ReDamageShieldBytesResult) bool, emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReDamageShieldBytesResult{}
...
//	})
func (ReDamageShield) RejectReader(r io.Reader, pred func(*ReDamageShieldBytesResult) bool) io.Reader {
	cfg := stream.DefaultTransformConfig()
	cfg.MaxLeftover = 1048576

	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReDamageShield{}.processReject(data, isEOF, pred, emitOut)
	}
...
func (ReDamageShield) processReject(data []byte, isEOF bool, pred func(*ReDamageShieldBytesResult) bool, emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReDamageShieldBytesResult{}
...
func (r *ReDamageShieldResult) CaptureByIndex(idx int) string {
	switch idx {
	case 0:
		return r.Match
	case 1:
...
// CaptureByIndex returns the capture group value by its 0-based index.
// Index 0 returns the full match, 1+ returns capture groups.
func (r *ReDamageShieldBytesResult) CaptureByIndex(idx int) []byte {
	switch idx {
	case 0:
		return r.Match
	case 1:
...
func (ReDamageShield) ReplaceAllString(input string, template string) string {
	...
	lastEnd := 0
	var r ReDamageShieldResult

	remaining := input
	offset := 0

	for {
		match, ok := ReDamageShield{}.FindStringReuse(remaining, &r)
		if !ok {
			break
		}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageShield) ReplaceAllBytes(input []byte, template string) []byte {
	return ReDamageShield{}.ReplaceAllBytesAppend(input, template, nil)
}

// ReplaceAllBytesAppend replaces all matches and appends to buf.
// If buf has sufficient capacity, no allocation occurs.
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageShield) ReplaceAllBytesAppend(input []byte, template string, buf []byte) []byte {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	result := buf[:0]
	lastEnd := 0
	var r ReDamageShieldBytesResult

	remaining := input
	offset := 0

	for {
		match, ok := ReDamageShield{}.FindBytesReuse(remaining, &r)
		if !ok {
			break
		}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageShield) ReplaceFirstString(input string, template string) string {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	var r ReDamageShieldResult
	match, ok := ReDamageShield{}.FindStringReuse(input, &r)
	if !ok {
		return input
	}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageShield) ReplaceFirstBytes(input []byte, template string) []byte {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	var r ReDamageShieldBytesResult
	match, ok := ReDamageShield{}.FindBytesReuse(input, &r)
	if !ok {
...
// ReDamageShieldReplaceTemplate holds a pre-compiled replace template for the ReDamageShield pattern.
// Use CompileReplaceTemplate to create one, then call its Replace methods.
type ReDamageShieldReplaceTemplate struct {
	original string
...
//
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageShield) CompileReplaceTemplate(template string) (*ReDamageShieldReplaceTemplate, error) {
	tmpl, err := replace.Parse(template)
	if err != nil {
		return nil, err
	}
	...
	return &ReDamageShieldReplaceTemplate{
		original: template,
		segments: resolved,
	}, nil
}
...
func (t *ReDamageShieldReplaceTemplate) String() string {
	return t.original
}

// ReplaceAllString replaces all matches in input using this compiled template.
func (t *ReDamageShieldReplaceTemplate) ReplaceAllString(input string) string {
	var result strings.Builder
	lastEnd := 0
	var r ReDamageShieldResult
...
func (t *ReDamageShieldReplaceTemplate) ReplaceAllBytes(input []byte) []byte {
	return t.ReplaceAllBytesAppend(input, nil)
}

// ReplaceAllBytesAppend replaces all matches and appends to buf.
// If buf has sufficient capacity, no allocation occurs.
func (t *ReDamageShieldReplaceTemplate) ReplaceAllBytesAppend(input []byte, buf []byte) []byte {
	result := buf[:0]
	lastEnd := 0
	var r ReDamageShieldBytesResult
...
func (t *ReDamageShieldReplaceTemplate) ReplaceFirstString(input string) string {
	var r ReDamageShieldResult
	match, ok := ReDamageShield{}.FindStringReuse(input, &r)
	if !ok {
		return input
...
func (t *ReDamageShieldReplaceTemplate) ReplaceFirstBytes(input []byte) []byte {
	var r ReDamageShieldBytesResult
	match, ok := ReDamageShield{}.FindBytesReuse(input, &r)
	if !ok {
		return append([]byte{}, input...)
