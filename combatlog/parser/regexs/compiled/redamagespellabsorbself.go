...
// Code generated by regengo for pattern: (.+[^\s]) absorbs (.+[^\s])\s's (.+[^\s])\.
// DO NOT EDIT.

var reDamageSpellAbsorbSelfStackPool = sync.Pool{New: func() interface{} {
	stack := make([][3]int, 0, 32)
	return &stack
}}

var reDamageSpellAbsorbSelfCaptureStackPool = sync.Pool{New: func() interface{} {
	stack := make([]int, 0, 128)
	return &stack
}}

type ReDamageSpellAbsorbSelf struct{}

var CompiledReDamageSpellAbsorbSelf = ReDamageSpellAbsorbSelf{}

// MinMatchLen is the minimum number of bytes any match can have.
const ReDamageSpellAbsorbSelfMinMatchLen = 20

// MaxMatchLen is the maximum number of bytes any match can have.
// -1 means unbounded (pattern contains * or + quantifiers).
const ReDamageSpellAbsorbSelfMaxMatchLen = -1

func (ReDamageSpellAbsorbSelf) MatchLengthInfo() (minLen, maxLen int) {
	return ReDamageSpellAbsorbSelfMinMatchLen, ReDamageSpellAbsorbSelfMaxMatchLen
}

func (ReDamageSpellAbsorbSelf) MatchString(input string) bool {
	l := len(input)
	offset := 0
	stackPtr := reDamageSpellAbsorbSelfStackPool.Get().(*[][3]int)
	stack := (*stackPtr)[:0]
	defer func() {
		for i := range stack {
			stack[i] = [3]int{0, 0, 0}
		...
		*stackPtr = stack[:0]
		reDamageSpellAbsorbSelfStackPool.Put(stackPtr)
	}()
	nextInstruction := 1
	goto StepSelect
TryFallback:
...
func (ReDamageSpellAbsorbSelf) MatchBytes(input []byte) bool {
	l := len(input)
	offset := 0
	stackPtr := reDamageSpellAbsorbSelfStackPool.Get().(*[][3]int)
	stack := (*stackPtr)[:0]
...
type ReDamageSpellAbsorbSelfResult struct {
...
type ReDamageSpellAbsorbSelfBytesResult struct {
...
func (ReDamageSpellAbsorbSelf) FindStringReuse(input string, r *ReDamageSpellAbsorbSelfResult) (*ReDamageSpellAbsorbSelfResult, bool) {
	l := len(input)
	offset := 0
	var captures [8]int
	captureStackPtr := reDamageSpellAbsorbSelfCaptureStackPool.Get().(*[]int)
	captureStack := (*captureStackPtr)[:0]
	defer func() {
		*captureStackPtr = captureStack[:0]
		reDamageSpellAbsorbSelfCaptureStackPool.Put(captureStackPtr)
	}()
	stackPtr := reDamageSpellAbsorbSelfStackPool.Get().(*[][3]int)
	stack := (*stackPtr)[:0]
	defer func() {
...
Ins26:
	{
		captureStack = append(captureStack, captures[:]...)
		stack = append(stack, [3]int{offset, 27, 1})
		goto Ins25
	}
Ins27:
	{
...
Ins30:
	{
		captures[1] = offset
		if r == nil {
			r = &ReDamageSpellAbsorbSelfResult{}
		}
...
func (recv ReDamageSpellAbsorbSelf) FindString(input string) (*ReDamageSpellAbsorbSelfResult, bool) {
	return recv.FindStringReuse(input, nil)
}
func (ReDamageSpellAbsorbSelf) FindAllStringAppend(input string, n int, s []*ReDamageSpellAbsorbSelfResult) []*ReDamageSpellAbsorbSelfResult {
	if n == 0 {
		return s
	}
	result := s
	...
	Ins30:
		{
			captures[1] = offset
			var item *ReDamageSpellAbsorbSelfResult
			if len(result) < cap(result) {
				result = result[:len(result)+1]
				item = result[len(result)-1]
				if item == nil {
					item = &ReDamageSpellAbsorbSelfResult{}
...
func (r ReDamageSpellAbsorbSelf) FindAllString(input string, n int) []*ReDamageSpellAbsorbSelfResult {
	return r.FindAllStringAppend(input, n, nil)
}
func (ReDamageSpellAbsorbSelf) FindBytesReuse(input []byte, r *ReDamageSpellAbsorbSelfBytesResult) (*ReDamageSpellAbsorbSelfBytesResult, bool) {
	l := len(input)
	offset := 0
	var captures [8]int
	captureStackPtr := reDamageSpellAbsorbSelfCaptureStackPool.Get().(*[]int)
...
Ins30:
	{
		captures[1] = offset
		if r == nil {
			r = &ReDamageSpellAbsorbSelfBytesResult{}
		}
...
func (recv ReDamageSpellAbsorbSelf) FindBytes(input []byte) (*ReDamageSpellAbsorbSelfBytesResult, bool) {
	return recv.FindBytesReuse(input, nil)
}
func (ReDamageSpellAbsorbSelf) FindAllBytesAppend(input []byte, n int, s []*ReDamageSpellAbsorbSelfBytesResult) []*ReDamageSpellAbsorbSelfBytesResult {
	if n == 0 {
		return s
	}
	result := s
	...
	Ins30:
		{
			captures[1] = offset
			var item *ReDamageSpellAbsorbSelfBytesResult
			if len(result) < cap(result) {
				result = result[:len(result)+1]
				item = result[len(result)-1]
				if item == nil {
					item = &ReDamageSpellAbsorbSelfBytesResult{}
					result[len(result)-1] = item
				}
			} else {
				item = &ReDamageSpellAbsorbSelfBytesResult{}
...
func (r ReDamageSpellAbsorbSelf) FindAllBytes(input []byte, n int) []*ReDamageSpellAbsorbSelfBytesResult {
...
func (ReDamageSpellAbsorbSelf) DefaultMaxLeftover() int {
	return 1048576
}
...
func (ReDamageSpellAbsorbSelf) FindReader(r io.Reader, cfg stream.Config, onMatch func(stream.Match[*ReDamageSpellAbsorbSelfBytesResult]) bool) error {
	...
	reuseResult := &ReDamageSpellAbsorbSelfBytesResult{}
			...
			if err == io.EOF {
				...
				if leftover > 0 {
					...
					for searchPos < len(chunk) {
						result, ok := ReDamageSpellAbsorbSelf{}.FindBytesReuse(chunk[searchPos:], reuseResult)
						if !ok {
							break
						}
						...
						m := stream.Match[*ReDamageSpellAbsorbSelfBytesResult]{
...
func (ReDamageSpellAbsorbSelf) FindReaderCount(r io.Reader, cfg stream.Config) (int64, error) {
	var count int64
	err := ReDamageSpellAbsorbSelf{}.FindReader(r, cfg, func(_ stream.Match[*ReDamageSpellAbsorbSelfBytesResult]) bool {
		count++
		return true
	})
	return count, err
...
func (ReDamageSpellAbsorbSelf) FindReaderFirst(r io.Reader, cfg stream.Config) (*ReDamageSpellAbsorbSelfBytesResult, int64, error) {
	var result *ReDamageSpellAbsorbSelfBytesResult
	var offset int64
	err := ReDamageSpellAbsorbSelf{}.FindReader(r, cfg, func(m stream.Match[*ReDamageSpellAbsorbSelfBytesResult]) bool {
		// Copy the result since buffer will be reused
		result = ReDamageSpellAbsorbSelf{}.copyBytesResult(m.Result)
...
func (ReDamageSpellAbsorbSelf) copyBytesResult(src *ReDamageSpellAbsorbSelfBytesResult) *ReDamageSpellAbsorbSelfBytesResult {
	if src == nil {
		return nil
	}
	dst := &ReDamageSpellAbsorbSelfBytesResult{}
	// Copy Match slice
...
//	    })
//	io.Copy(os.Stdout, r)
func (ReDamageSpellAbsorbSelf) NewTransformReader(r io.Reader, cfg stream.TransformConfig, onMatch func(match *ReDamageSpellAbsorbSelfBytesResult, emit func([]byte))) io.Reader {
	if cfg.BufferSize == 0 {
	...
	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReDamageSpellAbsorbSelf{}.processTransform(data, isEOF, onMatch, emitOut)
	}
...
func (ReDamageSpellAbsorbSelf) processTransform(data []byte, isEOF bool, onMatch func(match *ReDamageSpellAbsorbSelfBytesResult, emit func([]byte)), emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReDamageSpellAbsorbSelfBytesResult{}

	for {
		result, ok := ReDamageSpellAbsorbSelf{}.FindBytesReuse(data[processed:], reuseResult)
		if !ok {
			// No more matches
			if isEOF {
...
//	io.Copy(os.Stdout, r)
func (ReDamageSpellAbsorbSelf) ReplaceReader(r io.Reader, template string) io.Reader {
	parsed, err := replace.Parse(template)
	if err != nil {
		return &reDamageSpellAbsorbSelfTransformErrReader{err: err}
	}
	...
	return ReDamageSpellAbsorbSelf{}.NewTransformReader(r, stream.DefaultTransformConfig(), func(m *ReDamageSpellAbsorbSelfBytesResult, emit func([]byte)) {
		...
		for _, seg := range resolved {
			...
			case replace.SegmentCaptureIndex:
				capture := (ReDamageSpellAbsorbSelf{}).getCaptureByIndex(m, seg.CaptureIndex)
				if capture != nil {
...
// reDamageSpellAbsorbSelfTransformErrReader is a reader that always returns an error.
type reDamageSpellAbsorbSelfTransformErrReader struct {
	err error
}

func (r *reDamageSpellAbsorbSelfTransformErrReader) Read(p []byte) (int, error) {
	return 0, r.err
}

// getCaptureByIndex returns the capture group value by its index.
func (ReDamageSpellAbsorbSelf) getCaptureByIndex(m *ReDamageSpellAbsorbSelfBytesResult, index int) []byte {
	switch index {
	case 0:
		return m.Match
	default:
...
//	})
func (ReDamageSpellAbsorbSelf) SelectReader(r io.Reader, pred func(*ReDamageSpellAbsorbSelfBytesResult) bool) io.Reader {
	cfg := stream.DefaultTransformConfig()
	cfg.MaxLeftover = 1048576

	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReDamageSpellAbsorbSelf{}.processSelect(data, isEOF, pred, emitOut)
	}
...
func (ReDamageSpellAbsorbSelf) processSelect(data []byte, isEOF bool, pred func(*ReDamageSpellAbsorbSelfBytesResult) bool, emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReDamageSpellAbsorbSelfBytesResult{}
...
//	})
func (ReDamageSpellAbsorbSelf) RejectReader(r io.Reader, pred func(*ReDamageSpellAbsorbSelfBytesResult) bool) io.Reader {
	cfg := stream.DefaultTransformConfig()
	cfg.MaxLeftover = 1048576

	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReDamageSpellAbsorbSelf{}.processReject(data, isEOF, pred, emitOut)
	}
...
func (ReDamageSpellAbsorbSelf) processReject(data []byte, isEOF bool, pred func(*ReDamageSpellAbsorbSelfBytesResult) bool, emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReDamageSpellAbsorbSelfBytesResult{}
...
func (r *ReDamageSpellAbsorbSelfResult) CaptureByIndex(idx int) string {
	switch idx {
	case 0:
		return r.Match
	case 1:
...
// CaptureByIndex returns the capture group value by its 0-based index.
// Index 0 returns the full match, 1+ returns capture groups.
func (r *ReDamageSpellAbsorbSelfBytesResult) CaptureByIndex(idx int) []byte {
	switch idx {
	case 0:
		return r.Match
	case 1:
...
func (ReDamageSpellAbsorbSelf) ReplaceAllString(input string, template string) string {
	...
	lastEnd := 0
	var r ReDamageSpellAbsorbSelfResult

	remaining := input
	offset := 0

	for {
		match, ok := ReDamageSpellAbsorbSelf{}.FindStringReuse(remaining, &r)
		if !ok {
			break
		}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageSpellAbsorbSelf) ReplaceAllBytes(input []byte, template string) []byte {
	return ReDamageSpellAbsorbSelf{}.ReplaceAllBytesAppend(input, template, nil)
}

// ReplaceAllBytesAppend replaces all matches and appends to buf.
// If buf has sufficient capacity, no allocation occurs.
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageSpellAbsorbSelf) ReplaceAllBytesAppend(input []byte, template string, buf []byte) []byte {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	result := buf[:0]
	lastEnd := 0
	var r ReDamageSpellAbsorbSelfBytesResult

	remaining := input
	offset := 0

	for {
		match, ok := ReDamageSpellAbsorbSelf{}.FindBytesReuse(remaining, &r)
		if !ok {
			break
		}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageSpellAbsorbSelf) ReplaceFirstString(input string, template string) string {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	var r ReDamageSpellAbsorbSelfResult
	match, ok := ReDamageSpellAbsorbSelf{}.FindStringReuse(input, &r)
	if !ok {
		return input
	}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageSpellAbsorbSelf) ReplaceFirstBytes(input []byte, template string) []byte {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	var r ReDamageSpellAbsorbSelfBytesResult
	match, ok := ReDamageSpellAbsorbSelf{}.FindBytesReuse(input, &r)
	if !ok {
...
// ReDamageSpellAbsorbSelfReplaceTemplate holds a pre-compiled replace template for the ReDamageSpellAbsorbSelf pattern.
// Use CompileReplaceTemplate to create one, then call its Replace methods.
type ReDamageSpellAbsorbSelfReplaceTemplate struct {
	original string
...
//
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageSpellAbsorbSelf) CompileReplaceTemplate(template string) (*ReDamageSpellAbsorbSelfReplaceTemplate, error) {
	tmpl, err := replace.Parse(template)
	if err != nil {
		return nil, err
	}
	...
	return &ReDamageSpellAbsorbSelfReplaceTemplate{
		original: template,
		segments: resolved,
	}, nil
}
...
func (t *ReDamageSpellAbsorbSelfReplaceTemplate) String() string {
	return t.original
}

// ReplaceAllString replaces all matches in input using this compiled template.
func (t *ReDamageSpellAbsorbSelfReplaceTemplate) ReplaceAllString(input string) string {
	var result strings.Builder
	lastEnd := 0
	var r ReDamageSpellAbsorbSelfResult
...
func (t *ReDamageSpellAbsorbSelfReplaceTemplate) ReplaceAllBytes(input []byte) []byte {
	return t.ReplaceAllBytesAppend(input, nil)
}

// ReplaceAllBytesAppend replaces all matches and appends to buf.
// If buf has sufficient capacity, no allocation occurs.
func (t *ReDamageSpellAbsorbSelfReplaceTemplate) ReplaceAllBytesAppend(input []byte, buf []byte) []byte {
	result := buf[:0]
	lastEnd := 0
	var r ReDamageSpellAbsorbSelfBytesResult
...
func (t *ReDamageSpellAbsorbSelfReplaceTemplate) ReplaceFirstString(input string) string {
	var r ReDamageSpellAbsorbSelfResult
	match, ok := ReDamageSpellAbsorbSelf{}.FindStringReuse(input, &r)
	if !ok {
		return input
...
func (t *ReDamageSpellAbsorbSelfReplaceTemplate) ReplaceFirstBytes(input []byte) []byte {
	var r ReDamageSpellAbsorbSelfBytesResult
	match, ok := ReDamageSpellAbsorbSelf{}.FindBytesReuse(input, &r)
	if !ok {
		return append([]byte{}, input...)
