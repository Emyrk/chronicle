...
// Code generated by regengo for pattern: (.+[^\s]) (channels|casts|begins to cast) (.+[^\s]) on (.+[^\s])\.
// DO NOT EDIT.

var reV2CastsRankTargetStackPool = sync.Pool{New: func() interface{} {
	stack := make([][3]int, 0, 32)
	return &stack
}}

var reV2CastsRankTargetCaptureStackPool = sync.Pool{New: func() interface{} {
	stack := make([]int, 0, 160)
	return &stack
}}

type ReV2CastsRankTarget struct{}

var CompiledReV2CastsRankTarget = ReV2CastsRankTarget{}

// MinMatchLen is the minimum number of bytes any match can have.
const ReV2CastsRankTargetMinMatchLen = 18

// MaxMatchLen is the maximum number of bytes any match can have.
// -1 means unbounded (pattern contains * or + quantifiers).
const ReV2CastsRankTargetMaxMatchLen = -1

func (ReV2CastsRankTarget) MatchLengthInfo() (minLen, maxLen int) {
	return ReV2CastsRankTargetMinMatchLen, ReV2CastsRankTargetMaxMatchLen
}

func (ReV2CastsRankTarget) MatchString(input string) bool {
	l := len(input)
	offset := 0
	stackPtr := reV2CastsRankTargetStackPool.Get().(*[][3]int)
	stack := (*stackPtr)[:0]
	defer func() {
		for i := range stack {
			stack[i] = [3]int{0, 0, 0}
		...
		*stackPtr = stack[:0]
		reV2CastsRankTargetStackPool.Put(stackPtr)
	}()
	nextInstruction := 1
	goto StepSelect
TryFallback:
...
Ins20:
	{
		stack = append(stack, [3]int{offset, 9, 0})
		goto Ins16
	}
Ins21:
	{
...
func (ReV2CastsRankTarget) MatchBytes(input []byte) bool {
	l := len(input)
	offset := 0
	stackPtr := reV2CastsRankTargetStackPool.Get().(*[][3]int)
	stack := (*stackPtr)[:0]
...
type ReV2CastsRankTargetResult struct {
...
type ReV2CastsRankTargetBytesResult struct {
...
func (ReV2CastsRankTarget) FindStringReuse(input string, r *ReV2CastsRankTargetResult) (*ReV2CastsRankTargetResult, bool) {
	l := len(input)
	offset := 0
	var captures [10]int
	stackPtr := reV2CastsRankTargetStackPool.Get().(*[][3]int)
...
func (recv ReV2CastsRankTarget) FindString(input string) (*ReV2CastsRankTargetResult, bool) {
	return recv.FindStringReuse(input, nil)
}
func (ReV2CastsRankTarget) FindAllStringAppend(input string, n int, s []*ReV2CastsRankTargetResult) []*ReV2CastsRankTargetResult {
	if n == 0 {
		return s
	}
	result := s
	...
	Ins53:
		{
			captures[1] = offset
			var item *ReV2CastsRankTargetResult
			if len(result) < cap(result) {
				result = result[:len(result)+1]
				item = result[len(result)-1]
				if item == nil {
					item = &ReV2CastsRankTargetResult{}
...
func (r ReV2CastsRankTarget) FindAllString(input string, n int) []*ReV2CastsRankTargetResult {
	return r.FindAllStringAppend(input, n, nil)
}
func (ReV2CastsRankTarget) FindBytesReuse(input []byte, r *ReV2CastsRankTargetBytesResult) (*ReV2CastsRankTargetBytesResult, bool) {
	l := len(input)
	offset := 0
	var captures [10]int
	stackPtr := reV2CastsRankTargetStackPool.Get().(*[][3]int)
...
Ins53:
	{
		captures[1] = offset
		if r == nil {
			r = &ReV2CastsRankTargetBytesResult{}
		}
...
func (recv ReV2CastsRankTarget) FindBytes(input []byte) (*ReV2CastsRankTargetBytesResult, bool) {
	return recv.FindBytesReuse(input, nil)
}
func (ReV2CastsRankTarget) FindAllBytesAppend(input []byte, n int, s []*ReV2CastsRankTargetBytesResult) []*ReV2CastsRankTargetBytesResult {
	if n == 0 {
		return s
	}
	result := s
	...
	Ins53:
		{
			captures[1] = offset
			var item *ReV2CastsRankTargetBytesResult
			if len(result) < cap(result) {
				result = result[:len(result)+1]
				item = result[len(result)-1]
				if item == nil {
					item = &ReV2CastsRankTargetBytesResult{}
					result[len(result)-1] = item
				}
			} else {
				item = &ReV2CastsRankTargetBytesResult{}
...
func (r ReV2CastsRankTarget) FindAllBytes(input []byte, n int) []*ReV2CastsRankTargetBytesResult {
...
func (ReV2CastsRankTarget) DefaultMaxLeftover() int {
	return 1048576
}
...
func (ReV2CastsRankTarget) FindReader(r io.Reader, cfg stream.Config, onMatch func(stream.Match[*ReV2CastsRankTargetBytesResult]) bool) error {
	...
	reuseResult := &ReV2CastsRankTargetBytesResult{}
			...
			if err == io.EOF {
				...
				if leftover > 0 {
					...
					for searchPos < len(chunk) {
						result, ok := ReV2CastsRankTarget{}.FindBytesReuse(chunk[searchPos:], reuseResult)
						if !ok {
							break
						}
						...
						m := stream.Match[*ReV2CastsRankTargetBytesResult]{
...
func (ReV2CastsRankTarget) FindReaderCount(r io.Reader, cfg stream.Config) (int64, error) {
	var count int64
	err := ReV2CastsRankTarget{}.FindReader(r, cfg, func(_ stream.Match[*ReV2CastsRankTargetBytesResult]) bool {
		count++
		return true
	})
	return count, err
...
func (ReV2CastsRankTarget) FindReaderFirst(r io.Reader, cfg stream.Config) (*ReV2CastsRankTargetBytesResult, int64, error) {
	var result *ReV2CastsRankTargetBytesResult
	var offset int64
	err := ReV2CastsRankTarget{}.FindReader(r, cfg, func(m stream.Match[*ReV2CastsRankTargetBytesResult]) bool {
		// Copy the result since buffer will be reused
		result = ReV2CastsRankTarget{}.copyBytesResult(m.Result)
...
func (ReV2CastsRankTarget) copyBytesResult(src *ReV2CastsRankTargetBytesResult) *ReV2CastsRankTargetBytesResult {
	if src == nil {
		return nil
	}
	dst := &ReV2CastsRankTargetBytesResult{}
	// Copy Match slice
...
//	    })
//	io.Copy(os.Stdout, r)
func (ReV2CastsRankTarget) NewTransformReader(r io.Reader, cfg stream.TransformConfig, onMatch func(match *ReV2CastsRankTargetBytesResult, emit func([]byte))) io.Reader {
	if cfg.BufferSize == 0 {
	...
	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReV2CastsRankTarget{}.processTransform(data, isEOF, onMatch, emitOut)
	}
...
func (ReV2CastsRankTarget) processTransform(data []byte, isEOF bool, onMatch func(match *ReV2CastsRankTargetBytesResult, emit func([]byte)), emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReV2CastsRankTargetBytesResult{}

	for {
		result, ok := ReV2CastsRankTarget{}.FindBytesReuse(data[processed:], reuseResult)
		if !ok {
			// No more matches
			if isEOF {
...
//	io.Copy(os.Stdout, r)
func (ReV2CastsRankTarget) ReplaceReader(r io.Reader, template string) io.Reader {
	parsed, err := replace.Parse(template)
	if err != nil {
		return &reV2CastsRankTargetTransformErrReader{err: err}
	}
	...
	return ReV2CastsRankTarget{}.NewTransformReader(r, stream.DefaultTransformConfig(), func(m *ReV2CastsRankTargetBytesResult, emit func([]byte)) {
		...
		for _, seg := range resolved {
			...
			case replace.SegmentCaptureIndex:
				capture := (ReV2CastsRankTarget{}).getCaptureByIndex(m, seg.CaptureIndex)
				if capture != nil {
...
// reV2CastsRankTargetTransformErrReader is a reader that always returns an error.
type reV2CastsRankTargetTransformErrReader struct {
	err error
}

func (r *reV2CastsRankTargetTransformErrReader) Read(p []byte) (int, error) {
	return 0, r.err
}

// getCaptureByIndex returns the capture group value by its index.
func (ReV2CastsRankTarget) getCaptureByIndex(m *ReV2CastsRankTargetBytesResult, index int) []byte {
	switch index {
	case 0:
		return m.Match
	default:
...
//	})
func (ReV2CastsRankTarget) SelectReader(r io.Reader, pred func(*ReV2CastsRankTargetBytesResult) bool) io.Reader {
	cfg := stream.DefaultTransformConfig()
	cfg.MaxLeftover = 1048576

	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReV2CastsRankTarget{}.processSelect(data, isEOF, pred, emitOut)
	}
...
func (ReV2CastsRankTarget) processSelect(data []byte, isEOF bool, pred func(*ReV2CastsRankTargetBytesResult) bool, emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReV2CastsRankTargetBytesResult{}
...
//	})
func (ReV2CastsRankTarget) RejectReader(r io.Reader, pred func(*ReV2CastsRankTargetBytesResult) bool) io.Reader {
	cfg := stream.DefaultTransformConfig()
	cfg.MaxLeftover = 1048576

	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReV2CastsRankTarget{}.processReject(data, isEOF, pred, emitOut)
	}
...
func (ReV2CastsRankTarget) processReject(data []byte, isEOF bool, pred func(*ReV2CastsRankTargetBytesResult) bool, emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReV2CastsRankTargetBytesResult{}
...
func (r *ReV2CastsRankTargetResult) CaptureByIndex(idx int) string {
	switch idx {
	case 0:
		return r.Match
	case 1:
...
// CaptureByIndex returns the capture group value by its 0-based index.
// Index 0 returns the full match, 1+ returns capture groups.
func (r *ReV2CastsRankTargetBytesResult) CaptureByIndex(idx int) []byte {
	switch idx {
	case 0:
		return r.Match
	case 1:
...
func (ReV2CastsRankTarget) ReplaceAllString(input string, template string) string {
	...
	lastEnd := 0
	var r ReV2CastsRankTargetResult

	remaining := input
	offset := 0

	for {
		match, ok := ReV2CastsRankTarget{}.FindStringReuse(remaining, &r)
		if !ok {
			break
		}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReV2CastsRankTarget) ReplaceAllBytes(input []byte, template string) []byte {
	return ReV2CastsRankTarget{}.ReplaceAllBytesAppend(input, template, nil)
}

// ReplaceAllBytesAppend replaces all matches and appends to buf.
// If buf has sufficient capacity, no allocation occurs.
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReV2CastsRankTarget) ReplaceAllBytesAppend(input []byte, template string, buf []byte) []byte {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	result := buf[:0]
	lastEnd := 0
	var r ReV2CastsRankTargetBytesResult

	remaining := input
	offset := 0

	for {
		match, ok := ReV2CastsRankTarget{}.FindBytesReuse(remaining, &r)
		if !ok {
			break
		}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReV2CastsRankTarget) ReplaceFirstString(input string, template string) string {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	var r ReV2CastsRankTargetResult
	match, ok := ReV2CastsRankTarget{}.FindStringReuse(input, &r)
	if !ok {
		return input
	}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReV2CastsRankTarget) ReplaceFirstBytes(input []byte, template string) []byte {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	var r ReV2CastsRankTargetBytesResult
	match, ok := ReV2CastsRankTarget{}.FindBytesReuse(input, &r)
	if !ok {
...
// ReV2CastsRankTargetReplaceTemplate holds a pre-compiled replace template for the ReV2CastsRankTarget pattern.
// Use CompileReplaceTemplate to create one, then call its Replace methods.
type ReV2CastsRankTargetReplaceTemplate struct {
	original string
...
//
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReV2CastsRankTarget) CompileReplaceTemplate(template string) (*ReV2CastsRankTargetReplaceTemplate, error) {
	tmpl, err := replace.Parse(template)
	if err != nil {
		return nil, err
	}
	...
	return &ReV2CastsRankTargetReplaceTemplate{
		original: template,
		segments: resolved,
	}, nil
}
...
func (t *ReV2CastsRankTargetReplaceTemplate) String() string {
	return t.original
}

// ReplaceAllString replaces all matches in input using this compiled template.
func (t *ReV2CastsRankTargetReplaceTemplate) ReplaceAllString(input string) string {
	var result strings.Builder
	lastEnd := 0
	var r ReV2CastsRankTargetResult
...
func (t *ReV2CastsRankTargetReplaceTemplate) ReplaceAllBytes(input []byte) []byte {
	return t.ReplaceAllBytesAppend(input, nil)
}

// ReplaceAllBytesAppend replaces all matches and appends to buf.
// If buf has sufficient capacity, no allocation occurs.
func (t *ReV2CastsRankTargetReplaceTemplate) ReplaceAllBytesAppend(input []byte, buf []byte) []byte {
	result := buf[:0]
	lastEnd := 0
	var r ReV2CastsRankTargetBytesResult
...
func (t *ReV2CastsRankTargetReplaceTemplate) ReplaceFirstString(input string) string {
	var r ReV2CastsRankTargetResult
	match, ok := ReV2CastsRankTarget{}.FindStringReuse(input, &r)
	if !ok {
		return input
...
func (t *ReV2CastsRankTargetReplaceTemplate) ReplaceFirstBytes(input []byte) []byte {
	var r ReV2CastsRankTargetBytesResult
	match, ok := ReV2CastsRankTarget{}.FindBytesReuse(input, &r)
	if !ok {
		return append([]byte{}, input...)
