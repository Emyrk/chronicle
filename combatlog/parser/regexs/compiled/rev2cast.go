...
// Code generated by regengo for pattern: (.+[^\s]) (channels|fails casting|casts|begins to cast) (.+[^\s])\.
// DO NOT EDIT.

var reV2CastStackPool = sync.Pool{New: func() interface{} {
	stack := make([][3]int, 0, 32)
	return &stack
}}

var reV2CastCaptureStackPool = sync.Pool{New: func() interface{} {
	stack := make([]int, 0, 128)
	return &stack
}}

type ReV2Cast struct{}

var CompiledReV2Cast = ReV2Cast{}

// MinMatchLen is the minimum number of bytes any match can have.
const ReV2CastMinMatchLen = 12

// MaxMatchLen is the maximum number of bytes any match can have.
// -1 means unbounded (pattern contains * or + quantifiers).
const ReV2CastMaxMatchLen = -1

func (ReV2Cast) MatchLengthInfo() (minLen, maxLen int) {
	return ReV2CastMinMatchLen, ReV2CastMaxMatchLen
}

func (ReV2Cast) MatchString(input string) bool {
	l := len(input)
	offset := 0
	stackPtr := reV2CastStackPool.Get().(*[][3]int)
	stack := (*stackPtr)[:0]
	defer func() {
		for i := range stack {
			stack[i] = [3]int{0, 0, 0}
		...
		*stackPtr = stack[:0]
		reV2CastStackPool.Put(stackPtr)
	}()
	nextInstruction := 1
	goto StepSelect
TryFallback:
...
func (ReV2Cast) MatchBytes(input []byte) bool {
	l := len(input)
	offset := 0
	stackPtr := reV2CastStackPool.Get().(*[][3]int)
	stack := (*stackPtr)[:0]
...
type ReV2CastBytesResult struct {
...
func (ReV2Cast) FindStringReuse(input string, r *ReV2CastResult) (*ReV2CastResult, bool) {
	l := len(input)
	offset := 0
	var captures [8]int
	stackPtr := reV2CastStackPool.Get().(*[][3]int)
...
func (recv ReV2Cast) FindString(input string) (*ReV2CastResult, bool) {
	return recv.FindStringReuse(input, nil)
}
func (ReV2Cast) FindAllStringAppend(input string, n int, s []*ReV2CastResult) []*ReV2CastResult {
	if n == 0 {
		return s
	}
	result := s
...
func (r ReV2Cast) FindAllString(input string, n int) []*ReV2CastResult {
	return r.FindAllStringAppend(input, n, nil)
}
func (ReV2Cast) FindBytesReuse(input []byte, r *ReV2CastBytesResult) (*ReV2CastBytesResult, bool) {
	l := len(input)
	offset := 0
	var captures [8]int
	stackPtr := reV2CastStackPool.Get().(*[][3]int)
...
func (recv ReV2Cast) FindBytes(input []byte) (*ReV2CastBytesResult, bool) {
	return recv.FindBytesReuse(input, nil)
}
func (ReV2Cast) FindAllBytesAppend(input []byte, n int, s []*ReV2CastBytesResult) []*ReV2CastBytesResult {
	if n == 0 {
		return s
	}
	result := s
	...
	Ins59:
		{
			captures[1] = offset
			var item *ReV2CastBytesResult
			if len(result) < cap(result) {
				result = result[:len(result)+1]
				item = result[len(result)-1]
				if item == nil {
					item = &ReV2CastBytesResult{}
					result[len(result)-1] = item
				}
			} else {
				item = &ReV2CastBytesResult{}
...
func (r ReV2Cast) FindAllBytes(input []byte, n int) []*ReV2CastBytesResult {
...
func (ReV2Cast) DefaultMaxLeftover() int {
	return 1048576
}
...
func (ReV2Cast) FindReader(r io.Reader, cfg stream.Config, onMatch func(stream.Match[*ReV2CastBytesResult]) bool) error {
	...
	reuseResult := &ReV2CastBytesResult{}
			...
			if err == io.EOF {
				...
				if leftover > 0 {
					...
					for searchPos < len(chunk) {
						result, ok := ReV2Cast{}.FindBytesReuse(chunk[searchPos:], reuseResult)
						if !ok {
							break
						}
						...
						m := stream.Match[*ReV2CastBytesResult]{
...
func (ReV2Cast) FindReaderCount(r io.Reader, cfg stream.Config) (int64, error) {
	var count int64
	err := ReV2Cast{}.FindReader(r, cfg, func(_ stream.Match[*ReV2CastBytesResult]) bool {
		count++
		return true
	})
	return count, err
...
func (ReV2Cast) FindReaderFirst(r io.Reader, cfg stream.Config) (*ReV2CastBytesResult, int64, error) {
	var result *ReV2CastBytesResult
	var offset int64
	err := ReV2Cast{}.FindReader(r, cfg, func(m stream.Match[*ReV2CastBytesResult]) bool {
		// Copy the result since buffer will be reused
		result = ReV2Cast{}.copyBytesResult(m.Result)
...
func (ReV2Cast) copyBytesResult(src *ReV2CastBytesResult) *ReV2CastBytesResult {
	if src == nil {
		return nil
	}
	dst := &ReV2CastBytesResult{}
	// Copy Match slice
...
//	    })
//	io.Copy(os.Stdout, r)
func (ReV2Cast) NewTransformReader(r io.Reader, cfg stream.TransformConfig, onMatch func(match *ReV2CastBytesResult, emit func([]byte))) io.Reader {
	if cfg.BufferSize == 0 {
	...
	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReV2Cast{}.processTransform(data, isEOF, onMatch, emitOut)
	}
...
func (ReV2Cast) processTransform(data []byte, isEOF bool, onMatch func(match *ReV2CastBytesResult, emit func([]byte)), emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReV2CastBytesResult{}

	for {
		result, ok := ReV2Cast{}.FindBytesReuse(data[processed:], reuseResult)
		if !ok {
			// No more matches
			if isEOF {
...
//	io.Copy(os.Stdout, r)
func (ReV2Cast) ReplaceReader(r io.Reader, template string) io.Reader {
	parsed, err := replace.Parse(template)
	if err != nil {
		return &reV2CastTransformErrReader{err: err}
	}
	...
	return ReV2Cast{}.NewTransformReader(r, stream.DefaultTransformConfig(), func(m *ReV2CastBytesResult, emit func([]byte)) {
		...
		for _, seg := range resolved {
			...
			case replace.SegmentCaptureIndex:
				capture := (ReV2Cast{}).getCaptureByIndex(m, seg.CaptureIndex)
				if capture != nil {
...
// reV2CastTransformErrReader is a reader that always returns an error.
type reV2CastTransformErrReader struct {
	err error
}

func (r *reV2CastTransformErrReader) Read(p []byte) (int, error) {
	return 0, r.err
}

// getCaptureByIndex returns the capture group value by its index.
func (ReV2Cast) getCaptureByIndex(m *ReV2CastBytesResult, index int) []byte {
	switch index {
	case 0:
		return m.Match
	default:
...
//	})
func (ReV2Cast) SelectReader(r io.Reader, pred func(*ReV2CastBytesResult) bool) io.Reader {
	cfg := stream.DefaultTransformConfig()
	cfg.MaxLeftover = 1048576

	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReV2Cast{}.processSelect(data, isEOF, pred, emitOut)
	}
...
func (ReV2Cast) processSelect(data []byte, isEOF bool, pred func(*ReV2CastBytesResult) bool, emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReV2CastBytesResult{}
...
//	})
func (ReV2Cast) RejectReader(r io.Reader, pred func(*ReV2CastBytesResult) bool) io.Reader {
	cfg := stream.DefaultTransformConfig()
	cfg.MaxLeftover = 1048576

	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReV2Cast{}.processReject(data, isEOF, pred, emitOut)
	}
...
func (ReV2Cast) processReject(data []byte, isEOF bool, pred func(*ReV2CastBytesResult) bool, emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReV2CastBytesResult{}
...
func (r *ReV2CastResult) CaptureByIndex(idx int) string {
	switch idx {
	case 0:
		return r.Match
	case 1:
...
// CaptureByIndex returns the capture group value by its 0-based index.
// Index 0 returns the full match, 1+ returns capture groups.
func (r *ReV2CastBytesResult) CaptureByIndex(idx int) []byte {
	switch idx {
	case 0:
		return r.Match
	case 1:
...
func (ReV2Cast) ReplaceAllString(input string, template string) string {
	...
	lastEnd := 0
	var r ReV2CastResult

	remaining := input
	offset := 0

	for {
		match, ok := ReV2Cast{}.FindStringReuse(remaining, &r)
		if !ok {
			break
		}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReV2Cast) ReplaceAllBytes(input []byte, template string) []byte {
	return ReV2Cast{}.ReplaceAllBytesAppend(input, template, nil)
}

// ReplaceAllBytesAppend replaces all matches and appends to buf.
// If buf has sufficient capacity, no allocation occurs.
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReV2Cast) ReplaceAllBytesAppend(input []byte, template string, buf []byte) []byte {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	result := buf[:0]
	lastEnd := 0
	var r ReV2CastBytesResult

	remaining := input
	offset := 0

	for {
		match, ok := ReV2Cast{}.FindBytesReuse(remaining, &r)
		if !ok {
			break
		}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReV2Cast) ReplaceFirstString(input string, template string) string {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	var r ReV2CastResult
	match, ok := ReV2Cast{}.FindStringReuse(input, &r)
	if !ok {
		return input
	}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReV2Cast) ReplaceFirstBytes(input []byte, template string) []byte {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	var r ReV2CastBytesResult
	match, ok := ReV2Cast{}.FindBytesReuse(input, &r)
	if !ok {
...
// ReV2CastReplaceTemplate holds a pre-compiled replace template for the ReV2Cast pattern.
// Use CompileReplaceTemplate to create one, then call its Replace methods.
type ReV2CastReplaceTemplate struct {
	original string
...
//
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReV2Cast) CompileReplaceTemplate(template string) (*ReV2CastReplaceTemplate, error) {
	tmpl, err := replace.Parse(template)
	if err != nil {
		return nil, err
	}
	...
	return &ReV2CastReplaceTemplate{
		original: template,
		segments: resolved,
	}, nil
}
...
func (t *ReV2CastReplaceTemplate) String() string {
	return t.original
}

// ReplaceAllString replaces all matches in input using this compiled template.
func (t *ReV2CastReplaceTemplate) ReplaceAllString(input string) string {
	var result strings.Builder
	lastEnd := 0
	var r ReV2CastResult
...
func (t *ReV2CastReplaceTemplate) ReplaceAllBytes(input []byte) []byte {
	return t.ReplaceAllBytesAppend(input, nil)
}

// ReplaceAllBytesAppend replaces all matches and appends to buf.
// If buf has sufficient capacity, no allocation occurs.
func (t *ReV2CastReplaceTemplate) ReplaceAllBytesAppend(input []byte, buf []byte) []byte {
	result := buf[:0]
	lastEnd := 0
	var r ReV2CastBytesResult
...
func (t *ReV2CastReplaceTemplate) ReplaceFirstString(input string) string {
	var r ReV2CastResult
	match, ok := ReV2Cast{}.FindStringReuse(input, &r)
	if !ok {
		return input
...
func (t *ReV2CastReplaceTemplate) ReplaceFirstBytes(input []byte) []byte {
	var r ReV2CastBytesResult
	match, ok := ReV2Cast{}.FindBytesReuse(input, &r)
	if !ok {
		return append([]byte{}, input...)
