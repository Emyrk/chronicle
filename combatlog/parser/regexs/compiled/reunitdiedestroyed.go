...
// Code generated by regengo for pattern: (.+[^\s]) (dies|is destroyed)\.
// DO NOT EDIT.

var reUnitDieDestroyedStackPool = sync.Pool{New: func() interface{} {
	stack := make([][3]int, 0, 32)
	return &stack
}}

var reUnitDieDestroyedCaptureStackPool = sync.Pool{New: func() interface{} {
	stack := make([]int, 0, 96)
	return &stack
}}

type ReUnitDieDestroyed struct{}

var CompiledReUnitDieDestroyed = ReUnitDieDestroyed{}

// MinMatchLen is the minimum number of bytes any match can have.
const ReUnitDieDestroyedMinMatchLen = 8

// MaxMatchLen is the maximum number of bytes any match can have.
// -1 means unbounded (pattern contains * or + quantifiers).
const ReUnitDieDestroyedMaxMatchLen = -1

func (ReUnitDieDestroyed) MatchLengthInfo() (minLen, maxLen int) {
	return ReUnitDieDestroyedMinMatchLen, ReUnitDieDestroyedMaxMatchLen
}

func (ReUnitDieDestroyed) MatchString(input string) bool {
	l := len(input)
	offset := 0
	stackPtr := reUnitDieDestroyedStackPool.Get().(*[][3]int)
	stack := (*stackPtr)[:0]
	defer func() {
		for i := range stack {
			stack[i] = [3]int{0, 0, 0}
		...
		*stackPtr = stack[:0]
		reUnitDieDestroyedStackPool.Put(stackPtr)
	}()
	nextInstruction := 1
	goto StepSelect
TryFallback:
...
func (ReUnitDieDestroyed) MatchBytes(input []byte) bool {
	l := len(input)
	offset := 0
	stackPtr := reUnitDieDestroyedStackPool.Get().(*[][3]int)
	stack := (*stackPtr)[:0]
...
type ReUnitDieDestroyedResult struct {
	Match  string // Full match
	Group1 string
	Group2 string
}

type ReUnitDieDestroyedBytesResult struct {
	Match  []byte // Full match
	Group1 []byte
	Group2 []byte
}

func (ReUnitDieDestroyed) FindStringReuse(input string, r *ReUnitDieDestroyedResult) (*ReUnitDieDestroyedResult, bool) {
	l := len(input)
	offset := 0
	var captures [6]int
	captureStackPtr := reUnitDieDestroyedCaptureStackPool.Get().(*[]int)
	captureStack := (*captureStackPtr)[:0]
	defer func() {
		*captureStackPtr = captureStack[:0]
		reUnitDieDestroyedCaptureStackPool.Put(captureStackPtr)
	}()
	stackPtr := reUnitDieDestroyedStackPool.Get().(*[][3]int)
	stack := (*stackPtr)[:0]
	defer func() {
...
func (recv ReUnitDieDestroyed) FindString(input string) (*ReUnitDieDestroyedResult, bool) {
	return recv.FindStringReuse(input, nil)
}
func (ReUnitDieDestroyed) FindAllStringAppend(input string, n int, s []*ReUnitDieDestroyedResult) []*ReUnitDieDestroyedResult {
	if n == 0 {
		return s
	}
	result := s
	...
	Ins27:
		{
			captures[1] = offset
			var item *ReUnitDieDestroyedResult
			if len(result) < cap(result) {
				result = result[:len(result)+1]
				item = result[len(result)-1]
				if item == nil {
					item = &ReUnitDieDestroyedResult{}
...
func (r ReUnitDieDestroyed) FindAllString(input string, n int) []*ReUnitDieDestroyedResult {
	return r.FindAllStringAppend(input, n, nil)
}
func (ReUnitDieDestroyed) FindBytesReuse(input []byte, r *ReUnitDieDestroyedBytesResult) (*ReUnitDieDestroyedBytesResult, bool) {
	l := len(input)
	offset := 0
	var captures [6]int
	captureStackPtr := reUnitDieDestroyedCaptureStackPool.Get().(*[]int)
...
Ins27:
	{
		captures[1] = offset
		if r == nil {
			r = &ReUnitDieDestroyedBytesResult{}
		}
...
func (recv ReUnitDieDestroyed) FindBytes(input []byte) (*ReUnitDieDestroyedBytesResult, bool) {
	return recv.FindBytesReuse(input, nil)
}
func (ReUnitDieDestroyed) FindAllBytesAppend(input []byte, n int, s []*ReUnitDieDestroyedBytesResult) []*ReUnitDieDestroyedBytesResult {
	if n == 0 {
		return s
	}
	result := s
	...
	Ins27:
		{
			captures[1] = offset
			var item *ReUnitDieDestroyedBytesResult
			if len(result) < cap(result) {
				result = result[:len(result)+1]
				item = result[len(result)-1]
				if item == nil {
					item = &ReUnitDieDestroyedBytesResult{}
					result[len(result)-1] = item
				}
			} else {
				item = &ReUnitDieDestroyedBytesResult{}
...
func (r ReUnitDieDestroyed) FindAllBytes(input []byte, n int) []*ReUnitDieDestroyedBytesResult {
...
func (ReUnitDieDestroyed) DefaultMaxLeftover() int {
	return 1048576
}
...
func (ReUnitDieDestroyed) FindReader(r io.Reader, cfg stream.Config, onMatch func(stream.Match[*ReUnitDieDestroyedBytesResult]) bool) error {
	...
	reuseResult := &ReUnitDieDestroyedBytesResult{}
			...
			if err == io.EOF {
				...
				if leftover > 0 {
					...
					for searchPos < len(chunk) {
						result, ok := ReUnitDieDestroyed{}.FindBytesReuse(chunk[searchPos:], reuseResult)
						if !ok {
							break
						}
						...
						m := stream.Match[*ReUnitDieDestroyedBytesResult]{
...
func (ReUnitDieDestroyed) FindReaderCount(r io.Reader, cfg stream.Config) (int64, error) {
	var count int64
	err := ReUnitDieDestroyed{}.FindReader(r, cfg, func(_ stream.Match[*ReUnitDieDestroyedBytesResult]) bool {
		count++
		return true
	})
	return count, err
...
func (ReUnitDieDestroyed) FindReaderFirst(r io.Reader, cfg stream.Config) (*ReUnitDieDestroyedBytesResult, int64, error) {
	var result *ReUnitDieDestroyedBytesResult
	var offset int64
	err := ReUnitDieDestroyed{}.FindReader(r, cfg, func(m stream.Match[*ReUnitDieDestroyedBytesResult]) bool {
		// Copy the result since buffer will be reused
		result = ReUnitDieDestroyed{}.copyBytesResult(m.Result)
...
func (ReUnitDieDestroyed) copyBytesResult(src *ReUnitDieDestroyedBytesResult) *ReUnitDieDestroyedBytesResult {
	if src == nil {
		return nil
	}
	dst := &ReUnitDieDestroyedBytesResult{}
	// Copy Match slice
...
//	    })
//	io.Copy(os.Stdout, r)
func (ReUnitDieDestroyed) NewTransformReader(r io.Reader, cfg stream.TransformConfig, onMatch func(match *ReUnitDieDestroyedBytesResult, emit func([]byte))) io.Reader {
	if cfg.BufferSize == 0 {
	...
	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReUnitDieDestroyed{}.processTransform(data, isEOF, onMatch, emitOut)
	}
...
func (ReUnitDieDestroyed) processTransform(data []byte, isEOF bool, onMatch func(match *ReUnitDieDestroyedBytesResult, emit func([]byte)), emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReUnitDieDestroyedBytesResult{}

	for {
		result, ok := ReUnitDieDestroyed{}.FindBytesReuse(data[processed:], reuseResult)
		if !ok {
			// No more matches
			if isEOF {
...
//	io.Copy(os.Stdout, r)
func (ReUnitDieDestroyed) ReplaceReader(r io.Reader, template string) io.Reader {
	parsed, err := replace.Parse(template)
	if err != nil {
		return &reUnitDieDestroyedTransformErrReader{err: err}
	}
	...
	return ReUnitDieDestroyed{}.NewTransformReader(r, stream.DefaultTransformConfig(), func(m *ReUnitDieDestroyedBytesResult, emit func([]byte)) {
		...
		for _, seg := range resolved {
			...
			case replace.SegmentCaptureIndex:
				capture := (ReUnitDieDestroyed{}).getCaptureByIndex(m, seg.CaptureIndex)
				if capture != nil {
...
// reUnitDieDestroyedTransformErrReader is a reader that always returns an error.
type reUnitDieDestroyedTransformErrReader struct {
	err error
}

func (r *reUnitDieDestroyedTransformErrReader) Read(p []byte) (int, error) {
	return 0, r.err
}

// getCaptureByIndex returns the capture group value by its index.
func (ReUnitDieDestroyed) getCaptureByIndex(m *ReUnitDieDestroyedBytesResult, index int) []byte {
	switch index {
	case 0:
		return m.Match
	default:
...
//	})
func (ReUnitDieDestroyed) SelectReader(r io.Reader, pred func(*ReUnitDieDestroyedBytesResult) bool) io.Reader {
	cfg := stream.DefaultTransformConfig()
	cfg.MaxLeftover = 1048576

	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReUnitDieDestroyed{}.processSelect(data, isEOF, pred, emitOut)
	}
...
func (ReUnitDieDestroyed) processSelect(data []byte, isEOF bool, pred func(*ReUnitDieDestroyedBytesResult) bool, emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReUnitDieDestroyedBytesResult{}
...
//	})
func (ReUnitDieDestroyed) RejectReader(r io.Reader, pred func(*ReUnitDieDestroyedBytesResult) bool) io.Reader {
	cfg := stream.DefaultTransformConfig()
	cfg.MaxLeftover = 1048576

	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReUnitDieDestroyed{}.processReject(data, isEOF, pred, emitOut)
	}
...
func (ReUnitDieDestroyed) processReject(data []byte, isEOF bool, pred func(*ReUnitDieDestroyedBytesResult) bool, emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReUnitDieDestroyedBytesResult{}
...
func (r *ReUnitDieDestroyedResult) CaptureByIndex(idx int) string {
	switch idx {
	case 0:
		return r.Match
	case 1:
...
// CaptureByIndex returns the capture group value by its 0-based index.
// Index 0 returns the full match, 1+ returns capture groups.
func (r *ReUnitDieDestroyedBytesResult) CaptureByIndex(idx int) []byte {
	switch idx {
	case 0:
		return r.Match
	case 1:
...
func (ReUnitDieDestroyed) ReplaceAllString(input string, template string) string {
	...
	lastEnd := 0
	var r ReUnitDieDestroyedResult

	remaining := input
	offset := 0

	for {
		match, ok := ReUnitDieDestroyed{}.FindStringReuse(remaining, &r)
		if !ok {
			break
		}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReUnitDieDestroyed) ReplaceAllBytes(input []byte, template string) []byte {
	return ReUnitDieDestroyed{}.ReplaceAllBytesAppend(input, template, nil)
}

// ReplaceAllBytesAppend replaces all matches and appends to buf.
// If buf has sufficient capacity, no allocation occurs.
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReUnitDieDestroyed) ReplaceAllBytesAppend(input []byte, template string, buf []byte) []byte {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	result := buf[:0]
	lastEnd := 0
	var r ReUnitDieDestroyedBytesResult

	remaining := input
	offset := 0

	for {
		match, ok := ReUnitDieDestroyed{}.FindBytesReuse(remaining, &r)
		if !ok {
			break
		}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReUnitDieDestroyed) ReplaceFirstString(input string, template string) string {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	var r ReUnitDieDestroyedResult
	match, ok := ReUnitDieDestroyed{}.FindStringReuse(input, &r)
	if !ok {
		return input
	}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReUnitDieDestroyed) ReplaceFirstBytes(input []byte, template string) []byte {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	var r ReUnitDieDestroyedBytesResult
	match, ok := ReUnitDieDestroyed{}.FindBytesReuse(input, &r)
	if !ok {
...
// ReUnitDieDestroyedReplaceTemplate holds a pre-compiled replace template for the ReUnitDieDestroyed pattern.
// Use CompileReplaceTemplate to create one, then call its Replace methods.
type ReUnitDieDestroyedReplaceTemplate struct {
	original string
...
//
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReUnitDieDestroyed) CompileReplaceTemplate(template string) (*ReUnitDieDestroyedReplaceTemplate, error) {
	tmpl, err := replace.Parse(template)
	if err != nil {
		return nil, err
	}
	...
	return &ReUnitDieDestroyedReplaceTemplate{
		original: template,
		segments: resolved,
	}, nil
}
...
func (t *ReUnitDieDestroyedReplaceTemplate) String() string {
	return t.original
}

// ReplaceAllString replaces all matches in input using this compiled template.
func (t *ReUnitDieDestroyedReplaceTemplate) ReplaceAllString(input string) string {
	var result strings.Builder
	lastEnd := 0
	var r ReUnitDieDestroyedResult
...
func (t *ReUnitDieDestroyedReplaceTemplate) ReplaceAllBytes(input []byte) []byte {
	return t.ReplaceAllBytesAppend(input, nil)
}

// ReplaceAllBytesAppend replaces all matches and appends to buf.
// If buf has sufficient capacity, no allocation occurs.
func (t *ReUnitDieDestroyedReplaceTemplate) ReplaceAllBytesAppend(input []byte, buf []byte) []byte {
	result := buf[:0]
	lastEnd := 0
	var r ReUnitDieDestroyedBytesResult
...
func (t *ReUnitDieDestroyedReplaceTemplate) ReplaceFirstString(input string) string {
	var r ReUnitDieDestroyedResult
	match, ok := ReUnitDieDestroyed{}.FindStringReuse(input, &r)
	if !ok {
		return input
...
func (t *ReUnitDieDestroyedReplaceTemplate) ReplaceFirstBytes(input []byte) []byte {
	var r ReUnitDieDestroyedBytesResult
	match, ok := ReUnitDieDestroyed{}.FindBytesReuse(input, &r)
	if !ok {
		return append([]byte{}, input...)
