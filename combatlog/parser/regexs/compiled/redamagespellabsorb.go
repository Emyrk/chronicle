...
// Code generated by regengo for pattern: (.+[^\s])'s (.+[^\s]) is absorbed by (.+[^\s])\.
// DO NOT EDIT.

var reDamageSpellAbsorbStackPool = sync.Pool{New: func() interface{} {
	stack := make([][3]int, 0, 32)
	return &stack
}}

var reDamageSpellAbsorbCaptureStackPool = sync.Pool{New: func() interface{} {
	stack := make([]int, 0, 128)
	return &stack
}}

type ReDamageSpellAbsorb struct{}

var CompiledReDamageSpellAbsorb = ReDamageSpellAbsorb{}

// MinMatchLen is the minimum number of bytes any match can have.
const ReDamageSpellAbsorbMinMatchLen = 26

// MaxMatchLen is the maximum number of bytes any match can have.
// -1 means unbounded (pattern contains * or + quantifiers).
const ReDamageSpellAbsorbMaxMatchLen = -1

func (ReDamageSpellAbsorb) MatchLengthInfo() (minLen, maxLen int) {
	return ReDamageSpellAbsorbMinMatchLen, ReDamageSpellAbsorbMaxMatchLen
}

func (ReDamageSpellAbsorb) MatchString(input string) bool {
	l := len(input)
	offset := 0
	stackPtr := reDamageSpellAbsorbStackPool.Get().(*[][3]int)
	stack := (*stackPtr)[:0]
	defer func() {
		for i := range stack {
			stack[i] = [3]int{0, 0, 0}
		...
		*stackPtr = stack[:0]
		reDamageSpellAbsorbStackPool.Put(stackPtr)
	}()
	nextInstruction := 1
	goto StepSelect
TryFallback:
...
func (ReDamageSpellAbsorb) MatchBytes(input []byte) bool {
	l := len(input)
	offset := 0
	stackPtr := reDamageSpellAbsorbStackPool.Get().(*[][3]int)
	stack := (*stackPtr)[:0]
...
type ReDamageSpellAbsorbResult struct {
...
type ReDamageSpellAbsorbBytesResult struct {
...
func (ReDamageSpellAbsorb) FindStringReuse(input string, r *ReDamageSpellAbsorbResult) (*ReDamageSpellAbsorbResult, bool) {
	l := len(input)
	offset := 0
	var captures [8]int
	captureStackPtr := reDamageSpellAbsorbCaptureStackPool.Get().(*[]int)
	captureStack := (*captureStackPtr)[:0]
	defer func() {
		*captureStackPtr = captureStack[:0]
		reDamageSpellAbsorbCaptureStackPool.Put(captureStackPtr)
	}()
	stackPtr := reDamageSpellAbsorbStackPool.Get().(*[][3]int)
	stack := (*stackPtr)[:0]
	defer func() {
...
Ins32:
	{
		captureStack = append(captureStack, captures[:]...)
		stack = append(stack, [3]int{offset, 33, 1})
		goto Ins31
	}
Ins33:
	{
...
func (recv ReDamageSpellAbsorb) FindString(input string) (*ReDamageSpellAbsorbResult, bool) {
	return recv.FindStringReuse(input, nil)
}
func (ReDamageSpellAbsorb) FindAllStringAppend(input string, n int, s []*ReDamageSpellAbsorbResult) []*ReDamageSpellAbsorbResult {
	if n == 0 {
		return s
	}
	result := s
	...
	Ins36:
		{
			captures[1] = offset
			var item *ReDamageSpellAbsorbResult
			if len(result) < cap(result) {
				result = result[:len(result)+1]
				item = result[len(result)-1]
				if item == nil {
					item = &ReDamageSpellAbsorbResult{}
...
func (r ReDamageSpellAbsorb) FindAllString(input string, n int) []*ReDamageSpellAbsorbResult {
	return r.FindAllStringAppend(input, n, nil)
}
func (ReDamageSpellAbsorb) FindBytesReuse(input []byte, r *ReDamageSpellAbsorbBytesResult) (*ReDamageSpellAbsorbBytesResult, bool) {
	l := len(input)
	offset := 0
	var captures [8]int
	captureStackPtr := reDamageSpellAbsorbCaptureStackPool.Get().(*[]int)
...
Ins36:
	{
		captures[1] = offset
		if r == nil {
			r = &ReDamageSpellAbsorbBytesResult{}
		}
...
func (recv ReDamageSpellAbsorb) FindBytes(input []byte) (*ReDamageSpellAbsorbBytesResult, bool) {
	return recv.FindBytesReuse(input, nil)
}
func (ReDamageSpellAbsorb) FindAllBytesAppend(input []byte, n int, s []*ReDamageSpellAbsorbBytesResult) []*ReDamageSpellAbsorbBytesResult {
	if n == 0 {
		return s
	}
	result := s
	...
	Ins36:
		{
			captures[1] = offset
			var item *ReDamageSpellAbsorbBytesResult
			if len(result) < cap(result) {
				result = result[:len(result)+1]
				item = result[len(result)-1]
				if item == nil {
					item = &ReDamageSpellAbsorbBytesResult{}
					result[len(result)-1] = item
				}
			} else {
				item = &ReDamageSpellAbsorbBytesResult{}
...
func (r ReDamageSpellAbsorb) FindAllBytes(input []byte, n int) []*ReDamageSpellAbsorbBytesResult {
...
func (ReDamageSpellAbsorb) DefaultMaxLeftover() int {
	return 1048576
}
...
func (ReDamageSpellAbsorb) FindReader(r io.Reader, cfg stream.Config, onMatch func(stream.Match[*ReDamageSpellAbsorbBytesResult]) bool) error {
	...
	reuseResult := &ReDamageSpellAbsorbBytesResult{}
			...
			if err == io.EOF {
				...
				if leftover > 0 {
					...
					for searchPos < len(chunk) {
						result, ok := ReDamageSpellAbsorb{}.FindBytesReuse(chunk[searchPos:], reuseResult)
						if !ok {
							break
						}
						...
						m := stream.Match[*ReDamageSpellAbsorbBytesResult]{
...
func (ReDamageSpellAbsorb) FindReaderCount(r io.Reader, cfg stream.Config) (int64, error) {
	var count int64
	err := ReDamageSpellAbsorb{}.FindReader(r, cfg, func(_ stream.Match[*ReDamageSpellAbsorbBytesResult]) bool {
		count++
		return true
	})
	return count, err
...
func (ReDamageSpellAbsorb) FindReaderFirst(r io.Reader, cfg stream.Config) (*ReDamageSpellAbsorbBytesResult, int64, error) {
	var result *ReDamageSpellAbsorbBytesResult
	var offset int64
	err := ReDamageSpellAbsorb{}.FindReader(r, cfg, func(m stream.Match[*ReDamageSpellAbsorbBytesResult]) bool {
		// Copy the result since buffer will be reused
		result = ReDamageSpellAbsorb{}.copyBytesResult(m.Result)
...
func (ReDamageSpellAbsorb) copyBytesResult(src *ReDamageSpellAbsorbBytesResult) *ReDamageSpellAbsorbBytesResult {
	if src == nil {
		return nil
	}
	dst := &ReDamageSpellAbsorbBytesResult{}
	// Copy Match slice
...
//	    })
//	io.Copy(os.Stdout, r)
func (ReDamageSpellAbsorb) NewTransformReader(r io.Reader, cfg stream.TransformConfig, onMatch func(match *ReDamageSpellAbsorbBytesResult, emit func([]byte))) io.Reader {
	if cfg.BufferSize == 0 {
	...
	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReDamageSpellAbsorb{}.processTransform(data, isEOF, onMatch, emitOut)
	}
...
func (ReDamageSpellAbsorb) processTransform(data []byte, isEOF bool, onMatch func(match *ReDamageSpellAbsorbBytesResult, emit func([]byte)), emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReDamageSpellAbsorbBytesResult{}

	for {
		result, ok := ReDamageSpellAbsorb{}.FindBytesReuse(data[processed:], reuseResult)
		if !ok {
			// No more matches
			if isEOF {
...
//	io.Copy(os.Stdout, r)
func (ReDamageSpellAbsorb) ReplaceReader(r io.Reader, template string) io.Reader {
	parsed, err := replace.Parse(template)
	if err != nil {
		return &reDamageSpellAbsorbTransformErrReader{err: err}
	}
	...
	return ReDamageSpellAbsorb{}.NewTransformReader(r, stream.DefaultTransformConfig(), func(m *ReDamageSpellAbsorbBytesResult, emit func([]byte)) {
		...
		for _, seg := range resolved {
			...
			case replace.SegmentCaptureIndex:
				capture := (ReDamageSpellAbsorb{}).getCaptureByIndex(m, seg.CaptureIndex)
				if capture != nil {
...
// reDamageSpellAbsorbTransformErrReader is a reader that always returns an error.
type reDamageSpellAbsorbTransformErrReader struct {
	err error
}

func (r *reDamageSpellAbsorbTransformErrReader) Read(p []byte) (int, error) {
	return 0, r.err
}

// getCaptureByIndex returns the capture group value by its index.
func (ReDamageSpellAbsorb) getCaptureByIndex(m *ReDamageSpellAbsorbBytesResult, index int) []byte {
	switch index {
	case 0:
		return m.Match
	default:
...
//	})
func (ReDamageSpellAbsorb) SelectReader(r io.Reader, pred func(*ReDamageSpellAbsorbBytesResult) bool) io.Reader {
	cfg := stream.DefaultTransformConfig()
	cfg.MaxLeftover = 1048576

	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReDamageSpellAbsorb{}.processSelect(data, isEOF, pred, emitOut)
	}
...
func (ReDamageSpellAbsorb) processSelect(data []byte, isEOF bool, pred func(*ReDamageSpellAbsorbBytesResult) bool, emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReDamageSpellAbsorbBytesResult{}
...
//	})
func (ReDamageSpellAbsorb) RejectReader(r io.Reader, pred func(*ReDamageSpellAbsorbBytesResult) bool) io.Reader {
	cfg := stream.DefaultTransformConfig()
	cfg.MaxLeftover = 1048576

	processor := func(data []byte, isEOF bool, _ stream.TransformFunc, emitOut func([]byte)) int {
		return ReDamageSpellAbsorb{}.processReject(data, isEOF, pred, emitOut)
	}
...
func (ReDamageSpellAbsorb) processReject(data []byte, isEOF bool, pred func(*ReDamageSpellAbsorbBytesResult) bool, emitOut func([]byte)) int {
	processed := 0
	reuseResult := &ReDamageSpellAbsorbBytesResult{}
...
func (r *ReDamageSpellAbsorbResult) CaptureByIndex(idx int) string {
	switch idx {
	case 0:
		return r.Match
	case 1:
...
// CaptureByIndex returns the capture group value by its 0-based index.
// Index 0 returns the full match, 1+ returns capture groups.
func (r *ReDamageSpellAbsorbBytesResult) CaptureByIndex(idx int) []byte {
	switch idx {
	case 0:
		return r.Match
	case 1:
...
func (ReDamageSpellAbsorb) ReplaceAllString(input string, template string) string {
	...
	lastEnd := 0
	var r ReDamageSpellAbsorbResult

	remaining := input
	offset := 0

	for {
		match, ok := ReDamageSpellAbsorb{}.FindStringReuse(remaining, &r)
		if !ok {
			break
		}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageSpellAbsorb) ReplaceAllBytes(input []byte, template string) []byte {
	return ReDamageSpellAbsorb{}.ReplaceAllBytesAppend(input, template, nil)
}

// ReplaceAllBytesAppend replaces all matches and appends to buf.
// If buf has sufficient capacity, no allocation occurs.
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageSpellAbsorb) ReplaceAllBytesAppend(input []byte, template string, buf []byte) []byte {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	result := buf[:0]
	lastEnd := 0
	var r ReDamageSpellAbsorbBytesResult

	remaining := input
	offset := 0

	for {
		match, ok := ReDamageSpellAbsorb{}.FindBytesReuse(remaining, &r)
		if !ok {
			break
		}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageSpellAbsorb) ReplaceFirstString(input string, template string) string {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	var r ReDamageSpellAbsorbResult
	match, ok := ReDamageSpellAbsorb{}.FindStringReuse(input, &r)
	if !ok {
		return input
	}
...
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageSpellAbsorb) ReplaceFirstBytes(input []byte, template string) []byte {
	tmpl, err := replace.Parse(template)
	if err != nil {
		panic(fmt.Sprintf("regengo: invalid replace template: %v", err))
	}
	...
	var r ReDamageSpellAbsorbBytesResult
	match, ok := ReDamageSpellAbsorb{}.FindBytesReuse(input, &r)
	if !ok {
...
// ReDamageSpellAbsorbReplaceTemplate holds a pre-compiled replace template for the ReDamageSpellAbsorb pattern.
// Use CompileReplaceTemplate to create one, then call its Replace methods.
type ReDamageSpellAbsorbReplaceTemplate struct {
	original string
...
//
// Template syntax: $0 (full match), $1/$2 (by index), $name (by name), $$ (literal $)
func (ReDamageSpellAbsorb) CompileReplaceTemplate(template string) (*ReDamageSpellAbsorbReplaceTemplate, error) {
	tmpl, err := replace.Parse(template)
	if err != nil {
		return nil, err
	}
	...
	return &ReDamageSpellAbsorbReplaceTemplate{
		original: template,
		segments: resolved,
	}, nil
}
...
func (t *ReDamageSpellAbsorbReplaceTemplate) String() string {
	return t.original
}

// ReplaceAllString replaces all matches in input using this compiled template.
func (t *ReDamageSpellAbsorbReplaceTemplate) ReplaceAllString(input string) string {
	var result strings.Builder
	lastEnd := 0
	var r ReDamageSpellAbsorbResult
...
func (t *ReDamageSpellAbsorbReplaceTemplate) ReplaceAllBytes(input []byte) []byte {
	return t.ReplaceAllBytesAppend(input, nil)
}

// ReplaceAllBytesAppend replaces all matches and appends to buf.
// If buf has sufficient capacity, no allocation occurs.
func (t *ReDamageSpellAbsorbReplaceTemplate) ReplaceAllBytesAppend(input []byte, buf []byte) []byte {
	result := buf[:0]
	lastEnd := 0
	var r ReDamageSpellAbsorbBytesResult
...
func (t *ReDamageSpellAbsorbReplaceTemplate) ReplaceFirstString(input string) string {
	var r ReDamageSpellAbsorbResult
	match, ok := ReDamageSpellAbsorb{}.FindStringReuse(input, &r)
	if !ok {
		return input
...
func (t *ReDamageSpellAbsorbReplaceTemplate) ReplaceFirstBytes(input []byte) []byte {
	var r ReDamageSpellAbsorbBytesResult
	match, ok := ReDamageSpellAbsorb{}.FindBytesReuse(input, &r)
	if !ok {
		return append([]byte{}, input...)
