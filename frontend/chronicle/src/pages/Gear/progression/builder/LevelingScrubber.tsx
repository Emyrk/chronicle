...
interface LevelingScrubberProps {
  level: number;
  minLevel: number;
  /** Inclusive — the scrubber reaches the level cap. */
  maxLevel: number;
...
/**
 * The levelling axis: a continuous scrubber from level 1 to the cap.
 * Ticks mark the levels where the player's pool actually unlocks
 * something, and the arrows jump between those rather than crawling one
 * level at a time.
 */
