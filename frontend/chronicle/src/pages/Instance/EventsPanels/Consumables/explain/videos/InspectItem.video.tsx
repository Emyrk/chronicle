...
const breakoutData = {
  ...
  raidSize: 8,
  rows: [
    { guid: FIXTURE_PLAYERS.mage, name: "Frostweaver", cls: "MAGE", inCombatUses: 1, preCombatUses: 1, uses: 2 },
    { guid: FIXTURE_PLAYERS.priest, name: "Dawnmend", cls: "PRIEST", inCombatUses: 1, preCombatUses: 0, uses: 1 },
    { guid: FIXTURE_PLAYERS.paladin, name: "Lightward", cls: "PALADIN", inCombatUses: 0, preCombatUses: 1, uses: 1 },
  ],
  nonUsers: [
    { guid: FIXTURE_PLAYERS.warrior, name: "Ironwall", cls: "WARRIOR", inCombatUses: 0, preCombatUses: 0, uses: 0 },
    { guid: FIXTURE_PLAYERS.rogue, name: "Nightshiv", cls: "ROGUE", inCombatUses: 0, preCombatUses: 0, uses: 0 },
    { guid: FIXTURE_PLAYERS.hunter, name: "Eagleeye", cls: "HUNTER", inCombatUses: 0, preCombatUses: 0, uses: 0 },
    { guid: FIXTURE_PLAYERS.warlock, name: "Hexbinder", cls: "WARLOCK", inCombatUses: 0, preCombatUses: 0, uses: 0 },
    { guid: FIXTURE_PLAYERS.druid, name: "Oakheart", cls: "DRUID", inCombatUses: 0, preCombatUses: 0, uses: 0 },
  ],
  classes: [
