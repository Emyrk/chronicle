...
export const sunderExplainer: PanelExplainer = {
  summary:
    "Tracks Sunder Armor effectiveness by warriors, including stacks applied by Devastate and Glyph of Devastate. " +
    "A sunder is 'effective' if it actually applies a stack to the target. " +
