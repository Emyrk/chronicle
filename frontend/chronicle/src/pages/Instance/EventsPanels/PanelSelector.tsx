...
const PANEL_CATEGORIES: PanelCategory[] = [
  ...
  {
    label: "Utility",
    items: ["roles", "timeline", "rotations", "spell_count", "comparison", "all_activity", "metrics", "periods", "pulls_and_cleanup", "possession", "vehicle", "unit_lookup", "equipment", "guilds", "loot", "logging_metadata", "companion_stats", "leaderboard", "empty"],
