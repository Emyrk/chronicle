...
export type Heal = Message<"chronicleproto.Heal"> & {
  ...
  /**
   * Legacy primary school; use schools for complete data.
   *
  ...
  /**
   * @generated from field: repeated chronicleproto.School schools = 12;
   */
  schools: School[];
};
...
export type Interrupt = Message<"chronicleproto.Interrupt"> & {
  ...
  /**
   * legacy primary school of interrupted spell
   *
  ...
  /**
   * @generated from field: repeated chronicleproto.School extra_schools = 7;
   */
  extraSchools: School[];
};
...
export type Absorbed = Message<"chronicleproto.Absorbed"> & {
  ...
  /**
   * @generated from field: repeated chronicleproto.School absorb_schools = 10;
   */
