...
export function SupportRibbon() {
  return (
    ...
    >
      <span className="support-ribbon-medallion absolute -left-3 top-1/2 z-10 flex h-[4.75rem] w-[4.75rem] -translate-y-1/2 items-center justify-center rounded-full border border-amber-200/50 bg-[#242424] shadow-xl shadow-black/50 sm:-left-4 sm:h-[5.75rem] sm:w-[5.75rem]">
        ...
        <img
          ...
          alt=""
          aria-hidden="true"
          className="support-ribbon-logo h-[4.15rem] w-[4.15rem] rounded-full object-contain sm:h-20 sm:w-20"
        />
      </span>
