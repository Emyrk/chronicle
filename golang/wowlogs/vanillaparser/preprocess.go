...
func (s youReplacer) youReplace(content string) (string, bool, error) {
  if len(content) == 0 {
...
func (s youReplacer) replacer(re *regexp.Regexp, content string, replacement string) (string, bool, error) {
