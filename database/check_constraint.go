...
const (
	...
	CheckGuildDiscordInstallationsAnnounceRaidLogsScopeCheck    CheckConstraint = "guild_discord_installations_announce_raid_logs_scope_check"    // guild_discord_installations
	CheckGuildDiscordLogAnnouncementSourcesInstanceOrdinalCheck CheckConstraint = "guild_discord_log_announcement_sources_instance_ordinal_check" // guild_discord_log_announcement_sources
	CheckInstanceSpeedrunsRankedDurationNonnegative             CheckConstraint = "instance_speedruns_ranked_duration_nonnegative"                // instance_speedruns
	CheckInstanceSpeedrunsRankedTimingComplete                  CheckConstraint = "instance_speedruns_ranked_timing_complete"                     // instance_speedruns
	...
	CheckRaidGroupSnapshotEncounterChk                          CheckConstraint = "raid_group_snapshot_encounter_chk"                             // log_instance_raid_group_snapshots
	CheckLogInstancesCategoryCheck                              CheckConstraint = "log_instances_category_check"                                  // log_instances
	...
	CheckRankingSummaryBackfillsBatchSizeCheck                  CheckConstraint = "ranking_summary_backfills_batch_size_check"                    // ranking_summary_backfills
	CheckRankingSummaryBackfillsDelayMsCheck                    CheckConstraint = "ranking_summary_backfills_delay_ms_check"                      // ranking_summary_backfills
	CheckRankingSummaryBackfillsErrorCheck                      CheckConstraint = "ranking_summary_backfills_error_check"                         // ranking_summary_backfills
	CheckRankingSummaryBackfillsLifecycleCheck                  CheckConstraint = "ranking_summary_backfills_lifecycle_check"                     // ranking_summary_backfills
	CheckRankingSummaryBackfillsMaxBatchesCheck                 CheckConstraint = "ranking_summary_backfills_max_batches_check"                   // ranking_summary_backfills
	CheckRankingSummaryBackfillsPreviewCountsCheck              CheckConstraint = "ranking_summary_backfills_preview_counts_check"                // ranking_summary_backfills
	CheckRankingSummaryBackfillsProgressCheck                   CheckConstraint = "ranking_summary_backfills_progress_check"                      // ranking_summary_backfills
	CheckRankingSummaryBackfillsStatusCheck                     CheckConstraint = "ranking_summary_backfills_status_check"                        // ranking_summary_backfills
	CheckRankingSummaryBackfillsTargetVersionCheck              CheckConstraint = "ranking_summary_backfills_target_version_check"                // ranking_summary_backfills
