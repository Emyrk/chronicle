...
type sqlcQuerier interface {
	...
	GetWorldInstanceTemplateByZoneName(ctx context.Context, zoneName string) (GetWorldInstanceTemplateByZoneNameRow, error)
	...
	ListWorldInstanceTemplates(ctx context.Context) ([]ListWorldInstanceTemplatesRow, error)
