...
// ENUM(damage,heal,resource_change,extra_attack,slain,ressurection,cast,aura,spell_go,aura_cast,spell_start,spell_fail,unit_classification,dispel,combatant_info,interrupt,absorbed,companion_stats)
