...
type RaidGroup struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	Meta             *EventMeta             `protobuf:"bytes,1,opt,name=meta,proto3" json:"meta,omitempty"`
	GroupMemberGuids []string               `protobuf:"bytes,2,rep,name=group_member_guids,json=groupMemberGuids,proto3" json:"group_member_guids,omitempty"` // exactly 40 entries
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *RaidGroup) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *RaidGroup) GetGroupMemberGuids() []string {
	if x != nil {
		return x.GroupMemberGuids
	}
	return nil
}
...
const file_chronicle_proto_rawDesc = "" +
	...
	"\abuckets\x18\x03 \x03(\x05R\abuckets\"h\n" +
	"\tRaidGroup\x12-\n" +
	"\x04meta\x18\x01 \x01(\v2\x19.chronicleproto.EventMetaR\x04meta\x12,\n" +
	"\x12group_member_guids\x18\x02 \x03(\tR\x10groupMemberGuids*p\n" +
	"\x06School\x12\v\n" +
